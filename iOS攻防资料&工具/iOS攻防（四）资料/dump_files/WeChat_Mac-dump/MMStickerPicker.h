...
@class MMDivider, MMPageControl, MMStickerPickerToolbar, MMView, NSArray, NSImageView, NSPageController, NSPopover, NSProgressIndicator, NSString, NSTextField, NSView, SwipeDetector;
