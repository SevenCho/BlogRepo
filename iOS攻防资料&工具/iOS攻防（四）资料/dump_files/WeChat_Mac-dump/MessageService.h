...
@class AppMessageHandler, EmoticonMessageHandler, ImgMessageHandler, MessageData, NSLock, NSMutableDictionary, NSMutableSet, NSRecursiveLock, NSString, RecordUploadCDNMgr, TextMessageHandler, ThumbDownloadMgr, VideoDownloadMgr, VideoMessageHandler, VoiceMessageHandler;
...
- (id)getCurrentMessageData;
- (void)setCurrentMessageData:(id)arg1;
...
- (void)sendChatSyncNewXml:(id)arg1 startTime:(unsigned int)arg2 endTime:(unsigned int)arg3 sessionName:(id)arg4;
...
- (void)reportDuplicateMsg:(id)arg1;
