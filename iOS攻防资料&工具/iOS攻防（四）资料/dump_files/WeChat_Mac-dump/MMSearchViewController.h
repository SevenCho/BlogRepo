...
@interface MMSearchViewController : MMViewController <NSTableViewDataSource, NSTableViewDelegate, MMSearchTableSectionHeaderViewDelegate, MMSearchTableSectionAllViewDelegate, OpenIMResourceMgrExt>
{
    BOOL _choseResult;
