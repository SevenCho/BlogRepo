...
@class GetSingleContatctLogic, MMFriendRequestDataCollection, MMFriendVerifyMessageWindowController, NSString, OpenIMContactVerifyMgr;

@interface MMFriendRequestMgr : MMService <IMessageExt, IMMSessionMgrExt, MMService>
{
    OpenIMContactVerifyMgr *m_openimVerifyMgr;
