...
@interface MMChatMemberListViewController : MMViewController <NSTableViewDelegate, NSTableViewDataSource, MMTableViewDelegate, IGroupMgrExt, IContactMgrExt, OpenIMResourceMgrExt>
{
    BOOL _isShown;
    BOOL _isAnimating;
...
- (void)delayHandleOnModifyContacts;
