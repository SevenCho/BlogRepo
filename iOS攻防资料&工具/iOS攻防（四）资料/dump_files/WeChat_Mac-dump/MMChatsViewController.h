...
@interface MMChatsViewController : MMBaseChatsViewController <NSTableViewDataSource, NSTableViewDelegate, MMTableViewDelegate, IMMSessionMgrExt, IMessageExt, MMChatsTableCellViewDelegate, NSTextFieldDelegate, IGroupMgrExt, NSSearchFieldDelegate, OpenIMResourceMgrExt>
{
...
- (void)setCurrentSessionSelected;
