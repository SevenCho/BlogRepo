...
@class MMAvatarImageView, MMBadgeOverlayView, MMImageView, MMSessionInfo, MMSidebarColorIconView, MMSidebarLabelTextField, MMTextField, MMView, NSString, NSView;

@interface MMChatsTableCellView : NSTableCellView <IContactMgrExt, NSMenuDelegate, MMEmoticonDescMgrExt, IMMFileTransferStatusExt, OpenIMResourceMgrExt>
{
    BOOL _selected;
