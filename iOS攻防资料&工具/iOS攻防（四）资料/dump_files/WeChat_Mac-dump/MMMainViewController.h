...
@class LeftViewController, MMAvatarImageView, MMBadgeOverlayView, MMChatsViewController, MMContactsViewController, MMFavoritesViewController, MMLockViewController, MMSettingMenuWindowController, MMSplitView, MMView, MMViewController, MMYoMessageView, NSButton, NSString, WhatsNewWindowController;

@interface MMMainViewController : MMSwizzleTrafficLightViewController <NSSplitViewDelegate, MMTabbarControllerDelegate, IMessageExt, MMNetExt, AccountServiceExt, SyncExt, IContactMgrExt, IBetaMgrExt>
{
