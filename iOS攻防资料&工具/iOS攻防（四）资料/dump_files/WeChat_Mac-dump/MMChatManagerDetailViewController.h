...
@class CAShapeLayer, MMBatchExportViewWindow, MMButton, MMChatCollectionViewController, MMChatFTSSearchLogic, MMChatManagerDataSource, MMMessageCellView, MMMessageScrollView, MMMessageSendLogic, MMMessageTableItem, MMTableView, MMTextField, MMTimer, MMView, NSButton, NSImageView, NSMutableArray, NSProgressIndicator, NSString, NSTextField, NSView, WCContactData;

@interface MMChatManagerDetailViewController : NSViewController <NSTableViewDataSource, NSTableViewDelegate, MMTableViewDelegate, MMMessageCellViewDelegate, MMViewerWindowDelegate, IContactMgrExt, IGroupMgrExt, MMCollectionDelegate, MessageBatchExportMgrExt>
{
