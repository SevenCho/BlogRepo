...
@class EGOCache, MMEmoticonDB, MMEmoticonMgrLogic, MMEmotionGroupInfo, NSArray, NSMutableArray, NSMutableDictionary, NSString, YYMemoryCache;
...
@interface EmoticonMgr : MMService <MMEmoticonMgrLogicDelegate, MMResourceMgrExt, MMService>
{
    ...
    YYMemoryCache *_stickerStoreThumbCache;
...
@property(retain, nonatomic) YYMemoryCache *stickerStoreThumbCache; // @synthesize stickerStoreThumbCache=_stickerStoreThumbCache;
