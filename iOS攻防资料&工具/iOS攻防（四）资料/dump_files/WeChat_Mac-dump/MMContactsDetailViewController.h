...
#import "OpenIMContactVerifyMgrDelegate.h"
#import "OpenIMResourceMgrExt.h"

@class MMFriendRequestData, MMOutlineButton, MMView, NSBox, NSData, NSImageView, NSMutableArray, NSScrollView, NSString, NSTextField, NSTextView, NSView, OpenIMContactMgr, WCContactData;
...
@interface MMContactsDetailViewController : MMViewController <NSTextFieldDelegate, MMViewerWindowDelegate, IContactMgrExt, MMCGIDelegate, OpenIMResourceMgrExt, OpenIMContactVerifyMgrDelegate>
{
    ...
    OpenIMContactMgr *_openIMMgr;
}

@property(nonatomic) unsigned int mySessionId; // @synthesize mySessionId=_mySessionId;
@property(retain, nonatomic) OpenIMContactMgr *openIMMgr; // @synthesize openIMMgr=_openIMMgr;
