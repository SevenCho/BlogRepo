...
@class AFURLSessionManager, EmoticonOperateCGI, EmoticonUploadCGI, ExchangeEmoticonPackCgi, GetEmotionFavMD5ListCGI, MMTimer, MessageData, NSMutableArray, NSString, YYMemoryCache;
...
@property(retain, nonatomic) YYMemoryCache *dataCache; // @synthesize dataCache=_dataCache;
