...
@class FavoritesItem, MMDivider, MMPreviewNodraggableWindow, MMPreviewTitleButton, MessageData, NSButton, NSString, NSTextField, NSView, WeNoteArticleToolBar, WeNoteDetailViewController;
