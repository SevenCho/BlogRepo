...
@class MMFavSidebarHeaderRowView, MMFavoriteDetailViewContoller, MMFavoriteSidebarItem, MMFavoritesCollectionData, MMFavoritesPlaceholderViewController, MMSearchField, MMSidebarOutlineView, MMViewController<MMFavoritesViewControllerDetailProtocol>, NSIndexPath, NSIndexSet, NSString, NSTextField;
...
- (void)dataForDetailViewController:(id)arg1 collectionData:(CDUnknownBlockType)arg2;
...
- (void)loadDataForSelectedItem:(id)arg1 completion:(CDUnknownBlockType)arg2;
