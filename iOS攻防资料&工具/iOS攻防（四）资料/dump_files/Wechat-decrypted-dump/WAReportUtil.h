...
+ (unsigned long)publicLibVersion;
+ (unsigned int)conventDebugModeType2ReportAppState:(unsigned int)arg1;
...
+ (void)reportError:(unsigned int)arg1 contact:(id)arg2 appType:(unsigned int)arg3 scene:(unsigned int)arg4 sceneNote:(id)arg5;
