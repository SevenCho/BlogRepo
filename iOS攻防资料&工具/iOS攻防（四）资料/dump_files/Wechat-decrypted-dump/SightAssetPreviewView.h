...
@interface SightAssetPreviewView : UIView <UIScrollViewDelegate>
{
    ...
    unsigned int _previewOrientation;
    struct CGSize _outputSize;
}

@property(nonatomic) unsigned int previewOrientation; // @synthesize previewOrientation=_previewOrientation;
@property(nonatomic, getter=isVideoReady) BOOL videoReady; // @synthesize videoReady=_videoReady;
...
@property(nonatomic, getter=isHideOverlayView) BOOL hideOverlayView; // @synthesize hideOverlayView=_hideOverlayView;
