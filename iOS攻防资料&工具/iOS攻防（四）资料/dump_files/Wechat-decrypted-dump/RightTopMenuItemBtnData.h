...
+ (id)genItemWithID:(id)arg1 title:(id)arg2 imageName:(id)arg3 actionType:(unsigned int)arg4 actionName:(id)arg5 pluginUserName:(id)arg6;
...
@property(nonatomic) unsigned int m_actionType; // @synthesize m_actionType;
