...
@class HoneyPayGetMCreditLineTokenCgi, HoneyPayLoadingViewController, HoneyPayPayerCardDetailViewController, NSString, WCPayGetPayPwdTokenCgi, WCPayModifyHoneyPayerCreditLineCgi, WCPayModifyHoneyPayerNotifyCgi, WCPayModifyHoneyPayerPayWayCgi, WCPayQryHoneyPayerDetailCgi, WCPayUnbindHoneyPayCardCgi;
...
@property(retain, nonatomic) HoneyPayLoadingViewController *loadingVC; // @synthesize loadingVC=_loadingVC;
...
@property(nonatomic) unsigned int verifyPasswordScene; // @synthesize verifyPasswordScene=_verifyPasswordScene;
...
- (void)popAndPushDetailVC:(BOOL)arg1;
- (void)verifyPassword:(unsigned int)arg1;
- (void)requestDetail;
