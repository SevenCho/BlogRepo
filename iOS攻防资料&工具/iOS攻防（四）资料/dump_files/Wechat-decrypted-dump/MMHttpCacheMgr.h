...
- (BOOL)getWithURL:(id)arg1 cacheKey:(id)arg2 Type:(unsigned long)arg3 NotifyKey:(id)arg4 RefererHeader:(id)arg5;
- (BOOL)getWithURL:(id)arg1 cacheKey:(id)arg2 Type:(unsigned long)arg3 NotifyKey:(id)arg4;
- (void)dealloc;
- (void)onServiceInit;
