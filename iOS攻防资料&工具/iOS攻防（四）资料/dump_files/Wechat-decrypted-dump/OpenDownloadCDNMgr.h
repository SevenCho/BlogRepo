...
- (void)onCheckBigFileDownloadResult:(BOOL)arg1 resp:(id)arg2 wrapMsg:(id)arg3 errMsg:(id)arg4;
...
- (void)StopDownload:(id)arg1 MsgWrap:(id)arg2 needNotify:(BOOL)arg3;
- (void)StopDownload:(id)arg1 MsgWrap:(id)arg2;
- (void)StopCurDownload;
- (BOOL)StartDownload:(id)arg1 MsgWrap:(id)arg2 Silent:(BOOL)arg3;
- (BOOL)StartDownload:(id)arg1 MsgWrap:(id)arg2;
- (void)DownloadFail:(long)arg1 expired:(BOOL)arg2;
- (void)DownloadOk;
- (void)modMsgByBitSetInMainQueue:(id)arg1 MsgWrap:(id)arg2 BitSet:(unsigned long)arg3;
- (void)CheckQueue;
- (void)Pop;
- (id)GetTop;
- (void)DelTaskInDownloadQueue:(id)arg1;
- (BOOL)IsCurrentDownloading:(id)arg1 MsgWrap:(id)arg2;
