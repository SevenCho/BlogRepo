...
@interface WXGBackupMgr : MMService <IMsgExt, MMKernelExt, ChatMigrationGetConnectInfoDelegate, WXGBackupLogicDelegate, WXGBackupEntryViewControllerDelegate, WXGBackupImportMessageHelperDelegate, WXGChatLogDeleteHelperDelegate, WCImageFullScreeViewMgrExt, MMService>
{
    ...
    unsigned int m_workType;
    BOOL m_checkState;
    BOOL m_bNeedReloadBanner;
    BOOL _supportTimeSelect;
...
@property(nonatomic) BOOL supportTimeSelect; // @synthesize supportTimeSelect=_supportTimeSelect;
...
- (void)onDeleteSession:(unsigned int)arg1 totalSession:(unsigned int)arg2;
- (void)onDeleteStart;
...
- (void)onBackupLogicAlert:(unsigned int)arg1;
...
- (id)getProgress;
- (void)onBackupLogicNotify:(unsigned int)arg1;
...
- (void)showBackupEntryViewControllerOnMainThreadWithNotifyCode:(unsigned int)arg1;
- (void)checkState;
