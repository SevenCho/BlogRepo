...
@property(nonatomic) BOOL catchZombies; // @synthesize catchZombies=_catchZombies;
...
- (void)reportWechatUserException:(id)arg1 reason:(id)arg2 language:(id)arg3 lineOfCode:(id)arg4 stackTrace:(id)arg5 logAllThreads:(BOOL)arg6 terminateProgram:(BOOL)arg7 dumpFilePath:(id)arg8;
