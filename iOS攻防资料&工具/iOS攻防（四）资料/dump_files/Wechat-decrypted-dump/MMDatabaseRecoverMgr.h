...
@property(nonatomic) BOOL m_isGlobalSceneCanPop; // @synthesize m_isGlobalSceneCanPop=_m_isGlobalSceneCanPop;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *m_workQueue; // @synthesize m_workQueue;
@property(nonatomic) BOOL m_isRecovering; // @synthesize m_isRecovering;
@property(nonatomic) BOOL m_isUserLogon; // @synthesize m_isUserLogon;
