...
- (void)animationWithDuration:(double)arg1 coordinates:(struct CLLocationCoordinate2D *)arg2 coordinatesCount:(unsigned int)arg3 completion:(CDUnknownBlockType)arg4;
...
- (id)tb_constructKeyframeAnimationWithCoordinates:(struct CLLocationCoordinate2D *)arg1 coordinateCount:(unsigned int)arg2 duration:(double)arg3;
