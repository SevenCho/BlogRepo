...
{
    BOOL _show_check_box;
    BOOL _check_box_selected;
    BOOL _is_upload_credid;
...
@property(nonatomic) BOOL is_upload_credid; // @synthesize is_upload_credid=_is_upload_credid;
...
@property(nonatomic) BOOL check_box_selected; // @synthesize check_box_selected=_check_box_selected;
@property(nonatomic) BOOL show_check_box; // @synthesize show_check_box=_show_check_box;
