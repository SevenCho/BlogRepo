...
- (void)authFailWithJSAPI:(id)arg1 failHandler:(CDUnknownBlockType)arg2 errMsg:(id)arg3 scene:(unsigned int)arg4;
- (void)authOKWithJSAPI:(id)arg1 handler:(CDUnknownBlockType)arg2 scene:(unsigned int)arg3;
...
- (void)mainThread_checkUserAuthWithAPPID:(id)arg1 jsapi:(id)arg2 handler:(CDUnknownBlockType)arg3 failHandler:(CDUnknownBlockType)arg4 scene:(unsigned int)arg5;
...
- (void)dealloc;
- (id)initWithDebugModeType:(unsigned long)arg1 externalInfo:(id)arg2;
