...
@interface WASyncIssueLaunchCmd : WASyncBaseCmd
{
    ...
    unsigned long _useBeginTime;
    unsigned long _useEndTime;
}

@property(nonatomic) unsigned long useEndTime; // @synthesize useEndTime=_useEndTime;
@property(nonatomic) unsigned long useBeginTime; // @synthesize useBeginTime=_useBeginTime;
