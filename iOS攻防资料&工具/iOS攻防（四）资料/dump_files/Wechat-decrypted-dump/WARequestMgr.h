...
- (BOOL)abortRequestTask:(id)arg1 taskID:(id)arg2 getError:(id *)arg3;
- (void)requestWithAppID:(id)arg1 appVersion:(unsigned long long)arg2 isIgnoreCheckDomain:(BOOL)arg3 taskID:(id)arg4 url:(id)arg5 data:(id)arg6 httpHeaders:(id)arg7 method:(id)arg8 context:(id)arg9 completionHandler:(CDUnknownBlockType)arg10;
- (id)genRequestTaskID;
