...
- (BOOL)isContactType:(unsigned long)arg1;
- (void)removeTopHitItem:(id)arg1 forTopHitType:(unsigned long)arg2;
- (void)onAppTerminate;
- (void)onClearData;
- (void)onReloadData;
...
- (id)getTopHitItems:(unsigned long)arg1;
- (unsigned long)getTopHitCount:(unsigned long)arg1;
- (BOOL)hasTopHit:(unsigned long)arg1;
...
- (id)convertTopHitKeyFromType:(unsigned long)arg1;
...
- (void)selectItem:(id)arg1 type:(unsigned long)arg2;
- (void)removeBaseTopHitResult:(id)arg1 count:(unsigned int)arg2;
- (void)calWithMMGroupDisplayResult:(id)arg1 otherCount:(unsigned int)arg2;
- (BOOL)checkTopHitMatchInfo:(id)arg1 matchTip:(id)arg2;
- (id)findContactInArray:(id)arg1 key:(id)arg2;
- (id)findTopHitValue:(id)arg1 key:(id)arg2;
- (id)targetKeysForTopHitType:(unsigned long)arg1;
...
- (void)searchTopHit:(id)arg1 dicCheckList:(id)arg2 matchTips:(id)arg3 maxCount:(unsigned long)arg4;
- (BOOL)isSessionActiveForContact:(id)arg1;
- (BOOL)isNormalOrChatRoomContact:(id)arg1;
...
- (void)initData;
- (void)dealloc;
- (id)initWithType:(unsigned long)arg1;
- (id)init;
