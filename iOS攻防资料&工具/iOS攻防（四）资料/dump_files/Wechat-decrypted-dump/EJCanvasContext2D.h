...
@interface EJCanvasContext2D : EJCanvasContext
{
    ...
    int stateIndex;
    CDStruct_db1269c7 stateStack[16];
    CDStruct_db1269c7 *state;
    BOOL upsideDown;
...
@property(nonatomic) CDStruct_db1269c7 *state; // @synthesize state;
- (void)resetClip;
- (void)clip:(int)arg1;
...
- (void)arcX:(float)arg1 y:(float)arg2 radius:(float)arg3 startAngle:(float)arg4 endAngle:(float)arg5 antiClockwise:(BOOL)arg6;
...
@property(nonatomic) BOOL imageSmoothingEnabled; // @synthesize imageSmoothingEnabled;
- (void)flushBuffers;
