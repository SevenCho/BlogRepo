...
- (id)GetImgOrVideoOrAppNextMsg:(id)arg1 StartCreateTime:(unsigned long)arg2 EndCreateTime:(unsigned long)arg3 Limit:(int)arg4 Brand:(id)arg5;
- (id)GetImgOrVideoOrAppLastMsg:(id)arg1 StartCreateTime:(unsigned long)arg2 EndCreateTime:(unsigned long)arg3 Limit:(int)arg4 Brand:(id)arg5;
- (id)GetImgOrVideoOrAppNextMsg:(id)arg1 FromID:(unsigned long)arg2 CreateTime:(unsigned long)arg3 Limit:(int)arg4 Brand:(id)arg5;
- (id)GetImgOrVideoOrAppLastMsg:(id)arg1 FromID:(unsigned long)arg2 CreateTime:(unsigned long)arg3 Limit:(int)arg4 Brand:(id)arg5;
- (unsigned long)GetImgOrVideoOrAppMsgMinCreateTime:(id)arg1 Brand:(id)arg2;
...
- (id)GetDownMsg:(id)arg1 FromID:(unsigned long)arg2 Limit:(int)arg3 LeftCount:(unsigned int *)arg4 LeftUnreadCount:(unsigned int *)arg5 Brand:(id)arg6;
- (id)GetMsgByCreateTime:(id)arg1 FromID:(unsigned long)arg2 FromCreateTime:(unsigned long)arg3 Limit:(int)arg4 LeftCount:(unsigned int *)arg5 Brand:(id)arg6;
- (id)GetMsg:(id)arg1 FromID:(unsigned long)arg2 Limit:(int)arg3 LeftCount:(unsigned int *)arg4 LeftUnreadCount:(unsigned int *)arg5 Brand:(id)arg6;
