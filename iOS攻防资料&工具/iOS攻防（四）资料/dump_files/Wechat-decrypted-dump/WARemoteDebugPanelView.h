...
- (void)updateRecvLength:(id)arg1 recvCount:(unsigned long)arg2;
- (void)updateSendLength:(id)arg1 sendCount:(unsigned long)arg2;
- (void)updateNoSendCount:(unsigned long)arg1;
- (void)updateNoConfirmedCount:(unsigned long)arg1;
