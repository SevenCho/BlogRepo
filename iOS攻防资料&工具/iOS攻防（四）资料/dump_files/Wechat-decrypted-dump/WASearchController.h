...
@class MMSearchBar, MMUIViewController, NSMutableArray, NSMutableDictionary, NSString, UIButton, UIImageView, UIView<YYWebViewInterface>, WASearchResultLogic;
...
@interface WASearchController : MMObject <MMSearchBarDelegate, WASearchActionDelegate, UIScrollViewDelegate, WAAppCanvasWrapperViewDelegate, IWSViewControllerLifeCycleExt, WAWidgetJSEventHandlerDelegate>
{
    ...
    BOOL _webViewDidRegisterScrollNotify;
    ...
    float _webViewScrollNotifyDiffHeight;
    float _lastOffsetY;
    NSString *_searchID;
...
@property(nonatomic) float webViewScrollNotifyDiffHeight; // @synthesize webViewScrollNotifyDiffHeight=_webViewScrollNotifyDiffHeight;
@property(nonatomic) BOOL webViewDidRegisterScrollNotify; // @synthesize webViewDidRegisterScrollNotify=_webViewDidRegisterScrollNotify;
...
- (void)hideResultViewWithOffset:(BOOL)arg1 completion:(CDUnknownBlockType)arg2;
- (void)showResultViewWithOffset:(BOOL)arg1 completion:(CDUnknownBlockType)arg2;
