...
+ (void)reportUploadSnsAlbumVideo:(id)arg1 containsWXTag:(BOOL)arg2;
+ (void)reportUploadC2CRecordVideo:(id)arg1;
+ (void)reportUploadC2CAlbumVideo:(id)arg1 selectedKbpsLevel:(int)arg2 containsWXTag:(BOOL)arg3;
