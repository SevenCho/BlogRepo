...
@property(nonatomic) BOOL m_bHasMoreValue; // @synthesize m_bHasMoreValue;
@property(nonatomic) long m_lTotalGameCount; // @synthesize m_lTotalGameCount;
@property(nonatomic) long m_lSendTotalNum; // @synthesize m_lSendTotalNum;
@property(nonatomic) long m_lSendTotalAmount; // @synthesize m_lSendTotalAmount;
@property(nonatomic) long m_lRecTotalNum; // @synthesize m_lRecTotalNum;
@property(nonatomic) long m_lRecTotalAmount; // @synthesize m_lRecTotalAmount;
