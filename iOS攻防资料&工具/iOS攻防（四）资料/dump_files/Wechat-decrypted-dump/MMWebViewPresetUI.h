...
@interface MMWebViewPresetUI : MMObject
{
    ...
    unsigned int _webScrollStyle;
    UIColor *_backcontainerColor;
    unsigned int _backcontainerEffect;
...
@property(nonatomic) unsigned int backcontainerEffect; // @synthesize backcontainerEffect=_backcontainerEffect;
@property(retain, nonatomic) UIColor *backcontainerColor; // @synthesize backcontainerColor=_backcontainerColor;
@property(nonatomic) unsigned int webScrollStyle; // @synthesize webScrollStyle=_webScrollStyle;
...
@property(nonatomic) unsigned int statusBarColor; // @synthesize statusBarColor=_statusBarColor;
- (void).cxx_destruct;
- (id)init;
