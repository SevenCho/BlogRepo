...
{
    BOOL appBrandWithShareTicket;
    BOOL bIsShowLaunchFailToast;
    NSString *title;
...
@property(nonatomic) unsigned int miniProgramType; // @synthesize miniProgramType=_miniProgramType;
@property(retain, nonatomic) NSData *hdThumbData; // @synthesize hdThumbData=_hdThumbData;
@property(nonatomic) BOOL bIsShowLaunchFailToast; // @synthesize bIsShowLaunchFailToast;
...
@property(nonatomic) BOOL appBrandWithShareTicket; // @synthesize appBrandWithShareTicket;
...
@property(nonatomic) unsigned int objectType; // @synthesize objectType;
