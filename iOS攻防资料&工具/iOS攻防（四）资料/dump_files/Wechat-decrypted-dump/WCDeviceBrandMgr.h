...
@interface WCDeviceBrandMgr : MMService <MMService, WCDeviceAuthLogicDelegate, WCDeviceNetworkLogicMgrDelegate, WCDeviceSendDataToManufacturSvrLogicDelegate, WCDeviceWifiStateLogicDelegate, WCDeviceM7LogicDelegate, IMsgExt, BlueAdapterDelegate, IWCDeviceAccountMgrExt, IContactMgrExt, IPreEnterWechatLogicExt>
{
    ...
    unsigned long _uploadingHKStepCount;
    unsigned long _uploadingM7StepCount;
...
@property(nonatomic) unsigned long m_lastGetBoundDevTime; // @synthesize m_lastGetBoundDevTime=_m_lastGetBoundDevTime;
@property(nonatomic) BOOL m_isScanning; // @synthesize m_isScanning=_m_isScanning;
...
- (void)onSendWCDeviceUnbindResponse:(id)arg1 deviceId:(id)arg2 bAllUnbind:(BOOL)arg3 Error:(id)arg4;
...
- (void)onUploadDeviceStepReponse:(id)arg1 stepCount:(unsigned long)arg2 HKStepCount:(unsigned long)arg3 M7StepCount:(unsigned long)arg4 sourceWhiteList:(id)arg5 ErrorCode:(int)arg6;
- (unsigned long)getLastHealthkitStep;
- (unsigned long)getLastM7Step;
- (void)onGotDeviceStepObject:(id)arg1;
- (void)OnGetNewXmlMsg:(id)arg1 Type:(id)arg2 MsgWrap:(id)arg3;
- (void)onhandleWifiStateUpdateMsgEnd:(id)arg1 Status:(unsigned long)arg2;
...
- (BOOL)isSendTo3rdServer:(id)arg1 ForType:(int)arg2;
- (BOOL)isSendToH5:(id)arg1 ForType:(int)arg2;
...
- (BOOL)checkDeviceReqValidity:(long long)arg1 Seq:(unsigned short)arg2;
...
- (void)tryUploadM7OrHealthKitStepCount:(BOOL)arg1 scene:(int)arg2;
- (void)tryUploadStepOnObserver;
- (int)getWCDeviceWifiState:(id)arg1;
- (void)subscribeWifiStateUpdateFor:(id)arg1 ReqType:(unsigned long)arg2;
...
- (void)sendUpdateMyDeviceAttrReq:(id)arg1 alias:(id)arg2 isMain:(unsigned long)arg3;
- (void)sendUploadBlueProfileStepReq:(id)arg1 stepCount:(unsigned long)arg2;
...
- (void)switchDeviceMode:(BOOL)arg1 DID:(long long)arg2 EnterOrExitChatView:(BOOL)arg3;
- (BOOL)isDeviceAuthed:(long long)arg1;
