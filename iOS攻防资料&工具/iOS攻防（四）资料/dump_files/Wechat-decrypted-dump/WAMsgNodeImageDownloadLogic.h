...
- (BOOL)hasExceedLimit:(id)arg1;
- (void)clearTaskListWithUrl:(id)arg1;
- (void)addTask:(id)arg1;
- (BOOL)isDownloadingUrl:(id)arg1;
- (void)copyFileFrom:(id)arg1 url:(id)arg2;
- (void)doReportWithBeginTime:(struct timeval)arg1 fileLength:(unsigned int)arg2;
- (void)addImageUrl:(id)arg1 appId:(id)arg2 statId:(id)arg3 scene:(unsigned int)arg4 coreId:(unsigned long)arg5 completion:(CDUnknownBlockType)arg6;
