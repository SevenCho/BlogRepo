...
@interface WCPayMultiOrderDetail : NSObject
{
    ...
    unsigned int m_assignUserInfoPay;
    NSString *m_nsJumpToSafariUrl;
    WCPayEntrustPayInfo *m_entrustPayInfo;
    BOOL _m_isSupportBindCard;
    BOOL _m_isSupportRetry;
    BOOL _bIsUseNewPaidSuccPage;
...
@property(nonatomic) BOOL bIsUseNewPaidSuccPage; // @synthesize bIsUseNewPaidSuccPage=_bIsUseNewPaidSuccPage;
@property(retain, nonatomic) NSString *paySuccBtnWording; // @synthesize paySuccBtnWording=_paySuccBtnWording;
@property(nonatomic) BOOL m_isSupportRetry; // @synthesize m_isSupportRetry=_m_isSupportRetry;
@property(nonatomic) BOOL m_isSupportBindCard; // @synthesize m_isSupportBindCard=_m_isSupportBindCard;
...
@property(nonatomic) int m_assignUserCreType; // @synthesize m_assignUserCreType;
...
@property(nonatomic) unsigned int m_assignUserInfoPay; // @synthesize m_assignUserInfoPay;
@property(nonatomic) BOOL m_bNeedBindCardToShowFavInfo; // @synthesize m_bNeedBindCardToShowFavInfo;
@property(retain, nonatomic) WCPayTradeFavInfo *m_oWCPayTradeFavInfo; // @synthesize m_oWCPayTradeFavInfo;
@property(nonatomic) BOOL m_isOpenProtocal; // @synthesize m_isOpenProtocal;
...
@property(nonatomic) unsigned long m_productNum; // @synthesize m_productNum;
- (void).cxx_destruct;
- (void)dealloc;
