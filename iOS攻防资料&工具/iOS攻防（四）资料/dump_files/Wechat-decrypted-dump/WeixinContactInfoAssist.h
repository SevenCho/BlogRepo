...
@class CContact, CMessageWrap, ContactRelatedGroupLogic, MMTableViewInfo, NSMutableArray, NSString, SendVerifyMsgLogicController, UIButton;

@interface WeixinContactInfoAssist : CBaseContactInfoAssist <MMCPLabelDelegate, IAutoSetRemarkExt, IAutoSetStrangerAttributeExt, SendVerifyMsgViewControllerDelegate, ILinkEventExt, RichTextLayoutDelegate, IHDHeadImageViewExt, WCFacadeExt>
{
