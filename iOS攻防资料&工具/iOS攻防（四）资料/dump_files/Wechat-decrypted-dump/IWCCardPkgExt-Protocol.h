...
- (void)onGetUsedStoreList:(NSArray *)arg1 ErrCode:(int)arg2 EventID:(unsigned long)arg3;
...
- (void)onGiftCard:(NSString *)arg1 ErrCode:(int)arg2 EventID:(unsigned long)arg3;
- (void)onGiftCard:(NSString *)arg1 ErrCode:(int)arg2;
- (void)onAcceptCard:(WCCardData *)arg1 ErrCode:(int)arg2 ErrMsg:(NSString *)arg3 EventID:(unsigned long)arg4;
- (void)onAcceptCard:(WCCardData *)arg1 ErrCode:(int)arg2 ErrMsg:(NSString *)arg3;
- (void)onGetCardData:(WCCardData *)arg1 ErrCode:(int)arg2 EventID:(unsigned long)arg3;
