...
@interface WCMallFunctionActivity : NSObject
{
    ...
    BOOL m_hasDownloadRestrict;
    BOOL _m_hasRedDot;
}

@property(nonatomic) BOOL m_hasRedDot; // @synthesize m_hasRedDot=_m_hasRedDot;
@property(nonatomic) BOOL m_hasDownloadRestrict; // @synthesize m_hasDownloadRestrict;
...
@property(nonatomic) unsigned long m_uiFunctionActivityId; // @synthesize m_uiFunctionActivityId;
- (void).cxx_destruct;
- (id)debugDescription;
- (id)description;
