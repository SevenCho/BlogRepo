...
- (id)getBlurCodeView;
- (void)setupViewWithAnimation:(BOOL)arg1;
- (void)initView;
- (void)updateLargeCodeView:(id)arg1 dynamicCode:(id)arg2 offlineCode:(id)arg3 offlineCodeStatus:(unsigned long)arg4;
- (void)willChangeToSplitMode;
- (id)initWithCodeRect:(struct CGRect)arg1 cardSource:(id)arg2 dynamicCode:(id)arg3 offlineCode:(id)arg4 offlineCodeStatus:(unsigned long)arg5;
