...
@interface WAPageFlowReportMgr : MMService <MMService>
{
    ...
    unsigned long m_EntranceWebviewID;
...
- (unsigned int)preSceneForUrlIfExist:(id)arg1;
- (void)rigisterScanSourceType:(unsigned long)arg1 sourceInfo:(id)arg2 forUrl:(id)arg3;
...
- (void)onWeAppBecomeActive:(id)arg1 appInfo:(id)arg2 openFromWeApp:(BOOL)arg3;
- (void)onWeAppStartUpProcessTerminate:(unsigned long)arg1;
- (void)onWeAppProcessTriggerDownload;
- (void)onWeAppProcessBegin:(id)arg1 scene:(unsigned int)arg2;
- (id)currentPage;
