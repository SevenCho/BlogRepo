...
- (void).cxx_destruct;
- (void)addCellAtIndex:(int)arg1 rect:(struct CGRect)arg2;
- (void)scrollViewDidTap:(id)arg1;
- (void)scrollViewDidZoom:(id)arg1;
- (void)scrollViewDidScroll:(id)arg1;
- (void)relayoutScrollViewWithOffset:(float)arg1;
- (BOOL)rect:(struct CGRect)arg1 atRangeOf:(struct CGRect)arg2;
- (BOOL)rect:(struct CGRect)arg1 atRightOf:(struct CGRect)arg2;
- (BOOL)rect:(struct CGRect)arg1 atLeftOf:(struct CGRect)arg2;
- (void)reloadData;
