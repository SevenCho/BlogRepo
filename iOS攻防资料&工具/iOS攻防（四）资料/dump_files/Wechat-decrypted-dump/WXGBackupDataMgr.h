...
@interface WXGBackupDataMgr : NSObject
{
    ...
    NSData *m_encryptKey;
    unsigned int _produceSessionCount;
    unsigned int _produceMsgCount;
}

@property(nonatomic) unsigned int produceMsgCount; // @synthesize produceMsgCount=_produceMsgCount;
@property(nonatomic) unsigned int produceSessionCount; // @synthesize produceSessionCount=_produceSessionCount;
- (void).cxx_destruct;
