...
@interface WCPayOrderDetailActivityInfo : NSObject
{
    ...
    unsigned long m_uiSendRecordId;
    unsigned long m_uiUserRecordId;
    NSString *m_activityTinyAppUsername;
    NSString *m_activityTinyAppPath;
    unsigned long long m_activityMchId;
    unsigned long _m_activityTinyAppVersion;
...
@property(nonatomic) unsigned long m_activityTinyAppVersion; // @synthesize m_activityTinyAppVersion=_m_activityTinyAppVersion;
...
@property(nonatomic) unsigned long m_uiUserRecordId; // @synthesize m_uiUserRecordId;
@property(nonatomic) unsigned long m_uiSendRecordId; // @synthesize m_uiSendRecordId;
...
@property(nonatomic) unsigned long m_uiStyle; // @synthesize m_uiStyle;
