...
@class MMWebViewController, NSString, UICollectionView, WCBizLoadingView, WCPayNoticeBannerView, WCPayOverseaIBGGetWalletCgi, WCPayOverseaIBGGetWalletCgiCache, WCPayOverseaMainWalletDataSource, WCPayOverseaPayFunctionListCgi, WCPayOverseaPayFunctionListRespObject, WCPayOverseaReadActivityList;
...
@interface WCPayOverseaMainWalletViewController : WCBizBaseViewController <UICollectionViewDelegate, UICollectionViewDataSource, WCPayOverseaPayFunctionListCgiDelegate, WCPayOverseaIBGGetWalletCgiDelegate, WCActionSheetDelegate, WCPayNoticeBannerViewDelegate, MMWebViewDelegate>
{
    ...
    unsigned long _m_walletRegion;
    unsigned long _m_lastWalletCgiRequestTime;
    MMWebViewController *_m_userKeyInfoWebViewController;
}

@property(nonatomic) BOOL m_hasShownKeyInfo; // @synthesize m_hasShownKeyInfo=_m_hasShownKeyInfo;
...
@property(nonatomic) unsigned long m_lastWalletCgiRequestTime; // @synthesize m_lastWalletCgiRequestTime=_m_lastWalletCgiRequestTime;
@property(nonatomic) unsigned long m_walletRegion; // @synthesize m_walletRegion=_m_walletRegion;
...
- (void)reportClickOnUrl:(id)arg1 funcid:(unsigned long)arg2;
