...
- (void).cxx_destruct;
- (BOOL)readUnsignedIntNode:(const char *)arg1 rootNode:(struct XmlReaderNode_t *)arg2 xml:(id)arg3 getValue:(unsigned int *)arg4;
- (void)saveConfigData;
- (void)loadConfigData;
- (void)readMoreConfigFromXml:(id)arg1 configNode:(struct XmlReaderNode_t *)arg2;
- (BOOL)readBasicConfigFromXml:(id)arg1 configNode:(struct XmlReaderNode_t *)arg2;
