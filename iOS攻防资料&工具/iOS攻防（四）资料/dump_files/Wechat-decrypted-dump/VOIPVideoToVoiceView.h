...
@property(nonatomic) BOOL m_isOperating; // @synthesize m_isOperating;
...
- (void)voipToastMarginBottomOffsetFor480Screen:(float *)arg1;
- (void)getVoiceViewSpeakerMode:(char *)arg1;
