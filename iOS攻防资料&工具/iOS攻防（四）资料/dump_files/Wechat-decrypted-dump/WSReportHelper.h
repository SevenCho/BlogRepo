...
+ (void)reportVoiceSearchEvent:(int)arg1 sessionid:(id)arg2 subSessionid:(id)arg3 query:(id)arg4 scene:(unsigned long)arg5 isNavVoice:(BOOL)arg6;
+ (void)reportRtnBackEvent:(int)arg1 scene:(unsigned long)arg2 ishomepage:(BOOL)arg3 query:(id)arg4;
