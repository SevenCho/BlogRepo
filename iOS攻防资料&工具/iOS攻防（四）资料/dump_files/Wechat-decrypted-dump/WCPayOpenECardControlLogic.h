...
{
    BOOL _bIsOpenECardSucc;
    BOOL _bIsReuseExistingEcard;
    BOOL _bIsQryBankListAfterBindCard;
...
@property(nonatomic) BOOL bIsQryBankListAfterBindCard; // @synthesize bIsQryBankListAfterBindCard=_bIsQryBankListAfterBindCard;
@property(retain, nonatomic) NSString *bindCardSerial; // @synthesize bindCardSerial=_bindCardSerial;
@property(nonatomic) BOOL bIsReuseExistingEcard; // @synthesize bIsReuseExistingEcard=_bIsReuseExistingEcard;
@property(nonatomic) BOOL bIsOpenECardSucc; // @synthesize bIsOpenECardSucc=_bIsOpenECardSucc;
...
- (void)startOpenECardWithBankType:(id)arg1 PhoneNumber:(id)arg2 bindSerial:(id)arg3 bankCardNo:(id)arg4 isisRepeatSend:(BOOL)arg5;
