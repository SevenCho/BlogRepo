...
- (void)qbNetwork:(QBNetwork *)arg1 didReceiveChallenge:(NSURLAuthenticationChallenge *)arg2 completionHandler:(void (^)(int, NSURLCredential *))arg3;
- (void)qbNetwork:(QBNetwork *)arg1 willSendRequestForAuthenticationChallenge:(NSURLAuthenticationChallenge *)arg2;
- (BOOL)qbNetworkShouldUseCredentialStorage:(QBNetwork *)arg1;
