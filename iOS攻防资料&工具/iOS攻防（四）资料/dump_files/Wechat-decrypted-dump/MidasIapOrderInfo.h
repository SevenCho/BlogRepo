...
@property(nonatomic) BOOL needGetPayResult; // @synthesize needGetPayResult=_needGetPayResult;
...
@property(nonatomic) BOOL showRiskAlert; // @synthesize showRiskAlert=_showRiskAlert;
...
@property(nonatomic) BOOL isDepositGameCoin; // @synthesize isDepositGameCoin;
...
@property(nonatomic) long productType; // @synthesize productType;
