...
{
    BOOL _bShowArrowIcon;
    BOOL _bShowImageIcon;
...
@property(nonatomic) BOOL bShowImageIcon; // @synthesize bShowImageIcon=_bShowImageIcon;
@property(nonatomic) BOOL bShowArrowIcon; // @synthesize bShowArrowIcon=_bShowArrowIcon;
