...
+ (id)sendSynchronousRequest:(id)arg1 needSession:(BOOL)arg2 returningResponse:(id *)arg3 error:(id *)arg4;
+ (BOOL)canSessionON;
...
- (void)cancel;
- (id)initWithRequest:(id)arg1 delegate:(id)arg2 isProtocol:(BOOL)arg3 needSession:(BOOL)arg4;
