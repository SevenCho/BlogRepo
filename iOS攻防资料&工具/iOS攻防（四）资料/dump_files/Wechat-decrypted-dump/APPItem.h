...
@property(nonatomic) BOOL hasDownloadGift; // @dynamic hasDownloadGift;
@property(nonatomic) BOOL hasEnableChatroom; // @dynamic hasEnableChatroom;
...
@property(nonatomic) BOOL isForceUpdate; // @dynamic isForceUpdate;
@property(nonatomic) BOOL isSubscribed; // @dynamic isSubscribed;
