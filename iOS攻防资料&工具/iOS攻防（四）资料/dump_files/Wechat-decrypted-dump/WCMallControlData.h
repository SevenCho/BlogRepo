...
@property(nonatomic) BOOL m_bFunctionListDataFromLocalCache; // @synthesize m_bFunctionListDataFromLocalCache;
@property(nonatomic) BOOL m_bNotShowTutorial; // @synthesize m_bNotShowTutorial;
