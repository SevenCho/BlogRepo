...
@interface WCPayTransToBankCardData : MMObject
{
    ...
    unsigned long _m_enterTimeScene;
    NSString *_m_nsTransferDesc;
    unsigned long _m_uiTransferAmount;
    unsigned long _m_uiPondage;
    unsigned long _m_uiInputType;
...
@property(nonatomic) unsigned long m_uiInputType; // @synthesize m_uiInputType=_m_uiInputType;
@property(nonatomic) unsigned long m_uiPondage; // @synthesize m_uiPondage=_m_uiPondage;
@property(nonatomic) unsigned long m_uiTransferAmount; // @synthesize m_uiTransferAmount=_m_uiTransferAmount;
@property(retain, nonatomic) NSString *m_nsTransferDesc; // @synthesize m_nsTransferDesc=_m_nsTransferDesc;
@property(nonatomic) unsigned long m_enterTimeScene; // @synthesize m_enterTimeScene=_m_enterTimeScene;
