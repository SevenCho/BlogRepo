...
@property(nonatomic) BOOL m_bIsVariableFavor; // @synthesize m_bIsVariableFavor;
...
@property(nonatomic) BOOL m_bNeedShowedMoreFavInfo; // @synthesize m_bNeedShowedMoreFavInfo;
