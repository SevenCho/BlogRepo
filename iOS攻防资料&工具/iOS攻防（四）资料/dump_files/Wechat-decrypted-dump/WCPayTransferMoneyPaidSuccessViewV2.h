...
@class InternalFavorDescView, NSString, UIButton, UIImageView, UILabel, UIScrollView, WCPayControlData, WCPayLotteryView, WCPayWebImageView;

@interface WCPayTransferMoneyPaidSuccessViewV2 : UIView <WCPayLotteryViewDelegate>
{
    ...
    float _m_lastElemBottomY;
    WCPayWebImageView *_backgroundImageView;
    float _m_doneButtonMarginUp;
...
@property(nonatomic) float m_doneButtonMarginUp; // @synthesize m_doneButtonMarginUp=_m_doneButtonMarginUp;
@property(retain, nonatomic) WCPayWebImageView *backgroundImageView; // @synthesize backgroundImageView=_backgroundImageView;
@property(nonatomic) float m_lastElemBottomY; // @synthesize m_lastElemBottomY=_m_lastElemBottomY;
