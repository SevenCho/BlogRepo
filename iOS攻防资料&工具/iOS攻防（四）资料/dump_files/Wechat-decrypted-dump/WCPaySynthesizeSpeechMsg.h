...
@property(readonly, nonatomic) unsigned int m_speechFormat; // @synthesize m_speechFormat;
- (void).cxx_destruct;
...
- (BOOL)isSwitchOpen;
- (unsigned long)getCgiCmd;
- (BOOL)setVoiceResponse:(id)arg1;
- (id)getVoiceRequest;
- (id)getLocalNotificationInfo:(BOOL)arg1;
