...
@interface WCPayControlData : NSObject
{
    ...
    BOOL _bIsSmsVerifyAddCard;
    BOOL _m_bTouchIDAuthOrder;
    BOOL _openChangeRealName;
    BOOL _bIsBindNewCardToPay;
    BOOL _m_isShowArrow;
    BOOL _bIsFreePayment;
    BOOL _bIsResetPwdFromPayManage;
    ...
    unsigned long _m_uiWeAppEnterScene;
    ...
    NSString *_cre_tail;
    int _messageVerifyType;
    WCPayBindCardInfo *_autoDeductSelectedCardInfo;
    unsigned int _payOrReceiveFromScene;
...
@property(nonatomic) BOOL bIsResetPwdFromPayManage; // @synthesize bIsResetPwdFromPayManage=_bIsResetPwdFromPayManage;
...
@property(nonatomic) BOOL bIsFreePayment; // @synthesize bIsFreePayment=_bIsFreePayment;
...
@property(nonatomic) BOOL m_isShowArrow; // @synthesize m_isShowArrow=_m_isShowArrow;
...
@property(nonatomic) BOOL bIsBindNewCardToPay; // @synthesize bIsBindNewCardToPay=_bIsBindNewCardToPay;
...
@property(nonatomic) unsigned int payOrReceiveFromScene; // @synthesize payOrReceiveFromScene=_payOrReceiveFromScene;
@property(nonatomic) BOOL openChangeRealName; // @synthesize openChangeRealName=_openChangeRealName;
...
@property(nonatomic) int messageVerifyType; // @synthesize messageVerifyType=_messageVerifyType;
...
@property(nonatomic) unsigned long f2fAmount; // @synthesize f2fAmount=_f2fAmount;
...
@property(nonatomic) unsigned long scanScene; // @synthesize scanScene=_scanScene;
@property(nonatomic) int realnameGuideType; // @synthesize realnameGuideType=_realnameGuideType;
@property(nonatomic) unsigned long m_uiFetchChargeFee; // @synthesize m_uiFetchChargeFee=_m_uiFetchChargeFee;
...
@property(nonatomic) unsigned long m_uiWeAppEnterScene; // @synthesize m_uiWeAppEnterScene=_m_uiWeAppEnterScene;
@property(nonatomic) BOOL m_bTouchIDAuthOrder; // @synthesize m_bTouchIDAuthOrder=_m_bTouchIDAuthOrder;
...
@property(nonatomic) BOOL bIsSmsVerifyAddCard; // @synthesize bIsSmsVerifyAddCard=_bIsSmsVerifyAddCard;
...
@property(nonatomic) unsigned long m_pay_msg_type; // @synthesize m_pay_msg_type;
...
@property(nonatomic) BOOL isAutoDeduct; // @synthesize isAutoDeduct;
...
@property(nonatomic) unsigned long m_uiRealnameActionFlag; // @synthesize m_uiRealnameActionFlag;
...
@property(nonatomic) unsigned long m_uiShortRemainFee; // @synthesize m_uiShortRemainFee;
...
@property(nonatomic) BOOL bNeedInputNewTelToResetBalanceTel; // @synthesize bNeedInputNewTelToResetBalanceTel;
...
@property(nonatomic) unsigned long m_c2c_sceneId; // @synthesize m_c2c_sceneId;
...
@property(nonatomic) unsigned long m_uiStepInFacingReceiveViewTimestamp; // @synthesize m_uiStepInFacingReceiveViewTimestamp;
...
@property(nonatomic) unsigned long m_uiQueryQuestionCnt; // @synthesize m_uiQueryQuestionCnt;
...
@property(nonatomic) BOOL m_bNeedBind; // @synthesize m_bNeedBind;
...
@property(nonatomic) BOOL m_bBankUser; // @synthesize m_bBankUser;
...
@property(nonatomic) unsigned long uiInitalMoney; // @synthesize uiInitalMoney;
...
@property(nonatomic) int offlinePayNumber; // @synthesize offlinePayNumber;
@property(nonatomic) int offlinePayAmount; // @synthesize offlinePayAmount;
...
@property(nonatomic) BOOL m_bNeedOfflinePayLoading; // @synthesize m_bNeedOfflinePayLoading;
...
@property(nonatomic) BOOL bNeedGetSMSAgain; // @synthesize bNeedGetSMSAgain;
...
@property(nonatomic) unsigned long uiCardBankTag; // @synthesize uiCardBankTag;
...
@property(nonatomic) unsigned long uiJSApiPayScene; // @synthesize uiJSApiPayScene;
@property(nonatomic) unsigned long uiBindScene; // @synthesize uiBindScene;
@property(nonatomic) unsigned long uiPayScene; // @synthesize uiPayScene;
@property(retain, nonatomic) NSString *nsVerifiedPasswd; // @synthesize nsVerifiedPasswd;
@property(nonatomic) unsigned long uiFlag; // @synthesize uiFlag;
...
@property(nonatomic) BOOL m_bAutoFilledCardInfo; // @synthesize m_bAutoFilledCardInfo;
