...
+ (id)GenJsonFromInvoiceData:(id)arg1 andUin:(unsigned int)arg2;
+ (id)GetInvoiceArrFromJson:(id)arg1;
+ (BOOL)GetIsHaveInvoiceInfoFromJson:(id)arg1;
...
@property(nonatomic) int group_id; // @synthesize group_id;
- (void).cxx_destruct;
