...
@interface FTSMultiContactSearchLogic : NSObject <IFTSContactDataProviderExt>
{
    ...
    BOOL _bNewSearchForSingleQuery;
    id <FTSMultiContactSearchDelegate> _delegate;
}

+ (id)FilterArrKeywords:(id)arg1;
@property(nonatomic) BOOL bNewSearchForSingleQuery; // @synthesize bNewSearchForSingleQuery=_bNewSearchForSingleQuery;
