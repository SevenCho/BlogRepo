...
@property(nonatomic) BOOL isStartFromFirst; // @synthesize isStartFromFirst=_isStartFromFirst;
...
@property(nonatomic) BOOL continueFlag; // @synthesize continueFlag=_continueFlag;
