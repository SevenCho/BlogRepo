...
@interface FavoritesItemDataField : NSObject
{
    ...
    int _illegalType;
    NSString *_authkey;
    BOOL _isFromSingleMessage;
    NSString *_htmlId;
    FavWeAppItem *_weAppItem;
    unsigned long _fileType;
    NSString *_srcChatName;
    unsigned long _srcMsgLocalId;
    unsigned long _srcMsgCreateTime;
}

+ (id)GetPathByMd5:(id)arg1 isThumb:(BOOL)arg2 DataFmt:(id)arg3 isTmp:(BOOL)arg4;
+ (id)GetPathByMd5:(id)arg1 isThumb:(BOOL)arg2 DataFmt:(id)arg3;
@property(nonatomic) unsigned long srcMsgCreateTime; // @synthesize srcMsgCreateTime=_srcMsgCreateTime;
@property(nonatomic) unsigned long srcMsgLocalId; // @synthesize srcMsgLocalId=_srcMsgLocalId;
...
@property(nonatomic) BOOL isFromSingleMessage; // @synthesize isFromSingleMessage=_isFromSingleMessage;
...
@property(nonatomic) unsigned long subType; // @synthesize subType=_subType;
