...
@interface WXCTalkMgr : MMService <WXCCNetworkStatusExt, AUAudioDataSource, AVAudioPlayerDelegate, IAUAudioDeviceExt, MMKernelExt, MMService, WXCNetWorkDelegate>
{
    ...
    unsigned long mNextBannerClickTimeLimit;
    int _mNetSceneState;
...
@property(nonatomic) unsigned long mNextBannerClickTimeLimit; // @synthesize mNextBannerClickTimeLimit;
...
- (BOOL)sendWXTalkSubscribeVideoRequest:(id)arg1 roomId:(unsigned long)arg2 roomKey:(unsigned long long)arg3 MemberId:(int)arg4 UserName:(id)arg5 SubscribeMemberId:(int)arg6;
...
- (void)StopSession;
- (void)RedirectTo:(id)arg1 withEngineConf:(id)arg2 withHeadSignArray:(id)arg3 withIsEncode:(BOOL)arg4 withTCPSvrArr:(id)arg5 withTCPStartTime:(int)arg6 withAudioEncryptType:(int)arg7 withAudioEncodeType:(int)arg8 withEncryptKey:(id)arg9;
- (void)StartSession:(id)arg1 withEngineConf:(id)arg2 withHeadSignArray:(id)arg3 withIsEncode:(BOOL)arg4 withTCPSvrArr:(id)arg5 withTCPStartTime:(int)arg6 withAudioEncryptType:(int)arg7 withAudioEncodeType:(int)arg8 withEncryptKey:(id)arg9;
