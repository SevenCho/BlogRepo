...
@property(nonatomic) BOOL m_bFileExistInSvr; // @synthesize m_bFileExistInSvr=_m_bFileExistInSvr;
...
@property(nonatomic) unsigned long m_uiAttachDataSize; // @synthesize m_uiAttachDataSize;
...
@property(nonatomic) unsigned long m_uiAddQueueTime; // @synthesize m_uiAddQueueTime;
