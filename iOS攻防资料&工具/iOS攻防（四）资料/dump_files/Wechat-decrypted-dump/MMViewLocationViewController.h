...
@property(nonatomic) BOOL canShareToOpenSDK; // @synthesize canShareToOpenSDK=_canShareToOpenSDK;
...
@property(nonatomic) BOOL directShowDirection; // @synthesize directShowDirection=_directShowDirection;
@property(nonatomic) BOOL canSendToFriend; // @synthesize canSendToFriend=_canSendToFriend;
...
- (void)setPOICalloutShow:(BOOL)arg1;
...
- (void)dealloc;
- (id)initWithChatname:(id)arg1 POIInfo:(id)arg2 ShowTrackButton:(BOOL)arg3;
