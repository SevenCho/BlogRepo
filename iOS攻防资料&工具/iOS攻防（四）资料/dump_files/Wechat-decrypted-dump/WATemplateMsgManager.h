...
{
    BOOL _isManulLogined;
    BOOL _isContactListUpdated;
    WATemplateMsgInfoWrap *_infoWrap;
    NSMutableArray *_debug_unreadUsernames;
    NSString *_debug_lastUsername;
    unsigned int _debug_unreadMsgCount;
    NSMutableDictionary *_debug_fakeTemplateMsgDic;
    NSMutableArray *_debug_msgArray;
}

@property(nonatomic) BOOL isContactListUpdated; // @synthesize isContactListUpdated=_isContactListUpdated;
@property(nonatomic) BOOL isManulLogined; // @synthesize isManulLogined=_isManulLogined;
...
@property(nonatomic) unsigned int debug_unreadMsgCount; // @synthesize debug_unreadMsgCount=_debug_unreadMsgCount;
...
- (void)modifyContactOptForUsername:(id)arg1 withOpt:(unsigned long)arg2;
- (void)modifyServiceNotificationContactWithNotifyStatus:(BOOL)arg1;
- (BOOL)ifUserNameInBanListWithUserName:(id)arg1 banList:(id)arg2;
- (BOOL)isWeAppInTemplateMsgBanListFromLocal:(id)arg1;
...
- (void)batchUpdateTemplateMsgNotifyEnable:(unsigned int)arg1 msgStatusForApps:(id)arg2;
- (void)batchUpdateAWeAppTemplateMsgStatusForAppArray:(id)arg1;
- (void)updateAWeAppTemplateMsgStatusForApp:(id)arg1 status:(BOOL)arg2;
- (void)updateTemplateMsgNotifyEnable:(unsigned int)arg1;
- (void)dealloc;
- (id)init;
