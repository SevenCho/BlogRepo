...
@property(nonatomic) BOOL m_bFisrtLayout; // @synthesize m_bFisrtLayout=_m_bFisrtLayout;
@property(retain, nonatomic) UIImage *m_oImage; // @synthesize m_oImage=_m_oImage;
@property(nonatomic) BOOL m_bIsCreate; // @synthesize m_bIsCreate=_m_bIsCreate;
@property(nonatomic) BOOL m_bPitcureEnable; // @synthesize m_bPitcureEnable=_m_bPitcureEnable;
@property(nonatomic) BOOL m_bScrollNum; // @synthesize m_bScrollNum=_m_bScrollNum;
@property(nonatomic) BOOL m_bIsSender; // @synthesize m_bIsSender=_m_bIsSender;
...
- (void)onWcRedEnvelopesCdnManagerDidDownloadImage:(BOOL)arg1 fileId:(id)arg2;
- (void)onWcRedEnvelopesCdnManagerUploadImagePercent:(double)arg1;
- (void)onWcRedEnvelopesCdnManagerDidUploadImage:(BOOL)arg1 fileName:(id)arg2 fileId:(id)arg3 aesKey:(id)arg4 fileLength:(int)arg5;
...
- (void)dismiss;
- (void)show;
- (void)setUploadingStatus:(BOOL)arg1;
...
- (void)viewDidLoad;
- (void)setupView;
- (void)centerButton:(id)arg1 imageSpacing:(float)arg2;
- (void)configNumView:(id)arg1 withNumber:(int)arg2 font:(id)arg3;
- (BOOL)isMsgWrapHasImage;
- (id)initReceiveViewWithIsScrollNum:(BOOL)arg1 payData:(id)arg2;
- (id)initSendViewWithIsScrollNum:(BOOL)arg1 payData:(id)arg2;
