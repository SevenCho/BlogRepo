...
@property(nonatomic) BOOL m_bAutoDismis; // @synthesize m_bAutoDismis;
@property(nonatomic) BOOL m_bEnableEmpty; // @synthesize m_bEnableEmpty;
@property(retain, nonatomic) NSString *m_nsOldText; // @synthesize m_nsOldText;
- (void).cxx_destruct;
- (void)enableAutoCorrect:(BOOL)arg1;
- (void)dealloc;
