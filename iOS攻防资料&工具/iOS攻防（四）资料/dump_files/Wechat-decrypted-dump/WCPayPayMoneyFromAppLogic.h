...
#import "WCPayMainWindowExt.h"

@class NSDictionary, NSString, PayResp, WCPayBaseViewController, WCPayPayMoneyLogic;

@interface WCPayPayMoneyFromAppLogic : WCPayControlLogic <WCPayMainWindowExt, WCPayBaseViewControllerDelegate, WCBaseControlMgrExt>
{
