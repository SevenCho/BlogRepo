...
@property(nonatomic) BOOL m_hasStartScanLan; // @synthesize m_hasStartScanLan;
@property(nonatomic) BOOL m_hasStartScan; // @synthesize m_hasStartScan;
@property(nonatomic) BOOL m_hasInitLan; // @synthesize m_hasInitLan;
@property(nonatomic) BOOL m_hasInit; // @synthesize m_hasInit;
...
- (BOOL)canHdSendData:(id)arg1;
- (BOOL)canOpenWXDeviceLib:(id)arg1;
- (id)getExtraInfoUserName:(id)arg1;
- (BOOL)isSendDataDirectionToServer:(id)arg1;
- (BOOL)isSendDataDirectionToH5:(id)arg1;
- (BOOL)isSendDataDirectionSet:(id)arg1;
- (void)setSendDataDirection:(unsigned long)arg1 ForDevice:(id)arg2;
- (void)sendData:(id)arg1 ToDevice:(id)arg2 CallBack:(id)arg3;
- (void)getDeviceInfos:(id)arg1;
- (void)getDeviceTicket:(id)arg1 operType:(unsigned long)arg2 CallBack:(id)arg3;
...
- (void)notifyWebViewBindStateChange:(id)arg1 bindState:(BOOL)arg2;
