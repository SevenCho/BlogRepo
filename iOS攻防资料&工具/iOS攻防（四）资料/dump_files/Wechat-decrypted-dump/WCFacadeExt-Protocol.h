...
@optional
- (void)onDataItem:(WCDataItem *)arg1 likeFlagChanged:(BOOL)arg2;
- (void)onSetWCMessageNotifyFinished:(int)arg1 dataItemID:(NSString *)arg2 opFlag:(BOOL)arg3;
- (void)OnVideoStreamDownloadProgressUpdate:(WCMediaItem *)arg1 FinishedLength:(unsigned long)arg2 TotalLength:(unsigned long)arg3;
