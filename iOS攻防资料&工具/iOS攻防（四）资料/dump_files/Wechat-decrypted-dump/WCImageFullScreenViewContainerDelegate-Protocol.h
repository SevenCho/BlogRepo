...
- (void)onPushViewController:(UIViewController *)arg1 animated:(BOOL)arg2;
...
- (void)onLongPressedEditImage:(UIImage *)arg1 atPath:(NSString *)arg2 withFavItem:(FavoritesItem *)arg3 editAtFirst:(BOOL)arg4;
