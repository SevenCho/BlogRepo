...
@property(nonatomic) BOOL showDivideLine; // @synthesize showDivideLine=_showDivideLine;
@property(nonatomic) BOOL showRedIcon; // @synthesize showRedIcon=_showRedIcon;
