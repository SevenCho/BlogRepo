...
@class NSString, WCPayLQTCloseFundAccountCgi, WCPayLQTMoneyControlLogic, WCPayLQTOpenLqbAccountCgi, WCPayLQTQryUserFundDetailCgi;

@interface WCPayLQTDetailControlLogic : WCPayControlLogic <WCPayLQTDetailViewControllerDelegate, WCPayLQTQryUserFundDetailCgiDelegate, WCPayLQTCloseFundAccountCgiDelegate, WCPayPayPwdViewControllerDelegate, WCPayLQTMoneyControlLogicDelegate, WCPayLQTOpenLqbAccountCgiDelegate>
{
...
- (void)queryUserLQTDetailFromSvrShouldLoading:(BOOL)arg1;
...
- (void)startLQTMoneyControlLogicWithMoneyScece:(unsigned int)arg1;
...
- (void)startLogic;
- (void)stopLogic;
- (id)initWithFromScene:(unsigned int)arg1 controlData:(id)arg2;
- (void)dealloc;
