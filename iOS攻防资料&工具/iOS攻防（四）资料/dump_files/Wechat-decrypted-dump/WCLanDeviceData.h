...
@interface WCLanDeviceData : MMObject
{
    ...
    unsigned int m_nsScene;
    unsigned int m_nsSource;
...
@property(nonatomic) unsigned int m_nsSource; // @synthesize m_nsSource;
@property(nonatomic) unsigned int m_nsScene; // @synthesize m_nsScene;
...
- (int)opObjType;
- (id)dataId;
- (id)fileKissMsgWithDetail:(BOOL)arg1;
- (id)thumbPath;
- (id)filePath;
- (id)imageKissMsg;
- (id)imagePath;
