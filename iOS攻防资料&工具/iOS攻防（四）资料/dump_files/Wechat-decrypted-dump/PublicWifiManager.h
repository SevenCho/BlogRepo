...
@interface PublicWifiManager : MMService <APAuthDelegate, APCheckDelegate, APAccessDelegate, APProtalDelegate, PublicWifiGetA8KeyLogicDelegate, PublicWifiViewControllerDelegate, PublicWifiFrontInfoViewControllerDelegate, PublicWifiConnectedViewControllerDelegate, INetworkStatusMgrExt, APCheckPwdDelegate, PublicWifiNetworkLogicMgrDelegate, PublicWifiReportLocationLogicDelegate, PublicWifiApInfoListViewControllerDelegate, PublicWifiCompletePageViewControllerDelegate, APProtal33Delegate, PublicWifiScanListLogicDelegate, MMService, MMKernelExt, MMWebViewDelegate, IMsgExt>
{
    ...
    unsigned long _gAnnotationSwith;
...
@property(nonatomic) BOOL isRegisterHotspotInterface; // @synthesize isRegisterHotspotInterface=_isRegisterHotspotInterface;
@property(nonatomic) __weak PublicWifiPCLogic *publicWifiPCLogic; // @synthesize publicWifiPCLogic=_publicWifiPCLogic;
@property(nonatomic) BOOL isWaitingBindPhone; // @synthesize isWaitingBindPhone=_isWaitingBindPhone;
...
@property(nonatomic) BOOL isOpenUrlProcessing; // @synthesize isOpenUrlProcessing=_isOpenUrlProcessing;
@property(nonatomic) BOOL isWaitingUserConfirm; // @synthesize isWaitingUserConfirm=_isWaitingUserConfirm;
@property(nonatomic) unsigned int annotationExpire; // @synthesize annotationExpire=_annotationExpire;
@property(nonatomic) BOOL hasDoWifiManager; // @synthesize hasDoWifiManager=_hasDoWifiManager;
@property(nonatomic) BOOL isWifiChanged; // @synthesize isWifiChanged=_isWifiChanged;
@property(nonatomic) unsigned long gAnnotationSwith; // @synthesize gAnnotationSwith=_gAnnotationSwith;
...
- (void).cxx_destruct;
- (id)forgroundAppTask;
- (void)addReportQualityDataWithApBase:(id)arg1 protoType:(unsigned long)arg2 errscene:(unsigned long)arg3;
- (void)OnGetNewXmlMsg:(id)arg1 Type:(id)arg2 MsgWrap:(id)arg3;
- (void)addHotspotToProtocol3List:(id)arg1 macAddr:(id)arg2;
- (BOOL)isHotspotValidAndInList:(id)arg1 macAddr:(id)arg2;
- (void)addHotspotToProtocol4List:(id)arg1:(id)arg2;
- (void)registerHotspotHelper;
- (void)delayConfig;
- (BOOL)checkWifiHotSpotList:(id)arg1:(id)arg2;
...
- (void)showViewControllerWithApBase:(id)arg1 fromViewController:(id)arg2 isNeedConfirm:(BOOL)arg3;
- (void)connectToFreeWifiWithQRCode:(id)arg1 viewController:(id)arg2 scene:(unsigned long)arg3;
- (void)onPublicWifiApInfoSelected:(id)arg1;
- (BOOL)handleInnerSchemeFromViewController:(id)arg1 viewController:(id)arg2;
- (void)onReportLocationFailed:(unsigned int)arg1;
- (void)onReportLocationAndGetBizWifiInfo:(id)arg1;
- (void)handleLocationInfoReportWithApBase:(id)arg1;
- (BOOL)handleLocateRequestFromViewController:(id)arg1 scene:(unsigned long)arg2;
- (void)handle3rdAppWithUrl:(id)arg1;
- (void)showGuidePageAfterScanQrCodeOfApPortal;
- (void)doApPortalAfterGetA8KeyResult:(id)arg1 viewController:(id)arg2 scene:(unsigned long)arg3 pageInfo:(id)arg4 tid:(id)arg5 openid:(id)arg6 appid:(id)arg7;
- (void)doApAuthAfterGetA8KeyResult:(id)arg1 viewController:(id)arg2 scene:(unsigned long)arg3 pageInfo:(id)arg4 isNeedConfirm:(BOOL)arg5;
- (void)refreshApAuthPageIfNeed;
- (BOOL)isBindAboardPhone;
- (void)handleGetA8KeyResult:(id)arg1 withViewController:(id)arg2 withScene:(unsigned long)arg3;
...
- (void)setConfirmStateToConnect:(BOOL)arg1 ComfirmCompleteBlock:(CDUnknownBlockType)arg2;
- (void)logout;
- (void)cleanCache;
...
- (void)frontViewControllerWillGoBack:(BOOL)arg1;
...
- (void)setWaitBindPhoneStatus:(BOOL)arg1;
- (BOOL)isUserStayOnConnectingView;
- (void)readWifiSetting;
- (void)asyncReadWifiSetting:(CDUnknownBlockType)arg1;
- (void)doGetA8KeyForWifiWithQRCode:(id)arg1 scene:(unsigned long)arg2 viewController:(id)arg3;
