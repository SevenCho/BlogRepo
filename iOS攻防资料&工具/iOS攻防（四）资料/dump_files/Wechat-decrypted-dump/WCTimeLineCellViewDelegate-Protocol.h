...
- (UIView *)getView;
- (void)onShowDetailChanged:(WCDataItem *)arg1 bShowDetailBeforeChange:(BOOL)arg2;
...
- (void)onUpdateDataItem:(WCDataItem *)arg1 oldHeight:(float)arg2 newHeight:(float)arg3;
