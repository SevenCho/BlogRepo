...
@property(nonatomic) unsigned long m_uStartTime; // @synthesize m_uStartTime;
@property(nonatomic) long m_iDiffTime; // @synthesize m_iDiffTime;
...
@property(nonatomic) BOOL m_remindMMDBRestore; // @synthesize m_remindMMDBRestore;
@property(nonatomic) BOOL m_emotionReinit; // @synthesize m_emotionReinit;
...
@property(nonatomic) BOOL m_useInitContact; // @synthesize m_useInitContact;
...
@property(nonatomic) BOOL m_bQQOfflineSwitchStatus; // @synthesize m_bQQOfflineSwitchStatus;
...
@property(nonatomic) BOOL m_bReplyToAddContact; // @synthesize m_bReplyToAddContact;
...
@property(nonatomic) BOOL m_bAuthAnotherPlace; // @synthesize m_bAuthAnotherPlace;
...
@property(nonatomic) BOOL m_bPushPrivateMsg; // @synthesize m_bPushPrivateMsg;
@property(nonatomic) BOOL m_bRevPrivateMsg; // @synthesize m_bRevPrivateMsg;
...
@property(nonatomic) BOOL m_bSyncNickName; // @synthesize m_bSyncNickName;
...
- (id)delayTypeStringWith:(unsigned int)arg1;
- (id)delayTypeString;
- (unsigned int)transferDelayType;
