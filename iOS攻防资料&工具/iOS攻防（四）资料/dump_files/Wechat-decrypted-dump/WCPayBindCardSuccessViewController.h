...
#import "WCPayQueryBindCardAwardCgiDelegate.h"
#import "WCPaySendBindCardAwardCgiDelegate.h"
...
@property(nonatomic) BOOL m_needQuery; // @synthesize m_needQuery=_m_needQuery;
@property(nonatomic) BOOL m_disableAwardButton; // @synthesize m_disableAwardButton=_m_disableAwardButton;
