...
@property(nonatomic) BOOL isCallServerWhenConfirm; // @dynamic isCallServerWhenConfirm;
@property(nonatomic) BOOL isRecentHasAuth; // @dynamic isRecentHasAuth;
@property(nonatomic) BOOL isSlienctAuth; // @dynamic isSlienctAuth;
