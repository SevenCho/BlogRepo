...
@class CContact, ContactSearchLogic, DeepLinkBitSet, GeneralControlBitSet, JSAPIPermissionBitSet, JumpEmoticonDetailCgi, MMUIViewController, NSData, NSDictionary, NSMutableDictionary, NSString, SKBuiltinBuffer_t;

@interface GetA8KeyLogic : MMObject <WCPayLogicMgrExt, IJumpEmoticonDetailCgiDelegate, ExtraDeviceLoginMgrExt, IScanBookMgrExt, WCNewCardDetailViewControllerDelegate, ContactSearchLogicDelegate, PBMessageObserverDelegate, UIAlertViewDelegate, IWCProductExt, WCProductDetailViewControllerDelegate, IWCDeviceBrandMgrExt, WCBaseControlMgrExt>
{
...
@property(nonatomic) unsigned long getA8keySubScene; // @synthesize getA8keySubScene=_getA8keySubScene;
...
- (void)doSearchContact:(id)arg1 FromScene:(unsigned long)arg2 SearchScene:(unsigned long)arg3 resultString:(id)arg4 subScene:(unsigned long)arg5 picUrl:(id)arg6 picEncKey:(id)arg7 sourceType:(unsigned long)arg8;
- (void)doSearchContact:(id)arg1 FromScene:(unsigned long)arg2 SearchScene:(unsigned long)arg3 picUrl:(id)arg4;
- (void)doSearchContact:(id)arg1 SearchScene:(unsigned long)arg2 picUrl:(id)arg3;
- (void)alertView:(id)arg1 clickedButtonAtIndex:(int)arg2;
- (void)doUnknow:(id)arg1;
- (void)GetA8Key:(id)arg1 Scene:(unsigned long)arg2 codeType:(unsigned int)arg3 codeVersion:(unsigned int)arg4 appId:(id)arg5;
- (void)GetA8Key:(id)arg1 Scene:(unsigned long)arg2;
- (void)GetA8Key:(id)arg1 Scene:(unsigned long)arg2 subScene:(unsigned long)arg3 codeType:(unsigned int)arg4 codeVersion:(unsigned int)arg5;
