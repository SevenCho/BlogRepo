...
@class CTRichTextView, CountryCodeWrap, NSString, PhoneNumberFormatLogic, TakeOrSelectHeadImageLogic, UIButton, UIImage, UIView, WCAccountTextFieldItem, WCBaseKeyboardToolBar;
