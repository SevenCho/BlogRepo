...
- (BOOL)isAllSameBizType:(int)arg1 fromNode:(id)arg2;
- (BOOL)addPathComponent:(id)arg1 withRule:(const struct MMDiskUsageBizRule *)arg2 toRootNode:(id)arg3;
- (id)ruleDescription:(const struct MMDiskUsageBizRule *)arg1;
- (BOOL)isRuleValid:(const struct MMDiskUsageBizRule *)arg1;
