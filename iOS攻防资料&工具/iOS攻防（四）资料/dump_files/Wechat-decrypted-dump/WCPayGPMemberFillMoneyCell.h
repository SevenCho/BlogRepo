...
- (void)setNextBtnEnable:(BOOL)arg1;
- (void)setPreviousBtnEnable:(BOOL)arg1;
- (void)makeTextFieldBecomeFirstResponder;
- (void)updateCellContentWithContact:(id)arg1 payAmount:(double)arg2 displayName:(id)arg3 needShowSepLine:(BOOL)arg4;
