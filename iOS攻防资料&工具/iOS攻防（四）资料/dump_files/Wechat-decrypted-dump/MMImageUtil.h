...
+ (id)image:(id)arg1 scaleAspectFitSize:(struct CGSize)arg2 withOrientation:(int)arg3 imageData:(id)arg4;
...
+ (id)scaledImageWithData:(id)arg1 withSize:(struct CGSize)arg2 scale:(float)arg3 orientation:(int)arg4;
...
+ (id)maskImage:(id)arg1 addTriangle:(BOOL)arg2 isSender:(BOOL)arg3 inSize:(struct CGSize)arg4;
...
+ (void)addNodeViewPathToContext:(struct CGContext *)arg1 inRect:(struct CGRect)arg2 scale:(float)arg3;
