...
@property(readonly, nonatomic) unsigned int bubbleType; // @synthesize bubbleType=_bubbleType;
@property(readonly, nonatomic) NSString *iconUrl; // @synthesize iconUrl=_iconUrl;
- (void).cxx_destruct;
@property(readonly, nonatomic) NSString *iconName;
@property(readonly, nonatomic) float iconSize;
...
- (void)updateBgBubbleType:(unsigned int)arg1;
