...
- (void)OnEmoticonStoreItemDownloadProgressChanged:(id)arg1 CurrLength:(unsigned int)arg2 TotalLength:(unsigned int)arg3;
...
- (void)downloadEmoticonItem:(id)arg1 isAutomatic:(BOOL)arg2;
