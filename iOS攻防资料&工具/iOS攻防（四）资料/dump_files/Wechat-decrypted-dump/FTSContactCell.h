...
@class AttributeLabel, CContact, MMBrandHeadImageView, MMHeadImageView, MMUILabel, MMWebImageView, NSArray, NSString, SearchMatchTip, UIButton, UILabel;
...
@interface FTSContactCell : MMTableViewCell
{
    ...
    MMWebImageView *_iconNamePostfix;
