...
- (void)onWrapperView:(WAAppCanvasWrapperView *)arg1 viewStateChanged:(unsigned int)arg2;
...
- (void)onWrapperView:(WAAppCanvasWrapperView *)arg1 updateHeight:(float)arg2;
@end
