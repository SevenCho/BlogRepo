...
- (void)onMarkShareCardWithRet:(BOOL)arg1 isMark:(BOOL)arg2 andMarkUsr:(NSString *)arg3 markCardId:(NSString *)arg4 expireTime:(float)arg5 qrCodeWording:(NSString *)arg6;
