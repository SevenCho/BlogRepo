...
- (void).cxx_destruct;
- (id)getWSRedPointInfo:(BOOL)arg1;
- (void)tryUpdateSearchReddotClearedTimeStamps:(unsigned long)arg1;
- (void)tryUpdateRecommendReddotClearedTimeStamps:(unsigned long)arg1;
- (void)clearFFBrowseRedot;
- (void)clearFFSearchRedot;
- (BOOL)shouldShowFFBrowseRedot:(BOOL)arg1;
- (BOOL)shouldShowFFSearchRedot:(BOOL)arg1;
- (BOOL)shouldShowFindFriendTabRedotForSearch:(BOOL)arg1;
- (BOOL)shouldShowFindFriendTabRedotForRecommend:(BOOL)arg1;
