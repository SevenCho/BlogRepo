...
@property(nonatomic) BOOL bAnimating; // @synthesize bAnimating=_bAnimating;
- (void).cxx_destruct;
...
- (void)playWhistle;
- (id)getStreamerLayer:(BOOL)arg1;
- (id)getEmitterCell:(id)arg1 image:(id)arg2 isMore:(BOOL)arg3 isBack:(BOOL)arg4;
