...
- (id)getAuthResponsePkgWithOk:(id)arg1 withbackupID:(id)arg2 withStatus:(int)arg3 withVersion:(int)arg4 withType:(int)arg5 withSupportKv:(int)arg6;
- (id)getSecondAuthRequestPkg:(id)arg1 backupID:(id)arg2 version:(int)arg3 type:(int)arg4 supportExt:(int)arg5 needToken:(int)arg6;
- (id)getAuthRequestPkg:(id)arg1 backupID:(id)arg2 version:(int)arg3 type:(int)arg4 supportExt:(int)arg5 needToken:(int)arg6;
...
- (unsigned long)generateReceviveSequence;
