...
+ (void)saveMigrationSelectTextOnly:(BOOL)arg1;
+ (unsigned int)getSelectMigrationType;
+ (void)setSelectMigrationType:(unsigned int)arg1;
+ (BOOL)hasMigrationSelection;
+ (id)loadMigrationSelection;
+ (void)deleteMigrationSelection;
+ (BOOL)saveMigrationSelection:(id)arg1;
...
+ (unsigned int)checkMigrationRecoverState;
...
+ (void)writeBackupRecoverOnlyText:(BOOL)arg1;
+ (unsigned int)checkBackupRecoverState;
...
+ (BOOL)hasBackupDeleteSelection;
+ (id)loadBackupDeleteSelection;
+ (void)deleteBackupDeleteSelection;
+ (BOOL)saveBackupDeleteSelection:(id)arg1;
+ (BOOL)getBackupSelectTextOnlySetting;
+ (void)saveBackupSelectTextOnly:(BOOL)arg1;
+ (BOOL)hasBackupSelection;
+ (id)loadBackupSelection;
+ (void)deleteBackupSelection;
+ (BOOL)saveBackupSelection:(id)arg1;
