...
+ (void)reportFaceDetectResult:(unsigned int)arg1 isRetry:(BOOL)arg2 detectResult:(unsigned int)arg3 errorType:(unsigned int)arg4 errorCode:(unsigned int)arg5 errorCounter:(id)arg6 timeMeter:(id)arg7 appId:(id)arg8;
+ (void)reportFaceDetectVideoUploadResult:(unsigned long long)arg1 errorType:(unsigned int)arg2 errorCode:(unsigned int)arg3;
+ (void)reportStartFaceDetect:(unsigned int)arg1 isRetry:(BOOL)arg2;
- (void)dealloc;
- (id)init;
