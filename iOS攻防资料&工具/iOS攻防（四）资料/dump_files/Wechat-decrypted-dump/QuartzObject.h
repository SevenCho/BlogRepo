...
+ (id)getFontWithSize:(unsigned long)arg1 family:(id)arg2 weight:(id)arg3 style:(id)arg4;
+ (void)reset;
...
- (void)setPatternStyle:(struct CGContext *)arg1 data:(id)arg2 isFill:(BOOL)arg3;
...
- (void)drawText:(struct CGContext *)arg1 isStroke:(BOOL)arg2;
