...
+ (BOOL)saveImage:(id)arg1 toFile:(id)arg2 type:(struct __CFString *)arg3;
+ (id)getNetworkType;
...
+ (id)getStatusBarView;
+ (BOOL)isKindOfDictionary:(id)arg1;
+ (BOOL)isKindOfData:(id)arg1;
+ (BOOL)isKindOfString:(id)arg1;
+ (void)runBlockOnMainThread:(CDUnknownBlockType)arg1;
+ (BOOL)hasHttpSchemaPrefix:(id)arg1;
...
+ (unsigned long)appVersionInTaskFromAppVersionInContact:(unsigned long)arg1 debugMode:(unsigned long)arg2;
