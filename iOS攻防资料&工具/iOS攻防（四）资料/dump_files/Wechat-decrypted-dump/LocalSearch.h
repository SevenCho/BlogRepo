...
+ (BOOL)ftsMsgSearchHasTalkerContact:(id)arg1 arrContact:(id)arg2;
...
+ (BOOL)isMultiMatchObject:(id)arg1 object:(id)arg2 dicAddressBook:(id)arg3 matchTips:(id)arg4 helpDataItem:(id)arg5 extRule:(int)arg6 classInfo:(id)arg7;
...
+ (BOOL)isMatchText:(id)arg1 searchText:(id)arg2 regexMode:(BOOL)arg3 matchInfo:(id)arg4;
