...
- (id)_entryDataAtIndex:(unsigned int)arg1;
- (void)_setEntryCount:(unsigned int)arg1;
- (BOOL)entryExistsForEntityUUID:(id)arg1 sourceImageUUID:(id)arg2;
- (BOOL)imageExistsForEntity:(id)arg1;
- (BOOL)deleteEntryForEntityUUID:(id)arg1;
- (id)getImageForEntityUUID:(id)arg1 isNeedMemoryCache:(BOOL)arg2;
- (void)setEntryForEntityUUID:(id)arg1 imageDrawingBlock:(CDUnknownBlockType)arg2;
- (id)_chunkAtIndex:(unsigned int)arg1;
- (void)dealloc;
