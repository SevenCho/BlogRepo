...
@property(nonatomic) unsigned long m_uiFavType; // @synthesize m_uiFavType;
@property(nonatomic) unsigned long m_uiFavSubType; // @synthesize m_uiFavSubType;
...
@property(nonatomic) BOOL m_bBankFav; // @synthesize m_bBankFav;
- (void).cxx_destruct;
- (void)dealloc;
