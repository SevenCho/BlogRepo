...
- (void)authFailWithJSAPI:(NSString *)arg1 failHandler:(void (^)(NSString *))arg2 errMsg:(NSString *)arg3 scene:(unsigned int)arg4;
- (void)authOKWithJSAPI:(NSString *)arg1 handler:(void (^)(void))arg2 scene:(unsigned int)arg3;
