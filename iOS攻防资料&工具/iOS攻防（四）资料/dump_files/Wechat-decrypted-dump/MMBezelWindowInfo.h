...
@property(nonatomic) float descriptionLabelMarginTop; // @synthesize descriptionLabelMarginTop=_descriptionLabelMarginTop;
...
@property(nonatomic) float avatarViewMarginTop; // @synthesize avatarViewMarginTop=_avatarViewMarginTop;
