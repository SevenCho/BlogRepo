...
@property(nonatomic) BOOL hascoverurl; // @dynamic hascoverurl;
@property(nonatomic) BOOL isLikedCover; // @dynamic isLikedCover;
@property(nonatomic) BOOL iscacheexist; // @dynamic iscacheexist;
