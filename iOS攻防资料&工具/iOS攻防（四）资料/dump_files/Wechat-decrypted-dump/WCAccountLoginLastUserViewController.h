...
@interface WCAccountLoginLastUserViewController : WCAccountBaseViewController <IMMLanguageMgrExt, WCActionSheetDelegate>
{
    ...
    int m_currentLoginType;
    NSArray *m_accountChangeLoginTypeWording;
    BOOL m_bInAnimation;
    int m_uiLastLoginType;
    NSMutableArray *m_moreBtnArr;
    BOOL _m_bNoPwdLoginError;
    int _m_iCount;
}

@property(nonatomic) BOOL m_bNoPwdLoginError; // @synthesize m_bNoPwdLoginError=_m_bNoPwdLoginError;
@property(nonatomic) int m_iCount; // @synthesize m_iCount=_m_iCount;
- (void).cxx_destruct;
...
- (void)switchEaseInOutToType:(int)arg1;
- (void)onSwitch;
...
- (id)getSwitchBtnTitleWithCurrentLoginType:(unsigned int)arg1;
- (void)initFooterView;
