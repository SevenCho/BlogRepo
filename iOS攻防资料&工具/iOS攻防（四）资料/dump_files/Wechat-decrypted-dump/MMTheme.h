...
@property(nonatomic) int themeType; // @synthesize themeType=m_themeType;
@property(nonatomic) int finishedSize; // @synthesize finishedSize=m_finishedSize;
@property(nonatomic) int totalSize; // @synthesize totalSize=m_totalSize;
