...
@interface WCCanvasComponentReportSightInfo : WCCanvasComponentReportBasicInfo
{
    ...
    unsigned long _streamVideoTotalPlayTimeInMs;
...
@property(nonatomic) unsigned long streamVideoTotalPlayTimeInMs; // @synthesize streamVideoTotalPlayTimeInMs=_streamVideoTotalPlayTimeInMs;
