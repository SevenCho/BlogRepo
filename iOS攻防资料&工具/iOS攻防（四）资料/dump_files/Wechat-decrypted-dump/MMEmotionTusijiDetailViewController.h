...
- (void)makeRightDotLine:(id)arg1 marginPoint:(struct CGPoint)arg2 width:(float)arg3 height:(float)arg4;
- (void)makeLeftDotLine:(id)arg1 marginPoint:(struct CGPoint)arg2 width:(float)arg3 height:(float)arg4;
