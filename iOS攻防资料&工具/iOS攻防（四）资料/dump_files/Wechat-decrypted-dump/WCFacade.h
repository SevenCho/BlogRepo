...
@interface WCFacade : MMService <IContactMgrExt, IClearDataMgrExt, INewABTestMgrExt, PBMessageObserverDelegate, MMService, WCBGImgLogicNotity, WCDownloadMgrDelegate, WCTimelineDelegate, WCCommentUploadMgrDelegate, WCUploadMgrDelegate, WCNotificationCenterMgrDelegate, WCHomepageDelegate, WCLogicMgrDelegate, WCFacadeExt, WCBGRecommendMgrDelegate, WCGroupMgrExt, WCAdvertiseCommentUploadMgrDelegate, IMMFontMgrExt, WCPreloadLogicDelegate, IMsgExt, WCCdnDownloadImageDelegate>
{
    ...
    unsigned long m_clickCameraTime;
...
- (void)onCdnDownloadImageProcessChanged:(id)arg1 downloadType:(int)arg2 current:(int)arg3 total:(int)arg4;
...
- (void)setMessageNotificationForDataItem:(id)arg1 ignored:(BOOL)arg2;
...
- (unsigned int)startDownloadSightMedia:(id)arg1 DownloadMode:(unsigned int)arg2;
- (unsigned int)startDownloadSightMedia:(id)arg1;
- (unsigned int)GetWCAlbumVideoDownloadMode:(id)arg1;
- (unsigned int)GetWCVideoDownloadMode:(id)arg1;
...
- (void)commentObject:(id)arg1 ofUser:(id)arg2 content:(id)arg3 ref:(id)arg4 source:(int)arg5 isActionAtAd:(BOOL)arg6;
...
- (void)tryLogBigImageLoadedEfficency:(id)arg1 mid:(id)arg2 loadedResult:(unsigned long)arg3 costTime:(unsigned long)arg4;
...
- (void)tryLogClickBigImage:(id)arg1 clickIndex:(unsigned long)arg2 clickCount:(unsigned long)arg3 downloadCount:(unsigned long)arg4 scanIndexArrayStr:(id)arg5 scaleOutIndexArrayStr:(id)arg6 scaleInIndexArrayStr:(id)arg7 IsCollapsed:(unsigned long)arg8;
