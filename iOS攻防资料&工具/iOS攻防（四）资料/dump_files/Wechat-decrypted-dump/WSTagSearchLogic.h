...
@property(nonatomic) BOOL bForbidTagDeletion; // @synthesize bForbidTagDeletion=_bForbidTagDeletion;
...
- (BOOL)tagSearchObj:(id)arg1 shouldChangeTextInRange:(struct _NSRange)arg2 replacementText:(id)arg3;
- (void)setTagHolders:(id)arg1 withNormalText:(id)arg2;
- (void)addTagName:(id)arg1 withType:(unsigned long)arg2 withExtraInfo:(id)arg3;
- (void)dealloc;
