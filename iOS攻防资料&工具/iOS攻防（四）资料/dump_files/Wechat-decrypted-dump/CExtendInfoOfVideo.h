...
@interface CExtendInfoOfVideo : NSObject <IMessageWrapExt, IMsgExtendOperation, NSCopying>
{
    ...
    unsigned long m_uiPreDownloadPercent;
    unsigned long m_uiPreDownloadNetType;
...
@property(nonatomic) unsigned long m_uiPreDownloadNetType; // @synthesize m_uiPreDownloadNetType;
@property(nonatomic) unsigned long m_uiPreDownloadPercent; // @synthesize m_uiPreDownloadPercent;
@property(nonatomic) unsigned long m_uiVideoFormat; // @synthesize m_uiVideoFormat;
