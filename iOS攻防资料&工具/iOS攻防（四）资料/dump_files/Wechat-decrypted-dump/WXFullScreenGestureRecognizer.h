...
@interface WXFullScreenGestureRecognizer : UIGestureRecognizer <UIGestureRecognizerDelegate>
{
    ...
    float _panGestureAnimationDuration;
    BOOL _hasBeginDrag;
...
@property(nonatomic) BOOL enableDragDownToClose; // @synthesize enableDragDownToClose=_enableDragDownToClose;
...
- (BOOL)shouldCloseWhenGestureEndWithTranslation:(struct CGPoint)arg1;
- (float)durationFromCurPositionToTargetPointWithSpeed:(float)arg1;
