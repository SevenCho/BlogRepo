...
@interface WCPayLocalCachedData : NSObject <NSCoding>
{
    ...
    BOOL m_bIsAcceptRealnameLicense;
    float licenseLastQueryTime;
    int licenseQueryDelaySeconds;
    double m_tLBSLastShowTime;
    BOOL m_bIsShowOfflinePayTips;
    NSString *m_nsBalanceDetailRealnameGuideTitle;
    NSString *m_nsWalletBalanceTitle;
    BOOL _m_bIsShowHKFacingReceiveFirstTips;
...
@property(nonatomic) BOOL m_bIsShowHKFacingReceiveFirstTips; // @synthesize m_bIsShowHKFacingReceiveFirstTips=_m_bIsShowHKFacingReceiveFirstTips;
...
@property(nonatomic) BOOL m_bIsShowOfflinePayTips; // @synthesize m_bIsShowOfflinePayTips;
...
@property(nonatomic) int licenseQueryDelaySeconds; // @synthesize licenseQueryDelaySeconds;
@property(nonatomic) float licenseLastQueryTime; // @synthesize licenseLastQueryTime;
@property(nonatomic) BOOL m_bIsAcceptRealnameLicense; // @synthesize m_bIsAcceptRealnameLicense;
