...
- (BOOL)updateEnterpriseContactFromSvrIfNeed:(id)arg1 brand:(id)arg2 contactVer:(unsigned long)arg3 needDelay:(unsigned long)arg4;
- (BOOL)batchUpdateEnterpriseContactFromSvrIfNeed:(id)arg1 brand:(id)arg2;
...
- (id)getOrAddContactByUserName:(id)arg1 brand:(id)arg2 toDB:(BOOL)arg3 inDB:(char *)arg4;
- (id)getOrAddContactByUserName:(id)arg1 displayName:(id)arg2 brand:(id)arg3 toDB:(BOOL)arg4 inDB:(char *)arg5;
