...
@interface VOIPCSMgr : MMService <IAUAudioDeviceExt, INetworkStatusMgrExt, PBMessageObserverDelegate, MMService, AVVideoDeviceSessionDelegate, AVVideoDataSource, AUAudioDataSource, ISysCallCheckExt>
{
    ...
    BOOL m_usingFrontCameraLastFrame;
    ...
    int m_cameraChangeToOrientation;
    ...
    unsigned long mNextInviteTimestamp;
    ...
    unsigned long _mInviteId;
    unsigned long _mVoIPType;
    int _status;
    ...
    unsigned long _mMaxBitRateCS;
    unsigned long _mMaxFPSCS;
    unsigned long _mTimeCounter;
...
@property BOOL mIsShouldSendSPS; // @synthesize mIsShouldSendSPS=_mIsShouldSendSPS;
...
@property(nonatomic) unsigned long mTimeCounter; // @synthesize mTimeCounter=_mTimeCounter;
@property(nonatomic) unsigned long mMaxFPSCS; // @synthesize mMaxFPSCS=_mMaxFPSCS;
@property(nonatomic) unsigned long mMaxBitRateCS; // @synthesize mMaxBitRateCS=_mMaxBitRateCS;
...
@property(nonatomic) unsigned long mVoIPType; // @synthesize mVoIPType=_mVoIPType;
@property(nonatomic) unsigned long mInviteId; // @synthesize mInviteId=_mInviteId;
@property(nonatomic) BOOL mFromJSAPI; // @synthesize mFromJSAPI;
@property(nonatomic) BOOL mFromFaceAuth; // @synthesize mFromFaceAuth;
@property(nonatomic) unsigned int mCalleeMemberId; // @synthesize mCalleeMemberId;
@property(nonatomic) BOOL mNeedHeartBeat; // @synthesize mNeedHeartBeat;
...
@property(nonatomic) unsigned long mNextInviteTimestamp; // @synthesize mNextInviteTimestamp;
...
@property(nonatomic) BOOL mIsVideoInited; // @synthesize mIsVideoInited;
...
@property(nonatomic) int m_cameraChangeToOrientation; // @synthesize m_cameraChangeToOrientation;
@property(nonatomic) BOOL m_usingFrontCameraLastFrame; // @synthesize m_usingFrontCameraLastFrame;
@property(nonatomic) int m_cameraOrientation; // @synthesize m_cameraOrientation;
...
- (void)Hangup:(unsigned long)arg1;
- (void)VideoCall:(id)arg1 withCallType:(unsigned long)arg2 appid:(id)arg3;
- (void)AudioCall:(id)arg1 withCallType:(unsigned long)arg2 appid:(id)arg3;
...
- (void)GetLocalCapInfoWithVoipType:(unsigned long)arg1;
- (void)HandleVoipCSRedirectResp:(id)arg1 Event:(unsigned long)arg2;
- (void)HandleVoipCSReportResp:(id)arg1 Event:(unsigned long)arg2;
- (void)HandleVoipCSHeartBeatResp:(id)arg1 Event:(unsigned long)arg2;
- (void)HandleVoipCSSyncResp:(id)arg1 Event:(unsigned long)arg2;
- (void)HandleVoipCSHangupResp:(id)arg1 Event:(unsigned long)arg2;
- (void)HandleVoipCSInviteResp:(id)arg1 Event:(unsigned long)arg2;
- (void)SendVoipCSRedirectReq;
- (void)SendVoipCSHeartBeatReq;
- (void)SendVoipCSSyncReqBy:(unsigned long)arg1;
- (void)SendVoipCSHangupReqBy:(id)arg1 reason:(unsigned long)arg2;
