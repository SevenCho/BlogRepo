...
{
    BOOL _isCardCodeExposed;
    BOOL _dismissQrcodeIconOnCard;
    BOOL _isNeedLocation;
    BOOL _needDirectjump;
    BOOL _hasHongbao;
    BOOL _isAcceptable;
    BOOL _isShowAcceptView;
    ...
    unsigned long _qrcodeCorrectLevel;
...
@property(nonatomic) BOOL isShowAcceptView; // @synthesize isShowAcceptView=_isShowAcceptView;
@property(retain, nonatomic) NSString *unacceptableWording; // @synthesize unacceptableWording=_unacceptableWording;
@property(nonatomic) BOOL isAcceptable; // @synthesize isAcceptable=_isAcceptable;
@property(nonatomic) BOOL hasHongbao; // @synthesize hasHongbao=_hasHongbao;
...
@property(nonatomic) BOOL needDirectjump; // @synthesize needDirectjump=_needDirectjump;
...
@property(nonatomic) BOOL isNeedLocation; // @synthesize isNeedLocation=_isNeedLocation;
@property(nonatomic) unsigned long qrcodeCorrectLevel; // @synthesize qrcodeCorrectLevel=_qrcodeCorrectLevel;
@property(nonatomic) BOOL dismissQrcodeIconOnCard; // @synthesize dismissQrcodeIconOnCard=_dismissQrcodeIconOnCard;
@property(nonatomic) BOOL isCardCodeExposed; // @synthesize isCardCodeExposed=_isCardCodeExposed;
...
@property(nonatomic) unsigned long genType; // @synthesize genType=_genType;
...
@property(nonatomic) unsigned long controlflag; // @synthesize controlflag=_controlflag;
@property(retain, nonatomic) WCCardUsedStoreInfo *oneShopInfo; // @synthesize oneShopInfo=_oneShopInfo;
@property(nonatomic) unsigned long blockMask; // @synthesize blockMask=_blockMask;
...
@property(nonatomic) unsigned long shopCount; // @synthesize shopCount=_shopCount;
