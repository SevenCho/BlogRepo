...
+ (void)reportClickBannerWhenReachLimit:(BOOL)arg1 wxGroupId:(id)arg2 roomid:(unsigned int)arg3 roomkey:(unsigned long long)arg4;
+ (void)reportClickCancelButtonForRejectOfBanner:(BOOL)arg1 overLimit:(BOOL)arg2 result:(BOOL)arg3 wxGroupId:(id)arg4 roomid:(unsigned int)arg5 roomkey:(unsigned long long)arg6;
+ (void)reportClickCancelButtonOfBanner:(BOOL)arg1 overLimit:(BOOL)arg2 result:(BOOL)arg3 wxGroupId:(id)arg4 roomid:(unsigned int)arg5 roomkey:(unsigned long long)arg6;
+ (void)reportClickEnterButtonOfBanner:(BOOL)arg1 overLimit:(BOOL)arg2 result:(BOOL)arg3 wxGroupId:(id)arg4 roomid:(unsigned int)arg5 roomkey:(unsigned long long)arg6;
