...
- (void)StartDownloadByRecordData:(id)arg1 DataId:(id)arg2 prior:(BOOL)arg3;
- (void)StartDownloadByRecordData:(id)arg1 DataId:(id)arg2;
- (BOOL)StartDownloadByRecordMsg:(id)arg1;
...
- (BOOL)StartDownloadAppAttachInCDN:(id)arg1 MsgWrap:(id)arg2 Silent:(BOOL)arg3;
...
- (void)onNewSyncShowPush:(id)arg1 isAlwaysShow:(BOOL)arg2;
...
- (BOOL)StartDownloadAppAttach:(id)arg1 MsgWrap:(id)arg2 Silent:(BOOL)arg3;
- (BOOL)StartDownloadAppAttach:(id)arg1 MsgWrap:(id)arg2;
...
- (void)downLoadRemainPart:(id)arg1 DownloadMode:(unsigned int)arg2;
- (void)delayDownloadVideoRemainPart:(id)arg1 DownloadMode:(unsigned int)arg2;
...
- (unsigned int)GetVideoMessageDownloadMode:(id)arg1;
- (unsigned int)GetVideoMessageDownloadModeFromCDNTask:(id)arg1;
...
- (unsigned int)StartDownloadVideo:(id)arg1 MsgWrap:(id)arg2 Priority:(BOOL)arg3 DownloadMode:(unsigned int)arg4 Silent:(BOOL)arg5;
- (unsigned int)StartDownloadVideo:(id)arg1 MsgWrap:(id)arg2 Priority:(BOOL)arg3 DownloadMode:(unsigned int)arg4;
...
- (id)AddVideoMsg:(id)arg1 ToUsr:(id)arg2 VideoInfo:(id)arg3 MsgType:(unsigned long)arg4;
...
- (id)GetTextMsg:(id)arg1 FromID:(unsigned long)arg2 Limit:(int)arg3 LeftCount:(unsigned int *)arg4 LeftUnreadCount:(unsigned int *)arg5;
- (void)DelOverTimeNewBizExtMsgsOnType:(int)arg1;
- (id)GetAllChatNameWithValidNewBizMsg;
- (unsigned long)GetAllValidNewBizMsgCount;
- (unsigned long)GetValidNewBizMsgCountByChatName:(id)arg1 bizType:(int)arg2;
...
- (id)QueryMsgFromChat:(id)arg1 queryText:(id)arg2 FromID:(unsigned long)arg3 FromCreateTime:(unsigned long)arg4 Limit:(int)arg5 LeftCount:(unsigned int *)arg6;
...
- (id)GetFirstMsgByCreateTime:(id)arg1 FromID:(unsigned long)arg2 FromCreateTime:(unsigned long)arg3 Limit:(int)arg4 LeftCount:(unsigned int *)arg5;
- (id)GetLastMsgByCreateTime:(id)arg1 FromID:(unsigned long)arg2 FromCreateTime:(unsigned long)arg3 Limit:(int)arg4 LeftCount:(unsigned int *)arg5;
...
- (void)reloadRevokeMsg:(id)arg1 after:(unsigned long)arg2;
...
- (void)AsyncOnPushMsg:(id)arg1 isAlwaysShow:(BOOL)arg2;
