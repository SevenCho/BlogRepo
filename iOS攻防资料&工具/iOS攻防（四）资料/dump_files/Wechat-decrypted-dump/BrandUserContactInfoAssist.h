...
@class CertInfo, MMBrandHeadImageView, MMTableView, NSArray, NSMutableArray, NSString, UIButton, UIView, WCADPageWrap, WOAPPrivacyConfirmLogic;
...
- (BOOL)isJustAddedSubsriptionOrServiceBrandContact;
