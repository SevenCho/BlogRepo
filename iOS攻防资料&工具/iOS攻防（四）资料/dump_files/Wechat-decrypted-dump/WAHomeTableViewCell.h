...
@property(nonatomic) unsigned long stateFlag; // @synthesize stateFlag=_stateFlag;
- (void).cxx_destruct;
- (void)onLoadImageOK:(id)arg1;
- (void)hideMenuOptionsAnimated:(BOOL)arg1 completion:(CDUnknownBlockType)arg2;
- (void)markUnBottom;
- (void)markBottom;
- (void)markUnStaredAnimated:(BOOL)arg1;
- (void)markStaredAnimated:(BOOL)arg1;
