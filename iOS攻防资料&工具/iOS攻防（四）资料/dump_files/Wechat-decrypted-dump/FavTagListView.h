...
- (void)setButtonHighLight:(BOOL)arg1 named:(id)arg2;
- (id)addButton:(id)arg1;
- (void)setButtonBackground:(id)arg1 chosen:(BOOL)arg2;
- (void)layoutSubviews;
- (id)initWithTags:(id)arg1 title:(id)arg2 btnimg:(id)arg3 txtColor:(id)arg4 centerAlignment:(BOOL)arg5;
