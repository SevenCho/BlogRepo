...
- (void).cxx_destruct;
- (void)onServerRejectShowTipsId:(unsigned long)arg1 Version:(unsigned long)arg2;
- (void)OnGetNewXmlMsg:(id)arg1 Type:(id)arg2 MsgWrap:(id)arg3;
- (void)onServiceReloadData;
- (void)onServiceInit;
- (void)registerDynamicTips:(unsigned long)arg1 FilterClass:(id)arg2 Path:(id)arg3;
- (void)registerDynamicTips:(unsigned long)arg1;
- (void)registerLocalTips:(unsigned long)arg1 Version:(unsigned long)arg2 Key:(id)arg3;
- (id)getNewTipsInfoWithId:(unsigned long)arg1;
- (void)reportPageStayTimeWithTipsId:(unsigned long)arg1;
- (void)disposeTipsWithId:(unsigned long)arg1;
...
- (BOOL)canShowRedPathPointWithKey:(id)arg1;
- (void)dealloc;
