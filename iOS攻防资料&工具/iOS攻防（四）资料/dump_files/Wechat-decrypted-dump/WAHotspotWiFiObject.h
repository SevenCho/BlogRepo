...
@property(readonly, nonatomic) BOOL justJoined; // @synthesize justJoined=_justJoined;
@property(readonly, nonatomic) BOOL autoJoined; // @synthesize autoJoined=_autoJoined;
