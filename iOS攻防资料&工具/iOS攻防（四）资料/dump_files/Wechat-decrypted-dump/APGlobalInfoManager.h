...
+ (id)singleton;
@property(nonatomic) BOOL disableReprovidePrompt; // @synthesize disableReprovidePrompt=_disableReprovidePrompt;
@property(nonatomic) BOOL hideLoading; // @synthesize hideLoading=_hideLoading;
@property(nonatomic) BOOL excludeBundle; // @synthesize excludeBundle=_excludeBundle;
