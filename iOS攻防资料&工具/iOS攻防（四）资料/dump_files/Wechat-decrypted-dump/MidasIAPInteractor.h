...
- (void)blockProcessMpCgiError:(id)arg1 errorCode:(int)arg2 inner:(id)arg3 msg:(id)arg4 operation:(id)arg5;
- (void)blockProcessMpNetError:(id)arg1 operation:(id)arg2;
- (id)operationFromMpReq:(id)arg1 delegate:(id)arg2;
- (void)checkReprovide;
- (BOOL)checkMainThreadAndRegister:(BOOL)arg1;
- (void)uploadDeviceInfo:(id)arg1;
- (BOOL)validateInitParamOfReq:(id)arg1 environment:(id)arg2 locale:(id)arg3 extra:(id)arg4;
- (void)onManualReprovideResp:(id)arg1;
- (void)setInitGetCfgResult:(BOOL)arg1;
- (void)manualReprovideFromOperation:(id)arg1;
- (void)showRiskAlert:(id)arg1 errorCode:(int)arg2 completion:(CDUnknownBlockType)arg3;
- (void)launchH5PayPage:(id)arg1 delegate:(id)arg2;
- (void)launchResultPage:(id)arg1 resp:(id)arg2 delegate:(id)arg3;
- (void)backToGame:(id)arg1 isSuccess:(BOOL)arg2 delegate:(id)arg3;
...
- (BOOL)isIAPEnable;
- (void)dealloc;
- (BOOL)initializeWithReq:(id)arg1 environment:(id)arg2 locale:(id)arg3 extra:(id)arg4 reprovideDelegate:(id)arg5;
