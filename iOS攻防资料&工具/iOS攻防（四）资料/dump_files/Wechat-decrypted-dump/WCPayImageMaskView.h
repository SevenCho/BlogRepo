...
{
    unsigned long _tilesX;
    unsigned long _tilesY;
    int _tilesFilled;
...
@property(nonatomic) BOOL isCanScratch; // @synthesize isCanScratch=_isCanScratch;
...
@property(readonly, nonatomic) float percentsOfImageMasked;
- (void)handleTapGesture:(id)arg1;
- (id)initWithFrame:(struct CGRect)arg1;
- (void)initialize;
- (void)dealloc;
- (void)setImage:(id)arg1 radius:(unsigned long)arg2;
