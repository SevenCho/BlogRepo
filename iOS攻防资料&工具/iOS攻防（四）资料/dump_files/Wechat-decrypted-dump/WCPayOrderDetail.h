...
@interface WCPayOrderDetail : NSObject
{
    ...
    unsigned long m_uiQueryInfoQueryOrderTime;
    unsigned long m_uiQueryInfoQueryOrderCount;
...
@property(nonatomic) BOOL m_bTouchIDAuthFailed; // @synthesize m_bTouchIDAuthFailed;
@property(retain, nonatomic) NSString *m_nsWapPayTips; // @synthesize m_nsWapPayTips;
@property(nonatomic) BOOL m_bNeedAfterPaidErrorQueryOrder; // @synthesize m_bNeedAfterPaidErrorQueryOrder;
@property(nonatomic) unsigned long m_uiQueryInfoQueryOrderCount; // @synthesize m_uiQueryInfoQueryOrderCount;
@property(nonatomic) unsigned long m_uiQueryInfoQueryOrderTime; // @synthesize m_uiQueryInfoQueryOrderTime;
@property(nonatomic) unsigned long m_uiAfterPaidErrorQueryOrderTime; // @synthesize m_uiAfterPaidErrorQueryOrderTime;
@property(nonatomic) int m_touchIDType; // @synthesize m_touchIDType;
...
@property(nonatomic) BOOL m_bAllowedRetrySendMsg; // @synthesize m_bAllowedRetrySendMsg;
@property(nonatomic) unsigned long m_uiInsertEvaluateCellIndex; // @synthesize m_uiInsertEvaluateCellIndex;
...
@property(nonatomic) BOOL m_isOpenFeeProtocal; // @synthesize m_isOpenFeeProtocal;
...
@property(nonatomic) unsigned long m_productCount; // @synthesize m_productCount;
@property(nonatomic) BOOL m_bNeedShowProductDetailMoneyInfo; // @synthesize m_bNeedShowProductDetailMoneyInfo;
