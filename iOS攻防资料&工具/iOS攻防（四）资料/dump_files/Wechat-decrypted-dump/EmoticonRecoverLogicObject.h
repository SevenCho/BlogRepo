...
@property(nonatomic) BOOL m_needUpdateTime; // @synthesize m_needUpdateTime=_m_needUpdateTime;
...
- (void)continueDownloadFromDownloadFinished:(BOOL)arg1;
...
- (BOOL)clearLocalContentByMd5List:(id)arg1;
