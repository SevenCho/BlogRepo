...
- (BOOL)haveFreeSpace:(id)arg1 writeSize:(unsigned long long)arg2;
- (void)workThread_unzipWithAppID:(id)arg1 localID:(id)arg2 targetDirectory:(id)arg3 handler:(CDUnknownBlockType)arg4;
- (void)workthread_writeFileDataWithAppID:(id)arg1 localID:(id)arg2 isAppend:(BOOL)arg3 data:(id)arg4 handler:(CDUnknownBlockType)arg5;
- (void)workthread_readFileDataWithAppID:(id)arg1 localID:(id)arg2 fromPosition:(unsigned int)arg3 length:(unsigned int)arg4 handler:(CDUnknownBlockType)arg5;
...
- (void)writeFileDataWithAppID:(id)arg1 localID:(id)arg2 isAppend:(BOOL)arg3 data:(id)arg4 handler:(CDUnknownBlockType)arg5;
- (void)readFileDataWithAppID:(id)arg1 localID:(id)arg2 fromPosition:(unsigned int)arg3 length:(unsigned int)arg4 handler:(CDUnknownBlockType)arg5;
