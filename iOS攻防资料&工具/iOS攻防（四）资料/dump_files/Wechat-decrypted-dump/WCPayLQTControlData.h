...
{
    unsigned int _lqtMoneyScene;
    unsigned long _lqtCurrentTransMoney;
...
@property(nonatomic) int needOpenLqb; // @synthesize needOpenLqb=_needOpenLqb;
...
@property(nonatomic) unsigned long lqtCurrentTransMoney; // @synthesize lqtCurrentTransMoney=_lqtCurrentTransMoney;
@property(nonatomic) unsigned int lqtMoneyScene; // @synthesize lqtMoneyScene=_lqtMoneyScene;
- (void).cxx_destruct;
