...
@interface WCAccountMainLoginViewController : WCAccountBaseViewController <CountryCodePickerDelegate, UITextFieldDelegate, ILinkEventExt>
{
    ...
    UIButton *_btnNext;
    unsigned int _enLoginType;
    BOOL _bInSwitchAnimation;
    UIView *m_oBottomView;
    NSMutableArray *m_moreBtnArr;
    BOOL _bShouldShowBackBtn;
    BOOL _bShowPhoneLoginViewFirst;
}

@property(nonatomic) BOOL bShowPhoneLoginViewFirst; // @synthesize bShowPhoneLoginViewFirst=_bShowPhoneLoginViewFirst;
@property(nonatomic) BOOL bShouldShowBackBtn; // @synthesize bShouldShowBackBtn=_bShouldShowBackBtn;
- (void).cxx_destruct;
