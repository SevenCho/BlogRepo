...
@interface VideoVoipReceiverView : VideoVoipView <IVoipCXMgrExt, UIAlertViewDelegate, IRecordPermissionCheckExt>
{
    ...
    unsigned long _m_timerCnt;
}

@property(nonatomic) BOOL m_hasInitCameraDevice; // @synthesize m_hasInitCameraDevice=_m_hasInitCameraDevice;
@property(nonatomic) unsigned long m_timerCnt; // @synthesize m_timerCnt=_m_timerCnt;
