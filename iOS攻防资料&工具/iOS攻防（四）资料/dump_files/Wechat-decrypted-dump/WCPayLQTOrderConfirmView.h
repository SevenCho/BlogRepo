...
@property(nonatomic) unsigned long money; // @synthesize money=_money;
...
- (void)setupSubView;
- (id)initLQTConfirmViewWithFrame:(struct CGRect)arg1 money:(unsigned long)arg2 delegate:(id)arg3;
- (void)dealloc;
