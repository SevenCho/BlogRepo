...
@interface FileFragment : NSObject
{
    ...
    unsigned long _m_uploadId;
}

@property(nonatomic) unsigned long m_uploadId; // @synthesize m_uploadId=_m_uploadId;
...
- (void).cxx_destruct;
- (unsigned long)size;
- (id)initWithPath:(id)arg1 fragmentData:(id)arg2 packageIndex:(unsigned int)arg3 totalPackage:(unsigned int)arg4 uploadId:(unsigned long)arg5;
