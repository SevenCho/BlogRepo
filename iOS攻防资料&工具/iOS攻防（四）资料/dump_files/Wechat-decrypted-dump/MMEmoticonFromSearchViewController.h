...
- (void)onExchangeEmoticonForSendingFinishedWithWrap:(id)arg1 isSuccessed:(BOOL)arg2;
...
- (void)setButton:(id)arg1 enable:(BOOL)arg2;
...
- (void)doForwardEmot;
- (void)doAddEmot;
- (BOOL)shouldDisplaySendButtonToContent;
