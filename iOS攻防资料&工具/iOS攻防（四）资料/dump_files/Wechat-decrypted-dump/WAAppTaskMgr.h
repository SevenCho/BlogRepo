...
@interface WAAppTaskMgr : MMService <WAAppTaskDelegate, IVOIPUILogicMgrExt, WAGameTaskMgrExt, MMService>
{
    ...
    unsigned long lastMemoryWaringTimeStamp;
...
- (unsigned int)getCurrentBackToChatDebugType;
...
- (void)markBackToChatWithAppID:(id)arg1 usrName:(id)arg2 relativePath:(id)arg3 debugModeType:(unsigned int)arg4;
- (unsigned long)maxGameTaskRunningCount;
...
- (void)closeAllTaskUseTips:(BOOL)arg1;
...
- (id)allTaskArray;
- (BOOL)isNeedCloseAppTaskToOpenPagePath:(id)arg1 appID:(id)arg2 appType:(unsigned long)arg3;
- (BOOL)isNeedNewTask:(id)arg1 pagePath:(id)arg2 appType:(unsigned long)arg3;
- (id)getTaskWithAppID:(id)arg1;
- (id)getAndNewTaskIfNotExistWithAppID:(id)arg1 relativeURL:(id)arg2 taskExtInfo:(id)arg3 debugModeType:(unsigned long)arg4;
...
- (unsigned int)getJumpRoleWithAppId:(id)arg1;
- (void)addJumpWeAppRelationWithFromAppId:(id)arg1 toAppId:(id)arg2 jumpScene:(unsigned int)arg3;
