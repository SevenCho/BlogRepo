...
@interface WCPayTransBankItem : MMObject <IWCPaySelecBankItem>
{
    ...
    unsigned long _m_uiBankFlag;
    unsigned long _m_uiChargeFee;
...
@property(nonatomic) unsigned long m_uiChargeFee; // @synthesize m_uiChargeFee=_m_uiChargeFee;
@property(nonatomic) unsigned long m_uiBankFlag; // @synthesize m_uiBankFlag=_m_uiBankFlag;
