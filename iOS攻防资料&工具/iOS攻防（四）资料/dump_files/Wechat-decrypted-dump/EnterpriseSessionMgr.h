...
- (void)internalUpdateMainSessionInfoForBrand:(id)arg1 lastMsg:(id)arg2 checkLastMsg:(BOOL)arg3;
- (void)updateMainSessionInfoForBrand:(id)arg1 lastMsg:(id)arg2 checkLastMsg:(BOOL)arg3;
