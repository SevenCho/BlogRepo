...
@property(nonatomic) int fromScence; // @synthesize fromScence=_fromScence;
...
@property(nonatomic) unsigned long bizUin; // @synthesize bizUin=_bizUin;
...
- (id)initWithBizUin:(unsigned long)arg1 orderId:(id)arg2;
