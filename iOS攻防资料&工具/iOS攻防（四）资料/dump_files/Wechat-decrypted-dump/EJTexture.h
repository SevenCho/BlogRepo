...
@property(readonly, nonatomic) BOOL readOnly; // @synthesize readOnly;
@property(retain, nonatomic) EJSharedTextureCache *textureCache; // @synthesize textureCache;
@property(readonly, nonatomic) BOOL lazyLoaded; // @synthesize lazyLoaded;
@property(nonatomic) BOOL drawFlippedY; // @synthesize drawFlippedY;
...
- (void)ensureMutableKeepPixels:(BOOL)arg1 forTarget:(unsigned int)arg2;
