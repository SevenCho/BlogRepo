...
@property(nonatomic) int fileCountForDownload; // @synthesize fileCountForDownload=_fileCountForDownload;
...
- (BOOL)saveFileInfoSnapshot:(id)arg1;
- (id)fileInfoSnapshot;
