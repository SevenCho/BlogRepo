...
@property(nonatomic) BOOL needShowActionsheet; // @synthesize needShowActionsheet=_needShowActionsheet;
...
- (void).cxx_destruct;
- (float)originXForLineAtHeight:(float)arg1 richTextView:(id)arg2;
