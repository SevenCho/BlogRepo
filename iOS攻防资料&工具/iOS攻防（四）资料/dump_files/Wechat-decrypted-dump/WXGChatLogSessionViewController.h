...
{
    unsigned int m_curMaxDataCount;
    NSDate *m_beginBeginDate;
    NSDate *m_endEndDate;
    NSDate *m_beginDate;
    NSDate *m_endDate;
    BOOL m_selectAllTime;
    BOOL m_selectTextOnly;
    BOOL _doneWithPop;
    BOOL _showSize;
    BOOL _showSelectTime;
    BOOL _showSelectTextOnly;
...
@property(nonatomic) BOOL showSelectTextOnly; // @synthesize showSelectTextOnly=_showSelectTextOnly;
@property(nonatomic) BOOL showSelectTime; // @synthesize showSelectTime=_showSelectTime;
@property(nonatomic) BOOL showSize; // @synthesize showSize=_showSize;
@property(nonatomic) BOOL doneWithPop; // @synthesize doneWithPop=_doneWithPop;
- (void).cxx_destruct;
- (void)onSelectTimeViewCompleteWithBeginDate:(id)arg1 endDate:(id)arg2 selectAllTime:(BOOL)arg3 selectTextOnly:(BOOL)arg4;
...
- (BOOL)whetherSelectAllTime;
- (BOOL)whetherSessionItemSelected:(id)arg1;
- (void)loadMoreData;
