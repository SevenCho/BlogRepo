...
@property(nonatomic) unsigned long addressMgrId; // @synthesize addressMgrId=_addressMgrId;
@property(nonatomic) unsigned long locationMgrId; // @synthesize locationMgrId=_locationMgrId;
- (void).cxx_destruct;
