...
+ (unsigned long)packDesCnt;
@property(readonly, nonatomic) unsigned long bufSize; // @synthesize bufSize=_bufferSize;
...
- (void)dealloc;
- (id)initWithAudioBuf:(struct AudioQueueBuffer *)arg1 size:(unsigned long)arg2;
