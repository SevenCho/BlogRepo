...
@interface VideoStreamInfo : NSObject
{
    ...
    long _m_siVideoBitrate;
    unsigned long _m_uiVideoLen;
    NSString *_m_nsVideoPath;
    NSString *_m_nsDataUrl;
    NSString *_m_nsAesKey;
    unsigned int _m_uiDownloadMode;
    float _m_uiMaxLimitDuration;
    float _m_uiPreloadSec;
    float _m_uiSecByOnceDownload;
    float _minBufferLimit;
    float _maxBufferLimit;
    unsigned long _m_uiMoovPos;
    WCUrl *_m_wcDataUrl;
    unsigned long _m_uiDownloadStatus;
}

@property(nonatomic) unsigned long m_uiDownloadStatus; // @synthesize m_uiDownloadStatus=_m_uiDownloadStatus;
@property(retain, nonatomic) WCUrl *m_wcDataUrl; // @synthesize m_wcDataUrl=_m_wcDataUrl;
@property(nonatomic) unsigned long m_uiMoovPos; // @synthesize m_uiMoovPos=_m_uiMoovPos;
...
@property(nonatomic) unsigned int m_uiDownloadMode; // @synthesize m_uiDownloadMode=_m_uiDownloadMode;
...
@property(nonatomic) unsigned long m_uiVideoLen; // @synthesize m_uiVideoLen=_m_uiVideoLen;
@property(nonatomic) long m_siVideoBitrate; // @synthesize m_siVideoBitrate=_m_siVideoBitrate;
...
- (void).cxx_destruct;
- (BOOL)isDownloadWhilePlayingMode;
- (id)init;
