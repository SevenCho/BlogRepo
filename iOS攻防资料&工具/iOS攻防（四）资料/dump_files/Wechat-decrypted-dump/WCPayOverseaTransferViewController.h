...
@interface WCPayOverseaTransferViewController : WCPayBaseViewController <MMTipsViewControllerDelegate, WCPayCurrencyInputViewDelegate, MMWebViewDelegate, UIScrollViewDelegate, WCPayNoticeBannerViewDelegate, WCPayCommentTextViewDelegate>
{
    ...
    BOOL _m_isKeyBoardHide;
    BOOL _m_bKeyboardHasShown;
...
@property(nonatomic) BOOL m_bKeyboardHasShown; // @synthesize m_bKeyboardHasShown=_m_bKeyboardHasShown;
@property(nonatomic) float confirmBtnY; // @synthesize confirmBtnY=_confirmBtnY;
@property(retain, nonatomic) WCPayBannerNotice *m_bannerNotice; // @synthesize m_bannerNotice=_m_bannerNotice;
@property(nonatomic) BOOL m_isKeyBoardHide; // @synthesize m_isKeyBoardHide=_m_isKeyBoardHide;
...
- (id)trimString:(id)arg1 ToLenght:(unsigned int)arg2;
