...
- (void)OnGetNewXmlMsg:(NSString *)arg1 Type:(NSString *)arg2 MsgWrap:(CMessageWrap *)arg3 IsPull:(BOOL)arg4;
...
- (void)OnShowPush:(CMessageWrap *)arg1 isAlwaysShow:(BOOL)arg2;
