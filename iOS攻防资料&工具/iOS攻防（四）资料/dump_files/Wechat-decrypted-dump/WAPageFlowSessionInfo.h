...
@interface WAPageFlowSessionInfo : MMObject
{
    ...
    unsigned int _targetActionType;
...
@property(nonatomic) unsigned int targetActionType; // @synthesize targetActionType=_targetActionType;
@property(nonatomic) BOOL isTriggerDownloaded; // @synthesize isTriggerDownloaded=_isTriggerDownloaded;
