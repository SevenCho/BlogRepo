...
@interface WCPayPaidOrderDetailViewController : WCPayBaseViewController <WCPayPaidDetailQueryAwardCgiDelegate, WCPayNewPaidOrderDetailViewDelegate, MMTipsViewControllerDelegate, WCBaseControlMgrExt, ILinkEventExt, IWCPayPaidOrderActivityMgrExt>
{
    ...
    BOOL _bNeedQueryActivityAward;
    BOOL _bNeedQueryActivityInNewDetailView;
    BOOL _bHasOpenTinyAppActivity;
    BOOL _bIsQueryingTinyAppActivityAward;
    WCPaySelectVerifyTypeLogic *_m_realNameLogic;
    int _curActivityBtnTag;
...
@property(nonatomic) BOOL bIsQueryingTinyAppActivityAward; // @synthesize bIsQueryingTinyAppActivityAward=_bIsQueryingTinyAppActivityAward;
@property(nonatomic) BOOL bHasOpenTinyAppActivity; // @synthesize bHasOpenTinyAppActivity=_bHasOpenTinyAppActivity;
@property(retain, nonatomic) NSString *subscribeBrandUsrname; // @synthesize subscribeBrandUsrname=_subscribeBrandUsrname;
@property(nonatomic) BOOL bNeedQueryActivityInNewDetailView; // @synthesize bNeedQueryActivityInNewDetailView=_bNeedQueryActivityInNewDetailView;
...
@property(nonatomic) int curActivityBtnTag; // @synthesize curActivityBtnTag=_curActivityBtnTag;
@property(nonatomic) BOOL bNeedQueryActivityAward; // @synthesize bNeedQueryActivityAward=_bNeedQueryActivityAward;
...
- (void)onNewDetailViewClickTinyAppActivityWithTinyAppUsername:(id)arg1 tinyAppPath:(id)arg2 tinyAppVersion:(unsigned long)arg3;
- (void)reportNewDetailViewClickH5Activity;
- (void)onNewDetailViewClickH5ActivityOpenWithTinyAppUsername:(id)arg1 tinyAppPath:(id)arg2 tinyAppVersion:(unsigned long)arg3;
...
- (void)onNewDetailViewOpenTinyAppWithTinyAppUsername:(id)arg1 tinyAppPath:(id)arg2 tinyAppVersion:(unsigned long)arg3;
- (void)onNewDetailViewClickLotteryBtn:(id)arg1;
- (void)onNewDetailViewReturnWithoutDrawLottery;
- (void)onNewDetailViewStartDrawLottery:(unsigned long)arg1;
- (void)onWCPayPaidOrderShowInfoViewClickUrl:(id)arg1;
- (void)onWCPayPaidOrderShowInfoViewClickWAApp:(id)arg1 path:(id)arg2;
- (void)openTinyAppWithUsername:(id)arg1 path:(id)arg2 fromScene:(unsigned int)arg3 version:(unsigned long)arg4;
...
- (id)getActivityCellInfoByBtnTag:(int)arg1;
