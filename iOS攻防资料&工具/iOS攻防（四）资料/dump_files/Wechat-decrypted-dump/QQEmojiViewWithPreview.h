...
@property(nonatomic) BOOL needReloadPreview; // @synthesize needReloadPreview=_needReloadPreview;
...
- (BOOL)changeKey:(id)arg1 needSyncLoad:(BOOL)arg2;
