...
@property(nonatomic) BOOL m_hasEncounterBackgroundCameraStart; // @synthesize m_hasEncounterBackgroundCameraStart;
...
- (void)changeToAudioViewAnimation:(BOOL)arg1;
...
- (void)onVideoOrientationChangeTo:(int)arg1;
...
- (void)updateInputOutputRender:(BOOL)arg1;
...
- (id)initWithFrame:(struct CGRect)arg1 andContact:(id)arg2 AllowVideo:(BOOL)arg3 AndPreviewLayer:(id)arg4 AndIsMinimizeMode:(BOOL)arg5 delegate:(id)arg6 headUrl:(id)arg7 isAllowBackCamera:(BOOL)arg8 isShowCSVideo:(BOOL)arg9;
- (void)startTalkWithAllowVideo:(BOOL)arg1;
