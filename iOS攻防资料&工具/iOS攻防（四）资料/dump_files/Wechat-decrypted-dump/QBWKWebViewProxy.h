...
@property(nonatomic) BOOL isSelfProxyEnabled; // @synthesize isSelfProxyEnabled=_isSelfProxyEnabled;
@property(nonatomic) BOOL needInjectJsInNetwork; // @synthesize needInjectJsInNetwork=_needInjectJsInNetwork;
...
- (void).cxx_destruct;
- (BOOL)isMainRequest:(id)arg1 navigationType:(int)arg2;
