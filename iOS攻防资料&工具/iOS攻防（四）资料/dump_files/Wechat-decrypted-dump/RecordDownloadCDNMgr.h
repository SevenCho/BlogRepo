...
- (BOOL)needDownloadFromDataList:(id)arg1 inMsgWrap:(id)arg2;
...
- (void)StartDownloadByRecordData:(id)arg1 DataId:(id)arg2 thumb:(BOOL)arg3 data:(BOOL)arg4 prior:(BOOL)arg5;
