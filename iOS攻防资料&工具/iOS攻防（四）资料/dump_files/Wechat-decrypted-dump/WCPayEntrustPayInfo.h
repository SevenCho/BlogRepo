...
{
    BOOL _isAutoDeduct;
    BOOL _isSelectPayWay;
    NSString *_contractTitle;
    NSArray *_showInfo;
    NSString *_contractUrl;
    unsigned long _uiDeductShowType;
...
@property(nonatomic) unsigned long uiDeductShowType; // @synthesize uiDeductShowType=_uiDeductShowType;
@property(nonatomic) BOOL isSelectPayWay; // @synthesize isSelectPayWay=_isSelectPayWay;
...
@property(nonatomic) BOOL isAutoDeduct; // @synthesize isAutoDeduct=_isAutoDeduct;
