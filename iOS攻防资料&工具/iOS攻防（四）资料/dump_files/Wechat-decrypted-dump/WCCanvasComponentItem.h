...
@interface WCCanvasComponentItem : MMObject <NSCoding, WCCanvasIfAbility>
{
    ...
    int _noReport;
    float _paddingBottomSupplemental;
    int _downloadScene;
}

@property(nonatomic) int downloadScene; // @synthesize downloadScene=_downloadScene;
@property(nonatomic) float paddingBottomSupplemental; // @synthesize paddingBottomSupplemental=_paddingBottomSupplemental;
@property(nonatomic) int noReport; // @synthesize noReport=_noReport;
@property(nonatomic) BOOL hasUpdateDynamicData; // @synthesize hasUpdateDynamicData=_hasUpdateDynamicData;
...
@property(nonatomic) float layoutHeight; // @synthesize layoutHeight=_layoutHeight;
...
- (void).cxx_destruct;
- (float)jumpStreamVideoTextHeight;
