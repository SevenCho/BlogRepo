...
@property(nonatomic) BOOL isFirstOpen; // @synthesize isFirstOpen=_isFirstOpen;
...
- (void)createFooter:(float)arg1;
- (void)createMaskBackView:(float)arg1;
- (void)createMultiGiftPersonView:(float)arg1;
- (void)createLetterView:(float)arg1;
- (void)createSendView;
