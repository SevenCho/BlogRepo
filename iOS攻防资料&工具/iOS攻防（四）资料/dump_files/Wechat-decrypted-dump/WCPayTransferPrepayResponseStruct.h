...
@interface WCPayTransferPrepayResponseStruct : NSObject
{
    ...
    unsigned long _get_dynamic_code_flag;
...
@property(nonatomic) unsigned long get_dynamic_code_flag; // @synthesize get_dynamic_code_flag=_get_dynamic_code_flag;
...
@property(nonatomic) unsigned long fee; // @synthesize fee=_fee;
@property(retain, nonatomic) NSString *doubleCheckWording; // @synthesize doubleCheckWording=_doubleCheckWording;
@property(nonatomic) unsigned long amount; // @synthesize amount=_amount;
