...
- (void)clickNewAASysMsg:(NSString *)arg1 withMsgLocalID:(unsigned long)arg2;
...
- (BOOL)isMsgLastSend:(CMessageWrap *)arg1;
- (BOOL)isMsgCanRevoke:(CMessageWrap *)arg1;
- (void)revokeMsgByNodeView:(CMessageWrap *)arg1;
- (void)SetMsgPlayed:(CMessageWrap *)arg1;
- (void)switchEarMode;
- (void)jumpToUserProfile:(NSString *)arg1 Displayname:(NSString *)arg2 Scence:(unsigned long)arg3;
- (void)onHideKeyboard;
...
- (BOOL)isMsgSelected:(CMessageWrap *)arg1;
- (void)longPressOnHeadImage:(CBaseContact *)arg1;
- (BOOL)canLongPressOnHeadImage:(CBaseContact *)arg1;
...
- (void)BeginPlaying:(CMessageWrap *)arg1 FromTouch:(BOOL)arg2;
- (void)PlayVideo:(CMessageWrap *)arg1 soundable:(BOOL)arg2;
