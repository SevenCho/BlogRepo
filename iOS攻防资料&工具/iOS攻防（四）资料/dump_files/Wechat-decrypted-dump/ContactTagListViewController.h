...
@property(nonatomic) BOOL needGetTagFromSvr; // @synthesize needGetTagFromSvr=_needGetTagFromSvr;
@property(nonatomic) BOOL needReload; // @synthesize needReload=_needReload;
