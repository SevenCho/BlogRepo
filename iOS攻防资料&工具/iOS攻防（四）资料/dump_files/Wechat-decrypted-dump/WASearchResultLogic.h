...
- (void)onSearchGuideDataUpdated:(id)arg1 withInterval:(unsigned long)arg2;
...
- (void)onWebSearchDataFail:(BOOL)arg1;
- (void)onWebSearchDataChanged:(BOOL)arg1 isFromFuncQuery:(BOOL)arg2;
- (void)notifyPageOffsetChanged:(float)arg1;
...
- (void)logForExitSearch:(int)arg1;
- (void)logForBeginSearch:(int)arg1;
