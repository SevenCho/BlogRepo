...
@property(nonatomic, getter=eventResult, setter=setEventResult:) BOOL jcev2_p_3_r_eventResult; // @synthesize jcev2_p_3_r_eventResult=_jcev2_p_3_r_eventResult;
