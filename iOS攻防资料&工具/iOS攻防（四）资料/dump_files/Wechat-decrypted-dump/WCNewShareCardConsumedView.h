...
@property(nonatomic) BOOL bIsStatusBarBlack; // @synthesize bIsStatusBarBlack=_bIsStatusBarBlack;
@property(nonatomic) BOOL followCheckBoxSelected; // @synthesize followCheckBoxSelected=_followCheckBoxSelected;
...
- (void)initTopContainerViewWithError:(BOOL)arg1;
- (void)initNormalView;
- (void)initView;
- (void)layoutSubviews;
- (void)closeConsumedView;
- (void)showConsumedViewWithAnimation:(BOOL)arg1 isStatusBarBlack:(BOOL)arg2;
