...
- (BOOL)makeTaskLowPriority:(id)arg1;
- (BOOL)makeTaskHighPriority:(id)arg1;
- (void)removeAllTasks;
- (void)removeTask:(id)arg1;
- (BOOL)isTaskInQueue:(id)arg1;
- (id)startNewTaskForAsset:(id)arg1 inputPath:(id)arg2 outputPath:(id)arg3 params:(id)arg4 isHighPriority:(BOOL)arg5 completionBlock:(CDUnknownBlockType)arg6;
- (id)getVideoConfigForScene:(unsigned int)arg1;
- (int)getTimeMinuteCountFrom:(id)arg1;
