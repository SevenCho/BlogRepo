...
@property(nonatomic) BOOL m_blockDisplayVideo; // @synthesize m_blockDisplayVideo=_m_blockDisplayVideo;
...
- (void)updateNetworkTacticsWithNotify:(BOOL)arg1;
- (BOOL)checkLowNetworkWithNotify:(BOOL)arg1;
- (BOOL)checkHighWWanWithNotify:(BOOL)arg1;
- (BOOL)checkWiFiWithNotify:(BOOL)arg1;
- (BOOL)checkUnReachableWithNotify:(BOOL)arg1;
- (BOOL)isLowNetwork;
...
- (void)onMultiTalkMainViewControllerUpdateMessageWith:(id)arg1 duration:(unsigned long)arg2 messageId:(unsigned int)arg3;
...
- (void)stopRingSound;
- (void)playRingSoundWithVibration:(BOOL)arg1 isCaller:(BOOL)arg2;
...
- (void)joinMultiTalkWithGroup:(id)arg1 roomId:(unsigned long)arg2 roomKey:(unsigned long long)arg3;
