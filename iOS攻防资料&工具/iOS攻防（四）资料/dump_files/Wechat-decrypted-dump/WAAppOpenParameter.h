...
@property(nonatomic) BOOL m_bUpdateAndForceReloadTask; // @synthesize m_bUpdateAndForceReloadTask=_m_bUpdateAndForceReloadTask;
...
@property(nonatomic) unsigned int m_uiPreScene; // @synthesize m_uiPreScene=_m_uiPreScene;
...
@property(nonatomic) unsigned int m_uiDebugMode; // @synthesize m_uiDebugMode=_m_uiDebugMode;
@property(nonatomic) unsigned long m_uiVersion; // @synthesize m_uiVersion=_m_uiVersion;
