...
- (void)showDetailPageWithNeedScrollToBottom:(BOOL)arg1 extrance:(int)arg2;
- (void)onGoToRewardInDetailPage:(id)arg1;
- (void)startDownloadImageIsFirstTime:(BOOL)arg1;
- (void)onClick;
...
- (void)initRewardTipsViewWithMaxSize:(float)arg1;
