...
- (void)processOnMainThreadAlertCode:(unsigned int)arg1;
- (void)processAlertCode:(unsigned int)arg1;
...
- (BOOL)sendCommandRequestWithCommand:(int)arg1 withData:(id)arg2;
