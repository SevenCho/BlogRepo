...
@property(nonatomic) BOOL bSlientPlay; // @synthesize bSlientPlay=_bSlientPlay;
...
@property(nonatomic) BOOL sightPlaying; // @synthesize sightPlaying=_sightPlaying;
@property(nonatomic) BOOL sightReady; // @synthesize sightReady=_sightReady;
