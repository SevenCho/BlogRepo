...
{
    BOOL _delayConfirmDescUrlflag;
    BOOL _delayConfirmSwitchFlag;
...
@property(nonatomic) BOOL delayConfirmSwitchFlag; // @synthesize delayConfirmSwitchFlag=_delayConfirmSwitchFlag;
@property(copy, nonatomic) NSString *delayConfirmDescUrl; // @synthesize delayConfirmDescUrl=_delayConfirmDescUrl;
@property(nonatomic) BOOL delayConfirmDescUrlflag; // @synthesize delayConfirmDescUrlflag=_delayConfirmDescUrlflag;
