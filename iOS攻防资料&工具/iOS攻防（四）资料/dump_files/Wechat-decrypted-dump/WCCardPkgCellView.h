...
@property(nonatomic) BOOL bMemberCard; // @synthesize bMemberCard=_bMemberCard;
...
@property(nonatomic) unsigned long layoutType; // @synthesize layoutType=_layoutType;
