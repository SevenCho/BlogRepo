...
+ (BOOL)SelectCanvasFavItem:(id)arg1 FromViewController:(id)arg2 thumbView:(id)arg3 showNavigationBar:(BOOL)arg4;
...
+ (BOOL)SelectFavItem:(id)arg1 FromViewController:(id)arg2 Delegate:(id)arg3 FromScene:(unsigned long)arg4 FavIndex:(unsigned long)arg5;
