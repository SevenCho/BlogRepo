...
- (void).cxx_destruct;
- (void)navigateToMiniProgramWitAppID:(id)arg1 userName:(id)arg2 debugMode:(unsigned int)arg3 pagePath:(id)arg4 extraData:(id)arg5 navigationController:(id)arg6;
