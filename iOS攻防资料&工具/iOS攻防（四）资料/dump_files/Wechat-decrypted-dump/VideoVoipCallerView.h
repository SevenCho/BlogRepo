...
@interface VideoVoipCallerView : VideoVoipView <IRecordPermissionCheckExt, IVoipCXMgrExt, UIAlertViewDelegate>
{
    BOOL _m_hasHangup;
...
@property(nonatomic) BOOL m_hasHangup; // @synthesize m_hasHangup=_m_hasHangup;
