...
@optional
- (void)mapView:(QMapView *)arg1 didChangeUserTrackingMode:(int)arg2 animated:(BOOL)arg3;
- (void)mapView:(QMapView *)arg1 didFailToLocateUserWithError:(NSError *)arg2;
- (void)mapView:(QMapView *)arg1 didUpdateUserLocation:(QUserLocation *)arg2 fromHeading:(BOOL)arg3;
...
- (void)mapView:(QMapView *)arg1 regionDidChangeAnimated:(BOOL)arg2 gesture:(BOOL)arg3;
- (void)mapView:(QMapView *)arg1 regionWillChangeAnimated:(BOOL)arg2 gesture:(BOOL)arg3;
