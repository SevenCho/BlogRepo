...
{
    BOOL _isShowProtocol;
    unsigned long _guideFlag;
...
@property(nonatomic) BOOL isShowProtocol; // @synthesize isShowProtocol=_isShowProtocol;
...
@property(nonatomic) unsigned long guideFlag; // @synthesize guideFlag=_guideFlag;
- (void).cxx_destruct;
