...
+ (id)showLoading:(id)arg1 duration:(float)arg2 inView:(id)arg3;
+ (id)showToast:(id)arg1 andText:(id)arg2 duration:(float)arg3 inView:(id)arg4;
...
- (void)hide:(CDUnknownBlockType)arg1 seqID:(int)arg2;
