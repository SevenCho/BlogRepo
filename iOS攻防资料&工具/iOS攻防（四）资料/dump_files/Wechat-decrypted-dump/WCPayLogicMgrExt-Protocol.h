...
- (void)OnNotifyResutltOfOfflinePay:(NSString *)arg1 Error:(NSError *)arg2 UpdateCode:(BOOL)arg3;
...
- (void)OnQueryOfflinePayLimit:(WCPayOfflinePayQueryUserResponseStruct *)arg1 fromCache:(BOOL)arg2 Error:(NSError *)arg3;
...
- (void)OnQueryOfflinePayInfo:(WCPayOfflinePayQueryInfo *)arg1 LocalCached:(BOOL)arg2 Error:(NSError *)arg3;
- (void)OnShouldChangePayCardError:(NSString *)arg1 ErrorMsg:(NSString *)arg2 ErrorType:(unsigned long)arg3;
- (void)OnAddCardError:(NSString *)arg1 ErrorMsg:(NSString *)arg2 ErrorType:(unsigned long)arg3;
- (void)OnLimitInsufficientError:(NSString *)arg1 ErrorMsg:(NSString *)arg2 ErrorType:(unsigned long)arg3;
...
- (void)OnGetOrderList:(NSArray *)arg1 TotalCount:(unsigned long)arg2 Error:(NSError *)arg3;
...
- (void)OnShouldChangePayCardError:(NSString *)arg1 ErrorType:(unsigned long)arg2;
- (void)OnAddCardToVerifyUserInfoError:(NSString *)arg1 ErrorType:(unsigned long)arg2;
- (void)OnAddCardError:(NSString *)arg1 ErrorType:(unsigned long)arg2;
- (void)OnLimitInsufficientError:(NSString *)arg1 ErrorType:(unsigned long)arg2;
- (void)OnHandleSpecialPayError:(NSString *)arg1 ErrorType:(unsigned long)arg2;
...
- (void)OnPayPasswordError:(NSString *)arg1 ErrorCount:(int)arg2 LockTotalCount:(unsigned long)arg3 forgetPwdUrl:(NSString *)arg4;
- (void)OnPayPasswordError:(NSString *)arg1 ErrorCount:(int)arg2 LockTotalCount:(unsigned long)arg3;
