...
+ (float)heightForCardSource:(id)arg1 viewWidth:(float)arg2 offlineCode:(id)arg3;
...
- (void)setupView;
- (void)initView;
- (id)initWithViewWidth:(float)arg1 cardSource:(id)arg2 delegate:(id)arg3 dynamicCode:(id)arg4 offlineCode:(id)arg5 offlineCodeStatus:(unsigned long)arg6;
