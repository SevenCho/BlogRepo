...
- (BOOL)functionCallForWeApp:(id)arg1 withParams:(id)arg2 withCallbackID:(id)arg3;
...
- (BOOL)functionCallForBrowseVideo:(id)arg1 withParams:(id)arg2 withCallbackID:(id)arg3;
