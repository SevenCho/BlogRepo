...
+ (BOOL)validateChallenge:(id)arg1 withCertificateDataArray:(id)arg2;
...
@property(nonatomic) BOOL skipPortCheck; // @synthesize skipPortCheck=_skipPortCheck;
...
@property(nonatomic) unsigned long timeoutMS; // @synthesize timeoutMS=_timeoutMS;
- (void).cxx_destruct;
...
- (BOOL)validateChallenge:(id)arg1;
- (id)filterHttpHeader:(id)arg1;
- (BOOL)checkDomainList:(id)arg1;
