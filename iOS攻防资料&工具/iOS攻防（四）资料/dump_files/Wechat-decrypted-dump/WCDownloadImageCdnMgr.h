...
- (BOOL)onPostHandleResult:(id)arg1;
...
- (unsigned long)getMaxConcurrentCount:(int)arg1;
- (BOOL)isReachConcurrentLimit:(int)arg1;
...
- (BOOL)isTaskRunning:(id)arg1 downloadType:(int)arg2;
- (BOOL)isCacheExist:(id)arg1 downloadType:(int)arg2;
- (void)CheckQueue:(int)arg1;
- (void)CheckAllQueue;
- (void)StopDownloadImage:(id)arg1 downloadType:(int)arg2;
- (void)StartDownloadImage:(id)arg1 downloadType:(int)arg2 needNotify:(BOOL)arg3 force:(BOOL)arg4 preloadItem:(id)arg5 isAd:(BOOL)arg6;
- (void)StartDownloadImage:(id)arg1 downloadType:(int)arg2 needNotify:(BOOL)arg3 force:(BOOL)arg4 preloadItem:(id)arg5;
- (void)StartDownloadImage:(id)arg1 downloadType:(int)arg2 needNotify:(BOOL)arg3 force:(BOOL)arg4;
