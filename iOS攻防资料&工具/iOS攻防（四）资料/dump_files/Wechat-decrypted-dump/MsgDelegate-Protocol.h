...
@optional
- (void)ClearUnRead:(NSString *)arg1 FromID:(unsigned long)arg2 ToID:(unsigned long)arg3;
- (unsigned long)GetUnReadCount:(NSString *)arg1;
- (void)DelMsg:(NSString *)arg1 MsgList:(NSArray *)arg2 DelAll:(BOOL)arg3;
- (NSMutableArray *)GetMsg:(NSString *)arg1 FromID:(unsigned long)arg2 Limit:(int)arg3 LeftCount:(unsigned int *)arg4 LeftUnreadCount:(unsigned int *)arg5;
