...
@interface WCPayTranferGetUserNameResponse : NSObject
{
    ...
    unsigned long _busi_type;
    NSString *_mch_name;
    NSString *_mch_photo;
    NSString *_rcvr_ticket;
    unsigned long _get_pay_wifi;
    NSString *_mch_type;
    unsigned long _mch_time;
    NSString *_receiver_openid;
    NSString *_scan_tile;
    unsigned long _show_photo;
    NSString *_photo_url;
    NSString *_favor_desc;
    unsigned long _scan_scene;
    NSString *_favor_req_sign;
    NSString *_favor_req_extend;
    NSArray *_favor_list;
    BusiF2FFavorCommResp *_favor_comm_resp;
    unsigned long _photo_style;
    unsigned long _get_favor_interval;
    NSString *_mch_info_string;
}

@property(retain, nonatomic) NSString *mch_info_string; // @synthesize mch_info_string=_mch_info_string;
@property(nonatomic) unsigned long get_favor_interval; // @synthesize get_favor_interval=_get_favor_interval;
@property(nonatomic) unsigned long photo_style; // @synthesize photo_style=_photo_style;
...
@property(nonatomic) unsigned long scan_scene; // @synthesize scan_scene=_scan_scene;
...
@property(nonatomic) unsigned long show_photo; // @synthesize show_photo=_show_photo;
...
@property(nonatomic) unsigned long mch_time; // @synthesize mch_time=_mch_time;
@property(retain, nonatomic) NSString *mch_type; // @synthesize mch_type=_mch_type;
@property(nonatomic) unsigned long get_pay_wifi; // @synthesize get_pay_wifi=_get_pay_wifi;
...
@property(nonatomic) unsigned long busi_type; // @synthesize busi_type=_busi_type;
