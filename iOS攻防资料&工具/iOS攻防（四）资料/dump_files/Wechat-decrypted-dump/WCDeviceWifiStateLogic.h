...
- (BOOL)isDeviceSubscribing:(id)arg1;
- (void)handleWCDeviceWifiStateSubscribeResopnse:(id)arg1;
- (void)handleWifiStateUpdateMsg:(id)arg1;
- (void)sendWCDeviceWifiStatusSubscribeForDeviceID:(id)arg1 AndDeviceType:(id)arg2 AndReqType:(unsigned long)arg3;
- (int)getWCDeviceWifiState:(id)arg1;
- (void)sendWCDeviceWifiStateSubscribe:(id)arg1 ReqType:(unsigned long)arg2;
- (void)dealloc;
- (id)init;
