...
+ (id)gradientFromInstance:(unsigned long)arg1;
...
- (struct OpaqueJSValue *)_func_addColorStop:(struct OpaqueJSContext *)arg1 argc:(unsigned long)arg2 argv:(const struct OpaqueJSValue **)arg3;
- (void)dealloc;
