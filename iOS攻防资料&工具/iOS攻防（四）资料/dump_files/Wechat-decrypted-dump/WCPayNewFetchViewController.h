...
@class MMUIButton, MMUILabel, MMUIView, NSDictionary, NSString, UIButton, UIImageView, UITextField, WCPayBalanceTipsLogic, WCPayBindCardInfo, WCPayNoticeBanner, WCPayWebImageView;
...
@property(nonatomic) BOOL m_hasManualSelectedCard; // @synthesize m_hasManualSelectedCard=_m_hasManualSelectedCard;
