...
- (int)intValueForPreference:(id)arg1 defaultValue:(int)arg2;
- (BOOL)isPreferenceSwitcherOn:(id)arg1 nilIsOn:(BOOL)arg2;
- (void)saveTimeStamp:(int)arg1 contentMd5:(id)arg2;
