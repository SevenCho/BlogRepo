...
+ (BOOL)openVoipViewByVoipMonoMsg:(id)arg1 haveAnswered:(BOOL)arg2;
+ (BOOL)startVoipViewByVoipMonoMsg:(id)arg1;
+ (void)handleVoipLocalBusy:(id)arg1;
+ (id)genMessageForBusyVoip:(id)arg1 RoomId:(int)arg2 RoomKey:(long long)arg3 InviteType:(unsigned long)arg4 CreateTime:(unsigned long)arg5;
+ (id)genInviteMessageFromVoipMonoMsg:(id)arg1;
+ (id)genMessageForCancelVoip:(id)arg1 RoomId:(int)arg2 RoomKey:(long long)arg3 InviteType:(unsigned long)arg4 CreateTime:(unsigned long)arg5;
