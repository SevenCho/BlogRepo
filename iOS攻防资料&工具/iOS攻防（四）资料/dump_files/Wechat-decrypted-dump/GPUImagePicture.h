...
- (void)dealloc;
- (id)initWithCGImage:(struct CGImage *)arg1 smoothlyScaleOutput:(BOOL)arg2 removePremultiplication:(BOOL)arg3;
- (id)initWithImage:(id)arg1 smoothlyScaleOutput:(BOOL)arg2 removePremultiplication:(BOOL)arg3;
- (id)initWithCGImage:(struct CGImage *)arg1 removePremultiplication:(BOOL)arg2;
- (id)initWithImage:(id)arg1 removePremultiplication:(BOOL)arg2;
