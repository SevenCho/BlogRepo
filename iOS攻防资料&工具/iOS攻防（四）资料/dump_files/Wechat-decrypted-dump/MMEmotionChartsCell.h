...
@property(nonatomic) BOOL m_showBlackLine; // @synthesize m_showBlackLine;
@property(nonatomic) float m_cellHeight; // @synthesize m_cellHeight;
@property(nonatomic) BOOL m_freeToDownload; // @synthesize m_freeToDownload;
...
- (void)initStoreSession:(id)arg1 StoreItem:(id)arg2 ShouldShowBlackLine:(BOOL)arg3 CellHeight:(float)arg4;
