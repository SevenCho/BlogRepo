...
@property(nonatomic) BOOL m_isListHadChanged; // @synthesize m_isListHadChanged=_m_isListHadChanged;
...
- (void).cxx_destruct;
- (BOOL)showErrorTips:(id)arg1 forReason:(unsigned int)arg2;
