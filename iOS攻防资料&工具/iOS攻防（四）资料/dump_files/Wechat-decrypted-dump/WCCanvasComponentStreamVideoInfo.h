...
@interface WCCanvasComponentStreamVideoInfo : MMObject <NSCoding>
{
    ...
    int _displayType;
    float _streamDisplayWidth;
    float _streamDisplayHeight;
}

@property(nonatomic) BOOL allowVoice; // @synthesize allowVoice=_allowVoice;
@property(nonatomic) float streamDisplayHeight; // @synthesize streamDisplayHeight=_streamDisplayHeight;
@property(nonatomic) float streamDisplayWidth; // @synthesize streamDisplayWidth=_streamDisplayWidth;
