...
- (void)onTryToResendVideoWithAssetExist:(BOOL)arg1;
- (void)onSendFailButtonClicked:(id)arg1;
- (void)onSendFailButtonClicked:(id)arg1 DownloadMode:(unsigned int)arg2;
- (void)onClick:(BOOL)arg1 soundable:(BOOL)arg2;
