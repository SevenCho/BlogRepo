...
@property(nonatomic) unsigned int vcStatus; // @synthesize vcStatus=_vcStatus;
...
- (void).cxx_destruct;
- (id)getStatusBarColor:(unsigned long)arg1;
- (id)getStatusImage:(unsigned long)arg1;
