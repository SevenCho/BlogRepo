...
+ (void)initialize;
@property(nonatomic) BOOL bNeedCheck; // @synthesize bNeedCheck;
...
@property(nonatomic) BOOL bShowRedDot; // @synthesize bShowRedDot;
@property(nonatomic) BOOL bShowNew; // @synthesize bShowNew;
- (void).cxx_destruct;
- (id)pathForCache;
- (void)loadFromCache;
- (void)saveToCache;
