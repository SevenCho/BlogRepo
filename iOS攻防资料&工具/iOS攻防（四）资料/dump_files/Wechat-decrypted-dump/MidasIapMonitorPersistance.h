...
@interface MidasIapMonitorPersistance : NSObject
{
    ...
    BOOL _forceTerminated;
    unsigned int _homeTimes;
    NSString *_billNum;
...
+ (unsigned int)getHomes:(id)arg1;
+ (id)getTotalCurrency:(id)arg1;
+ (id)getBillNo:(id)arg1;
+ (id)getTransInfo:(id)arg1 index:(unsigned int)arg2;
...
@property(nonatomic) BOOL forceTerminated; // @synthesize forceTerminated=_forceTerminated;
...
@property(nonatomic) unsigned int homeTimes; // @synthesize homeTimes=_homeTimes;
- (void).cxx_destruct;
- (id)key;
- (id)totalCurrency;
- (void)remove;
