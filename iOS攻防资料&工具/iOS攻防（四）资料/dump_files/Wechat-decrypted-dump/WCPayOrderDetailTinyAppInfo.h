...
@interface WCPayOrderDetailTinyAppInfo : NSObject
{
    ...
    unsigned long _tinyAppVersion;
    NSString *_tinyAppBtnText;
    unsigned long _sendRecordId;
    unsigned long _userRecordId;
...
@property(nonatomic) unsigned long userRecordId; // @synthesize userRecordId=_userRecordId;
@property(nonatomic) unsigned long sendRecordId; // @synthesize sendRecordId=_sendRecordId;
...
@property(nonatomic) unsigned long tinyAppVersion; // @synthesize tinyAppVersion=_tinyAppVersion;
