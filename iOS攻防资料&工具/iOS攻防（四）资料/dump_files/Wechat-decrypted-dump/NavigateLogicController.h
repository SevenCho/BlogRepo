...
- (void)showNavigateMenuWithTopMapType:(unsigned int)arg1 To:(id)arg2 InView:(id)arg3;
...
- (void)dealloc;
- (BOOL)isLocationInChina:(struct CLLocationCoordinate2D)arg1;
