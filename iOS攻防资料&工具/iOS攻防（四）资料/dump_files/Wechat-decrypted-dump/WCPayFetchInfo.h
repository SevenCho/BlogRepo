...
@property(nonatomic) unsigned long m_uiMinChargeFee; // @synthesize m_uiMinChargeFee=_m_uiMinChargeFee;
@property(nonatomic) unsigned long m_uiRemainFee; // @synthesize m_uiRemainFee=_m_uiRemainFee;
@property(nonatomic) BOOL m_bCalcCharge; // @synthesize m_bCalcCharge=_m_bCalcCharge;
@property(nonatomic) BOOL m_bShowCharge; // @synthesize m_bShowCharge=_m_bShowCharge;
