...
- (BOOL)startRequestWithProductId:(id)arg1 reqScene:(int)arg2 IsAutomatic:(BOOL)arg3;
- (BOOL)startRequestWithStoreItem:(id)arg1 reqScene:(int)arg2 IsAutomatic:(BOOL)arg3;
- (id)init;
