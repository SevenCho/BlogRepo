...
- (void).cxx_destruct;
- (id)getCheckMarkImageWithContactState:(unsigned int)arg1;
- (void)updateItemView:(id)arg1 andContactState:(unsigned int)arg2;
- (void)initView;
- (id)initWithFrame:(struct CGRect)arg1 andContact:(id)arg2 andIsAllowMultiSelect:(BOOL)arg3;
- (void)dealloc;
