...
@interface WCMallMobileChargeControlLogic : WCMallControlLogic <WCMallChargeMobileViewControllerDelegate, IWCPayControlLogicExt>
{
    ...
    BOOL _bIsAddressBookLoading;
    BOOL _bHasLoadAddressBook;
...
@property(nonatomic) BOOL bHasLoadAddressBook; // @synthesize bHasLoadAddressBook=_bHasLoadAddressBook;
@property(nonatomic) BOOL bIsAddressBookLoading; // @synthesize bIsAddressBookLoading=_bIsAddressBookLoading;
