...
#import "EJAudioSourceDelegate.h"

@class NSObject<EJAudioSource>, NSOperation, NSString;
...
@property(nonatomic) BOOL ended; // @synthesize ended;
@property(nonatomic) BOOL loop; // @synthesize loop;
...
- (struct OpaqueJSValue *)_func_cloneNode:(struct OpaqueJSContext *)arg1 argc:(unsigned long)arg2 argv:(const struct OpaqueJSValue **)arg3;
- (struct OpaqueJSValue *)_func_canPlayType:(struct OpaqueJSContext *)arg1 argc:(unsigned long)arg2 argv:(const struct OpaqueJSValue **)arg3;
- (struct OpaqueJSValue *)_func_load:(struct OpaqueJSContext *)arg1 argc:(unsigned long)arg2 argv:(const struct OpaqueJSValue **)arg3;
- (struct OpaqueJSValue *)_func_pause:(struct OpaqueJSContext *)arg1 argc:(unsigned long)arg2 argv:(const struct OpaqueJSValue **)arg3;
- (struct OpaqueJSValue *)_func_play:(struct OpaqueJSContext *)arg1 argc:(unsigned long)arg2 argv:(const struct OpaqueJSValue **)arg3;
