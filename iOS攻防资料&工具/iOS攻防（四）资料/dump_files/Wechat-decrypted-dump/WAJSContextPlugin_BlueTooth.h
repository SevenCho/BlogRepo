...
@interface WAJSContextPlugin_BlueTooth : WAJSContextPluginBase <WABleAdpterLogicDelegate>
{
    ...
    int m_state;
    unsigned int m_onDeviceFoundTriggerInterval;
    NSMutableDictionary *m_foundDevices;
    MMTimer *m_deviceOnTriggerTimer;
    BOOL m_isScaning;
}

@property(nonatomic) BOOL m_isScaning; // @synthesize m_isScaning;
- (void).cxx_destruct;
- (void)stopScan;
...
- (int)setNotifyOnCharacteristics:(id)arg1 serviceID:(id)arg2 characteristics:(id)arg3 state:(BOOL)arg4;
...
- (void)startBluetoothDevicesDiscoveryForServices:(id)arg1 allowDuplicatesKey:(BOOL)arg2 onFoundInterval:(unsigned int)arg3;
