...
{
    unsigned long _requestMaxConcurrentCount;
}

@property(nonatomic) unsigned long requestMaxConcurrentCount; // @synthesize requestMaxConcurrentCount=_requestMaxConcurrentCount;
