...
@class CBCentralManager, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSRecursiveLock, NSString, WABlueToothDevicePool;
...
- (int)setNotifyForPeripheral:(id)arg1 service:(id)arg2 charUUID:(id)arg3 state:(BOOL)arg4;
...
- (void)stopScan;
- (BOOL)scanForServices:(id)arg1 allowDuplicatesKey:(BOOL)arg2;
- (BOOL)scan;
- (int)state;
