...
@property(nonatomic) BOOL is_open_touch_pay; // @synthesize is_open_touch_pay=_is_open_touch_pay;
@property(copy, nonatomic) NSString *wallet_lock_status_name; // @synthesize wallet_lock_status_name=_wallet_lock_status_name;
@property(nonatomic) int wallet_lock_status; // @synthesize wallet_lock_status=_wallet_lock_status;
