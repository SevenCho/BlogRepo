...
+ (void)tryToReportDownloadInfoWithUrl:(id)arg1 mediaType:(unsigned int)arg2 isPreload:(unsigned int)arg3 costTime:(unsigned long long)arg4 retCode:(int)arg5 scene:(unsigned int)arg6 downloadSize:(long long)arg7 startDownloadTime:(unsigned long long)arg8;
...
@property(nonatomic) BOOL hasReportInit; // @synthesize hasReportInit=_hasReportInit;
@property(retain, nonatomic) WCCanvasReportInfo *reportInfo; // @synthesize reportInfo=_reportInfo;
@property(nonatomic) BOOL bSearchCanvas; // @synthesize bSearchCanvas=_bSearchCanvas;
- (void).cxx_destruct;
...
- (void)tryToReportPanoramaComponentUrlInfo:(id)arg1 needDownload:(BOOL)arg2;
- (void)tryToReportStreamComponentVideoUrlInfo:(id)arg1 needDownload:(BOOL)arg2;
- (void)tryToReportStreamComponentThumbUrlInfo:(id)arg1 needDownload:(BOOL)arg2;
- (void)tryToReportStreamComponentIsAutoPlay:(id)arg1 isAutoPlay:(BOOL)arg2;
...
- (void)tryToReportSightUrlInfo:(id)arg1 needDownload:(BOOL)arg2;
- (void)tryToReportSightThumbUrlInfo:(id)arg1 needDownload:(BOOL)arg2;
- (void)tryToReportSightIsAutoPlay:(id)arg1 isAutoPlay:(BOOL)arg2;
...
- (void)tryToReportFullScreenImageUrlInfo:(id)arg1 needDownload:(BOOL)arg2;
- (void)tryToReportPureImageUrlInfo:(id)arg1 needDownload:(BOOL)arg2;
...
- (void)tryToReportExitWithLeaveType:(unsigned int)arg1 andSource:(unsigned long)arg2;
- (void)tryToReportAddFavItem;
- (void)tryToReportSendFriendMsg;
- (void)tryToReportShareTimeLine;
- (void)tryToReportRightSwipePage;
- (void)reportCanvasAdEnterWithSnsId:(id)arg1 uxInfo:(id)arg2 inScene:(int)arg3 withEnterType:(unsigned int)arg4 andSource:(unsigned long)arg5 originScene:(int)arg6 canvasId:(unsigned long long)arg7;
- (void)reportCanvasAdInitWithSnsId:(id)arg1 uxInfo:(id)arg2 inScene:(int)arg3 withEnterType:(unsigned int)arg4 enableSwipe:(BOOL)arg5 componentItemsCount:(unsigned long)arg6 snsStatExt:(id)arg7 extraInfo:(id)arg8 originScene:(int)arg9 canvasId:(unsigned long long)arg10;
