...
@interface WCCanvasRadarChartInfo : MMObject <NSCoding>
{
    ...
    float _scoreFontSize;
    float _borderImgWidth;
}

@property(nonatomic) float borderImgWidth; // @synthesize borderImgWidth=_borderImgWidth;
@property(nonatomic) float scoreFontSize; // @synthesize scoreFontSize=_scoreFontSize;
