...
@property(nonatomic) BOOL m_hasChange; // @synthesize m_hasChange=_m_hasChange;
- (void).cxx_destruct;
...
- (void)updateLastAlbum:(id)arg1 shouldIncludeVideo:(BOOL)arg2 isOnlyShowVideo:(BOOL)arg3;
- (id)getLastAlbumShouldIncludeVideo:(BOOL)arg1 isOnlyShowVideo:(BOOL)arg2;
- (void)dealloc;
- (id)init;
