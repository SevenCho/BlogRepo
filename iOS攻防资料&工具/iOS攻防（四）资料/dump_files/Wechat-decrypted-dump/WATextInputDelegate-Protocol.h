...
- (void)didHeightChange:(float)arg1 lineNum:(int)arg2 input:(id <WATextInputInterface>)arg3;
- (void)didValueChange:(NSString *)arg1 pos:(int)arg2 input:(id <WATextInputInterface>)arg3 keyCode:(unsigned short)arg4;
- (void)onCaretBreak;
- (BOOL)onReturn:(id <WATextInputInterface>)arg1;
