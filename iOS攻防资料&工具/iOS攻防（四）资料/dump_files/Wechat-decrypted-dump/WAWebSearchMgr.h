...
@interface WAWebSearchMgr : MMObject <PBMessageObserverDelegate, WAWebSearchImageTaskDelegate, IHeadImageExt>
{
    ...
    BOOL _isWorkingForWeAppSearch;
    unsigned long _lastEventIDForSuggestion;
    unsigned long _lastEventIDForWeAppSearch;
    NSMutableDictionary *_dicHeadImgInfo;
    NSMutableDictionary *_dicCommonImgInfo;
    BOOL _hasLoadWeAppSearchDownloadH5;
    BOOL _isUpdatingGuideData;
...
@property(nonatomic) BOOL isUpdatingGuideData; // @synthesize isUpdatingGuideData=_isUpdatingGuideData;
...
- (void)internelHandleSearchCGI:(unsigned long)arg1 pbMessage:(unsigned long)arg2 response:(id)arg3 respjson:(id)arg4 withQuery:(id)arg5 offset:(float)arg6 updateCode:(int)arg7;
...
- (BOOL)isLocalSearchGuideDataInvalid;
- (BOOL)tryToUpdateSearchGuideData:(id)arg1;
