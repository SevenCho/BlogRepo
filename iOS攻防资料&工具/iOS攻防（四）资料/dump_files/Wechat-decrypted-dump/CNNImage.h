...
- (id)initWithDimension:(struct CNNDimension)arg1 elementSize:(int)arg2 device:(id)arg3 option:(unsigned int)arg4;
...
- (id)initWithBytes:(void *)arg1 dimension:(struct CNNDimension)arg2 elementSize:(int)arg3 device:(id)arg4 option:(unsigned int)arg5;
