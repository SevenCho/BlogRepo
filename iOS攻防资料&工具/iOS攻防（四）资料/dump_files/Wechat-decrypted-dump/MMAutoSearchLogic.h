...
@property(nonatomic) BOOL blockSignal; // @synthesize blockSignal=_blockSignal;
...
- (void).cxx_destruct;
- (void)tryNextSearch;
- (BOOL)autoSearchShouldFinishedWithKeyword:(id)arg1 QueryInterval:(double)arg2 StartFromFirst:(BOOL)arg3;
- (void)tryAutoSearchWithKeyword:(id)arg1 StartFromFirst:(BOOL)arg2;
- (void)reset;
- (id)init;
