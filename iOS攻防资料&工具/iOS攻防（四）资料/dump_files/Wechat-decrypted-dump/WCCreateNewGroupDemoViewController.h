...
@interface WCCreateNewGroupDemoViewController : MMUIViewController <MMTableViewInfoDelegate, UITextFieldDelegate, UIAlertViewDelegate>
{
    ...
    BOOL _bIsTagNameOverLimit;
    BOOL _bIsShowWarningText;
...
@property(nonatomic) BOOL bIsShowWarningText; // @synthesize bIsShowWarningText=_bIsShowWarningText;
@property(nonatomic) BOOL bIsTagNameOverLimit; // @synthesize bIsTagNameOverLimit=_bIsTagNameOverLimit;
...
- (void)setWaitParentViewControllerDismissWhenDone:(BOOL)arg1;
- (void)viewDidLoad;
