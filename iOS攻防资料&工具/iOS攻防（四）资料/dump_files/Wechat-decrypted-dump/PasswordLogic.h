...
@property(nonatomic) BOOL m_bCan_Verify_Pwd_Use_Old_WTBuf; // @synthesize m_bCan_Verify_Pwd_Use_Old_WTBuf;
@property(nonatomic) unsigned long m_uiVerfyPwdScene; // @synthesize m_uiVerfyPwdScene;
...
@property(nonatomic) unsigned long m_opCode; // @synthesize m_opCode;
@property(nonatomic) __weak id <PasswordLogicDelegate> m_delegate; // @synthesize m_delegate;
- (void).cxx_destruct;
- (void)MessageReturn:(id)arg1 Event:(unsigned long)arg2;
- (void)MessageReturnVerifyPasswd:(id)arg1 Event:(unsigned long)arg2;
- (void)MessageReturnCheckPasswd:(id)arg1 Event:(unsigned long)arg2;
- (void)MessageReturnSetPasswd:(id)arg1 Event:(unsigned long)arg2;
- (void)alertView:(id)arg1 clickedButtonAtIndex:(int)arg2;
- (void)dealloc;
- (id)init;
- (void)startSetPassword:(id)arg1 ticketType:(unsigned long)arg2;
- (void)startCheckPassword:(unsigned long)arg1;
