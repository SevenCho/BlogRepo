...
@interface MMWebCustomLog : MMObject
{
    ...
    unsigned int _toScene;
    unsigned int _sendToFriendsTimes;
    unsigned int _shareTimelineTimes;
}

@property(nonatomic) unsigned int shareTimelineTimes; // @synthesize shareTimelineTimes=_shareTimelineTimes;
@property(nonatomic) unsigned int sendToFriendsTimes; // @synthesize sendToFriendsTimes=_sendToFriendsTimes;
@property(nonatomic) unsigned int toScene; // @synthesize toScene=_toScene;
...
- (void).cxx_destruct;
- (void)recordShareMsgUrl:(id)arg1 msgTitle:(id)arg2 msgDesc:(id)arg3 msgIconUrl:(id)arg4 toScene:(unsigned int)arg5;
- (void)recordCurrentUrl:(id)arg1 currentTitle:(id)arg2 currentAppId:(id)arg3;
- (void)recordPreMsgUrl:(id)arg1 preMsgTitle:(id)arg2 preMsgDesc:(id)arg3 preMsgIconUrl:(id)arg4 preMsgAppId:(id)arg5 fromScence:(unsigned int)arg6;
- (void)uploadKV;
- (id)init;
