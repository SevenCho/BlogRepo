...
- (BOOL)checkNeedDelAllExpt:(unsigned long)arg1;
- (void)onGotSvrExptList:(id)arg1 deleteExptIds:(id)arg2 andExptFlag:(unsigned long)arg3;
...
- (BOOL)getExpt:(id)arg1 withBoolDef:(BOOL)arg2;
