...
@property(nonatomic) BOOL bWaitForVerify; // @synthesize bWaitForVerify=_bWaitForVerify;
...
@property(nonatomic) BOOL m_isInMyContactList; // @synthesize m_isInMyContactList;
...
- (BOOL)copyPatialFieldFromAddressBookFriend:(id)arg1;
- (int)compareMobileFriendAscending:(id)arg1;
- (int)compare:(id)arg1;
- (void)dealloc;
- (id)init;
