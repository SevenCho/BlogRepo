...
@property(nonatomic) unsigned long jumpProfileScence; // @synthesize jumpProfileScence=_jumpProfileScence;
@property(nonatomic) unsigned long getA8KeyScence; // @synthesize getA8KeyScence=_getA8KeyScence;
...
- (void).cxx_destruct;
- (void)mediaItemView:(id)arg1 openMediaUrl:(id)arg2 actionBase:(id)arg3 actionListCount:(unsigned int)arg4;
...
- (id)genGridItemView:(id)arg1 withStatId:(id)arg2 gridItemListCount:(int)arg3;
...
- (BOOL)isHiddenCell:(id)arg1;
- (BOOL)isBannerCell:(id)arg1;
