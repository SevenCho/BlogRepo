...
@interface OCRTransResultViewController : MMUIViewController <IOCRTransMgrExt, UIScrollViewDelegate, MMTipsViewControllerDelegate>
{
    ...
    unsigned int _ZHResultStrCount;
    unsigned int _allResultStrCount;
    UIImage *_image;
    UIImage *_grayImage;
...
- (void)getBitmap;
- (void)OnOploadOCRImageFinish:(BOOL)arg1;
...
- (struct CGSize)sizeForText:(id)arg1 withSize:(struct CGSize)arg2 font:(id)arg3 isMerge:(BOOL)arg4;
- (void)setupShowOriginButtonImage;
- (void)updateResult;
- (void)setTranslations:(id)arg1 andAngle:(float)arg2;
