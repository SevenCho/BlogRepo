...
@interface WCCanvasComponentSightVideoInfo : MMObject <NSCoding>
{
    ...
    int _displayType;
    float _sightDisplayWidth;
    float _sightDisplayHeight;
...
@property(nonatomic) float sightDisplayHeight; // @synthesize sightDisplayHeight=_sightDisplayHeight;
@property(nonatomic) float sightDisplayWidth; // @synthesize sightDisplayWidth=_sightDisplayWidth;
