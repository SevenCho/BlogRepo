...
- (BOOL)isDontDisturbModeAndCheckRestore:(BOOL)arg1;
- (void)_muteForSeconds:(unsigned int)arg1;
- (void)unmute;
- (void)muteForOneHour;
- (void)showDisturbConfirmViewController;
- (void)handleActionWithIdentifier:(id)arg1 forUserInfo:(id)arg2 withResponseInfo:(id)arg3 isRemote:(BOOL)arg4 completionHandler:(CDUnknownBlockType)arg5;
