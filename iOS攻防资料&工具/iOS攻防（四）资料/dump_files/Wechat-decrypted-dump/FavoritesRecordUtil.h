...
+ (id)ConvertFavDataList:(id)arg1 toMsgWrap:(id)arg2 inFavItem:(id)arg3 hasSetThumb:(BOOL)arg4;
...
+ (id)ConvertRecordMsg2FavData:(id)arg1 forFav:(BOOL)arg2;
...
+ (void)GetNoteTitleAndDesc:(id)arg1 toTitle:(id *)arg2 toDesc:(id *)arg3 needDefaultTitle:(BOOL)arg4 needBreakLines:(BOOL)arg5;
+ (void)GetNoteTitleAndDesc:(id)arg1 toTitle:(id *)arg2 toDesc:(id *)arg3;
+ (id)GetNoteDesc:(id)arg1;
+ (id)GetRecordDataDesc:(id)arg1 needBreakLines:(BOOL)arg2;
