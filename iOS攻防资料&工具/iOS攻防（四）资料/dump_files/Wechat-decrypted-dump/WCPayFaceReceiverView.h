...
@property(nonatomic) BOOL bScrollViewAnimating; // @synthesize bScrollViewAnimating=_bScrollViewAnimating;
...
@property(nonatomic) long balanceNum; // @synthesize balanceNum=_balanceNum;
...
- (void)addReceiver:(id)arg1 animated:(BOOL)arg2;
