...
@interface WCCardNewPkgItemView : MMUIView
{
    ...
    float _stateX;
    float _rightBaseLineX;
}

+ (float)cellHeight;
@property(nonatomic) float rightBaseLineX; // @synthesize rightBaseLineX=_rightBaseLineX;
@property(nonatomic) float stateX; // @synthesize stateX=_stateX;
