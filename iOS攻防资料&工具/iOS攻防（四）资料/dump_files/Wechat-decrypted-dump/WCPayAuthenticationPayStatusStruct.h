...
@property(nonatomic) BOOL is_jsapi_close_page; // @synthesize is_jsapi_close_page=_is_jsapi_close_page;
@property(retain, nonatomic) WCPayPayResponseRetryInfo *retry_pay_info; // @synthesize retry_pay_info=_retry_pay_info;
@property(nonatomic) long can_pay_retry; // @synthesize can_pay_retry=_can_pay_retry;
...
@property(nonatomic) BOOL m_bPayCompleteFlag; // @synthesize m_bPayCompleteFlag;
