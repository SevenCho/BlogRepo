...
@interface WCPayQRCodeRewardControlData : NSObject
{
    ...
    int _payChannel;
    int _setupViewControllerScene;
    int _payerSelectedAmount;
...
@property(nonatomic) int payerSelectedAmount; // @synthesize payerSelectedAmount=_payerSelectedAmount;
@property(nonatomic) int setupViewControllerScene; // @synthesize setupViewControllerScene=_setupViewControllerScene;
