...
- (void)OnGetWCMallFunctionProductList:(id)arg1 FunctionId:(unsigned long)arg2 BalanceUrl:(id)arg3 RechargeUrl:(id)arg4 BalanceWord:(id)arg5 RechargeWord:(id)arg6 Error:(id)arg7;
