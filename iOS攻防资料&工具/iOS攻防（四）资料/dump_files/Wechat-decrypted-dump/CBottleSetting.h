...
@property(nonatomic) unsigned long m_uiChatStatus; // @synthesize m_uiChatStatus;
@property(nonatomic) unsigned long m_uiLastMsgType; // @synthesize m_uiLastMsgType;
@property(nonatomic) BOOL m_bFirstIn; // @synthesize m_bFirstIn;
