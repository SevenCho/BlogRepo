...
{
    BOOL _m_bAdjustRet;
    unsigned long _m_uiLoginType;
    unsigned long _m_uiFromScene;
    NSString *_m_nsPwd;
    ...
    int _m_iForceReg;
    int _m_iRegMode;
    unsigned long _m_uiRegNextShowStyle;
    NSDictionary *_m_dicStyleKeyValue;
    unsigned long _m_uiNextAuthType;
...
@property(nonatomic) unsigned long m_uiAdjustRet; // @synthesize m_uiAdjustRet=_m_uiAdjustRet;
@property(nonatomic) BOOL m_bAdjustRet; // @synthesize m_bAdjustRet=_m_bAdjustRet;
...
@property(nonatomic) unsigned long m_uiNextAuthType; // @synthesize m_uiNextAuthType=_m_uiNextAuthType;
@property(retain, nonatomic) NSDictionary *m_dicStyleKeyValue; // @synthesize m_dicStyleKeyValue=_m_dicStyleKeyValue;
@property(nonatomic) unsigned long m_uiRegNextShowStyle; // @synthesize m_uiRegNextShowStyle=_m_uiRegNextShowStyle;
...
@property(nonatomic) unsigned long m_uiFromScene; // @synthesize m_uiFromScene=_m_uiFromScene;
@property(nonatomic) unsigned long m_uiLoginType; // @synthesize m_uiLoginType=_m_uiLoginType;
- (void).cxx_destruct;
