...
@property(nonatomic) BOOL depositGameCoin; // @synthesize depositGameCoin=_depositGameCoin;
...
@property(nonatomic) long reqType; // @synthesize reqType;
- (void).cxx_destruct;
- (BOOL)validateParams;
- (id)init;
