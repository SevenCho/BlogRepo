...
@interface WCPayOfflinePayMainLogic : WCPayControlLogic <UIViewControllerTransitioningDelegate, MMWebViewDelegate, WCPayAddPayCardDelegate, WCPayGPWalletLaunchControlLogicDelegate, WCPayOpenECardControlLogicExt, WCPayT2BCTransferControlLogicDelegate, WCPayDrawLotteryCgiDelegate, WCPayGetLotteryCgiDelegate, WCPayModifyExposureCgiDelegate, WAAppTaskMgrExt, WCPayOfflineAckMsgCgiDelegate, WCPayOfflineCancelPayCgiDelegate, WCPayOfflinePayViewControllerDelegate, WCPayOrderDetailHistoryViewControllerDelegate, WCBaseControlMgrExt, WCPayOfflinePayConfirmViewDelegate, WCPayPaidOrderDetailViewControllerDelegate, WCPayOfflineGetMsgCgiDelegate>
{
    ...
    BOOL _isPullingOfflineMsg;
    BOOL _isOfflineGetMsgStarted;
    BOOL _isModifyExposureInfo;
    BOOL _isLogicCancelByControlMgr;
...
@property(nonatomic) BOOL isLogicCancelByControlMgr; // @synthesize isLogicCancelByControlMgr=_isLogicCancelByControlMgr;
...
@property(nonatomic) BOOL isOfflineGetMsgStarted; // @synthesize isOfflineGetMsgStarted=_isOfflineGetMsgStarted;
@property(nonatomic) BOOL isPullingOfflineMsg; // @synthesize isPullingOfflineMsg=_isPullingOfflineMsg;
...
- (void)OnNotifyResutltOfOfflinePay:(id)arg1 Error:(id)arg2 UpdateCode:(BOOL)arg3;
...
- (void)OnShouldChangePayCardError:(id)arg1 ErrorMsg:(id)arg2 ErrorType:(unsigned long)arg3;
- (void)OnAddCardError:(id)arg1 ErrorMsg:(id)arg2 ErrorType:(unsigned long)arg3;
- (void)OnLimitInsufficientError:(id)arg1 ErrorMsg:(id)arg2 ErrorType:(unsigned long)arg3;
...
- (void)onAddPayCardResult:(BOOL)arg1;
