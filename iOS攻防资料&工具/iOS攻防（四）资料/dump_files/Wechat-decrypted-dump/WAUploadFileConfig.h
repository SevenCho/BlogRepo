...
{
    unsigned long _uploadFileMaxConcurrentCount;
}

@property(nonatomic) unsigned long uploadFileMaxConcurrentCount; // @synthesize uploadFileMaxConcurrentCount=_uploadFileMaxConcurrentCount;
