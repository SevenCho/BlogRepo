...
{
    BOOL _acceptButtonStatus;
    NSMutableArray *_cardDataList;
    NSString *_acceptButtonWording;
    unsigned long _privateStatus;
    NSString *_privateWording;
}

@property(retain, nonatomic) NSString *privateWording; // @synthesize privateWording=_privateWording;
@property(nonatomic) BOOL acceptButtonStatus; // @synthesize acceptButtonStatus=_acceptButtonStatus;
@property(nonatomic) unsigned long privateStatus; // @synthesize privateStatus=_privateStatus;
