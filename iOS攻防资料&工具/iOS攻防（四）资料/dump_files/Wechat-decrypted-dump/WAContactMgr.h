...
@interface WAContactMgr : MMService <MMConfigMgrExt, PBMessageObserverDelegate, MMService>
{
    ...
    unsigned long _singleAttrSyncRequestInterval;
    NSMutableArray *_arrBatchAttrSyncWait;
    NSMutableSet *_setBatchAttrSyncRequest;
    unsigned long _batchAttrSyncRequestInterval;
}
...
- (BOOL)checkResponseVersion:(id)arg1 username:(id)arg2 report:(unsigned long)arg3;
...
- (id)getContactFromCacheWithKey:(id)arg1 type:(unsigned int)arg2;
...
- (BOOL)modifyWxAppOptWithBitMask:(unsigned long)arg1 bitValue:(unsigned long)arg2 userName:(id)arg3;
...
- (void)updateWeAppContactWithKey:(id)arg1 updateType:(unsigned int)arg2 isForce:(BOOL)arg3;
- (void)updateWeAppContactWithKey:(id)arg1 updateType:(unsigned int)arg2;
- (BOOL)isKeyValidWithKey:(id)arg1 keyType:(unsigned int)arg2;
- (void)deleteWeAppContactList:(id)arg1;
- (id)getAllWeAppContact;
- (id)getWeAppContact:(id)arg1;
- (id)getWeAppContactWithKey:(id)arg1 type:(unsigned int)arg2;
