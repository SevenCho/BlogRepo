...
- (unsigned long)getImageStartAddr:(id)arg1;
- (id)getWeChatBinaryInfo;
- (id)getWeChatImageUUID;
- (id)getReportJsonDataWithCallStackArray:(struct KSStackCursor **)arg1 callStackCount:(unsigned int)arg2 withReportID:(id)arg3 withDumpType:(unsigned int)arg4 withScene:(id)arg5;
- (id)getReportJsonDataWithCallStackArray:(struct KSStackCursor **)arg1 callStackCount:(unsigned int)arg2 withReportID:(id)arg3 withDumpType:(unsigned int)arg4;
