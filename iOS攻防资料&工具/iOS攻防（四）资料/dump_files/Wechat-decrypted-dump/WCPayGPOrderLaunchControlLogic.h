...
@property(nonatomic) BOOL bHasSelectMemberFinish; // @synthesize bHasSelectMemberFinish=_bHasSelectMemberFinish;
...
- (id)contactInBizChatSessionAtRow:(unsigned int)arg1;
- (int)numberOfRowInBizChatSession;
