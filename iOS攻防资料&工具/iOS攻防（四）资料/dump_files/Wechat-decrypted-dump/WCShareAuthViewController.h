...
@property(nonatomic) BOOL bIsFromSysCopy; // @synthesize bIsFromSysCopy;
- (void).cxx_destruct;
...
- (id)makeLink;
- (void)viewDidLoad;
- (id)initWithType:(int)arg1 appid:(id)arg2 bundleId:(id)arg3 txt:(id)arg4 url:(id)arg5 msgType:(unsigned long)arg6 desc:(id)arg7 extraData:(id)arg8;
- (id)initWithType:(int)arg1 appid:(id)arg2 bundleId:(id)arg3 txt:(id)arg4 url:(id)arg5 msgType:(unsigned long)arg6;
- (void)dealloc;
