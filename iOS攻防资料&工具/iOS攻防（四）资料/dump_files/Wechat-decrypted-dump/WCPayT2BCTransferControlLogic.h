...
@interface WCPayT2BCTransferControlLogic : WCPayControlLogic <WCPayT2BCDetailControlLogicDelegate, WCPayPayMoneyLogicDelegate, WCPayT2BCGetTransHistroyCgiDelegate, WCPayT2BCAppointBankCgiDelegate, WCPayT2BCCheckBankBindCgiDelegate, WCPayT2BCPayRequestCgiDelegate, WCPayT2BCGetBankInfoCgiDelegate, WCPayT2BCModifyRemarkCgiDelegate, WCPayT2BCDeleteRecordCgiDelegate, WCPayT2BCBusinessCallBackCgiDelegate, WCPayT2BCOperationCgiDelegate, WCPaySelectReceiverViewControllerDelegate, MMTipsViewControllerDelegate, WCPayTransferToBankCardFillInfoViewControllerDelegate, WCPayTransferToBankCardViewControllerDelegate>
{
    ...
    unsigned int m_uiT2BCTransferLogicStatus;
...
- (void)OnWCPayT2BCBusinessCallBackCgiResponseError:(id)arg1 errorCode:(unsigned long)arg2;
- (void)OnWCPayT2BCBusinessCallBackCgiResponseOK:(id)arg1;
- (void)OnWCPayT2BCDeleteRecordCgiResponseError:(id)arg1 errorCode:(unsigned long)arg2;
- (void)OnWCPayT2BCDeleteRecordCgiResponseOK:(id)arg1;
- (void)OnWCPayT2BCModifyRemarkCgiResponseError:(id)arg1 errorCode:(unsigned long)arg2;
- (void)OnWCPayT2BCModifyRemarkCgiResponseOK:(id)arg1;
- (void)OnWCPayT2BCGetBankInfoCgiResponseError:(id)arg1 errorCode:(unsigned long)arg2;
...
- (void)OnWCPayT2BCPayRequestCgiResponseError:(id)arg1 errorCode:(unsigned long)arg2 response:(id)arg3;
- (void)OnWCPayT2BCPayRequestCgiResponseError:(id)arg1 errorCode:(unsigned long)arg2;
...
- (void)OnWCPayT2BCCheckBankBindCgiResponseError:(id)arg1 errorCode:(unsigned long)arg2;
- (void)OnWCPayT2BCCheckBankBindCgiResponseOK:(id)arg1;
- (void)OnGetApponitBankResonseError:(id)arg1 errorCode:(unsigned long)arg2;
- (void)OnGetApponitBankResonseOK:(id)arg1;
- (void)OnWCPayT2BCOperationCgiResponseError:(id)arg1 errorCode:(unsigned long)arg2;
- (void)OnWCPayT2BCOperationCgiResponseOK:(id)arg1;
- (void)OnGetTransToBankHistoryError:(id)arg1 errorCode:(int)arg2;
