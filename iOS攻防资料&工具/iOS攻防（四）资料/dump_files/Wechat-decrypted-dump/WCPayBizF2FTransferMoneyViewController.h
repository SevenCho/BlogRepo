...
@class BusiF2FFavorCommResp, FavorComposeInfo, InternalLoadingFavor, InternalTransferTask, NSString, RichTextView, UIButton, UIImageView, UILabel, UITextField, UIView, WCPayBaseNetworkingError, WCPayBizF2FFavorSelectView, WCPayBusiF2FGetFavorCgi, WCPayNavigationView;

@interface WCPayBizF2FTransferMoneyViewController : WCPayBaseViewController <InternalLoadingFavorDelegate, InternalTransferTaskDelegate, WCPayBusiF2FGetFavorCgiDelegate, WCPayBizF2FFavorSelectViewDelegate, UITextFieldDelegate, ILinkEventExt>
{
    BOOL _m_userHasSelectCompose;
    BOOL _m_favorLoading;
...
@property(nonatomic) BOOL m_favorLoading; // @synthesize m_favorLoading=_m_favorLoading;
@property(retain, nonatomic) WCPayBusiF2FGetFavorCgi *getFavorCgi; // @synthesize getFavorCgi=_getFavorCgi;
@property(nonatomic) BOOL m_userHasSelectCompose; // @synthesize m_userHasSelectCompose=_m_userHasSelectCompose;
...
- (void)getFavorWithAmount:(unsigned long)arg1 andDelegate:(id)arg2;
...
- (float)updateFavorMoneyLabelWithYOffset:(float)arg1 baseView:(id)arg2;
- (float)updateFavorLineWithYOffset:(float)arg1 baseView:(id)arg2;
- (float)updateFavorButtonWithYOffset:(float)arg1 baseView:(id)arg2;
- (float)updateFavorTitleLabelWithYOffset:(float)arg1 baseView:(id)arg2;
- (float)updateFavorViewWithYOffset:(float)arg1 baseView:(id)arg2;
- (id)favorButtonTitle;
...
- (BOOL)shouldGetFavor;
- (float)amountInputLabelMarginUp;
- (float)amountInputLabelHeight;
- (float)amountInputLabelFontSize;
