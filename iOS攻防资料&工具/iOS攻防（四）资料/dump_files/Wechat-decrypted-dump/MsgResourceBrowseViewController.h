...
- (void)onSelecteAll;
- (void)msgFastBrowseView:(id)arg1 didChangeCheckMarkTo:(BOOL)arg2 atSection:(unsigned int)arg3;
...
- (unsigned long)getDataSize:(const vector_3d478e4e *)arg1;
...
- (void)viewDidLoad;
- (void)dealloc;
- (id)initWithMsgWrap:(id)arg1 type:(unsigned int)arg2;
