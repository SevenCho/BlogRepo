...
@property(nonatomic) BOOL needGzip; // @synthesize needGzip=_needGzip;
@property(nonatomic) BOOL bIsCdnDownloadType; // @synthesize bIsCdnDownloadType=_bIsCdnDownloadType;
