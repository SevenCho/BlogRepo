...
@interface ShowRatingAchive : NSObject <NSCoding>
{
    ...
    BOOL _m_bShowing;
    BOOL _m_bUseNewShowRatingStrategy;
    unsigned int m_uiWaitDays;
}

@property(nonatomic) BOOL m_bUseNewShowRatingStrategy; // @synthesize m_bUseNewShowRatingStrategy=_m_bUseNewShowRatingStrategy;
@property(nonatomic) BOOL m_bShowing; // @synthesize m_bShowing=_m_bShowing;
