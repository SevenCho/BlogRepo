...
- (void)formContentViewByText:(id)arg1 lineNum:(int)arg2;
- (void)formContentViewByText:(id)arg1 lineNum:(int)arg2 width:(float)arg3;
- (void)initInputView;
...
- (void)onRoomInfoBack;
- (void)showPreViewAnimate:(BOOL)arg1 View:(id)arg2 completion:(CDUnknownBlockType)arg3;
...
- (id)getInputText;
- (void)hideView:(BOOL)arg1;
- (void)showView:(BOOL)arg1;
- (void)dealloc;
- (id)init;
