...
+ (unsigned long)getMaxDataSize:(id)arg1;
+ (void)calFavDataIllegalTypeAndSize:(id)arg1 fromMsg:(id)arg2;
+ (id)getWebpageFavItemUrl:(id)arg1;
+ (id)getFavTextCellText:(id)arg1 needBreakLines:(BOOL)arg2;
...
+ (id)ConvertCanvasPage2FavItem:(id)arg1 desc:(id)arg2 WebUrl:(id)arg3 CanvasPageInfo:(id)arg4 FromUser:(id)arg5 EventId:(id)arg6 AppId:(id)arg7 ThumbUrl:(id)arg8 ThumbPath:(id)arg9 SrcCreateTime:(unsigned long)arg10;
...
+ (id)ConvertUrlWeb2FavItem:(id)arg1 Title:(id)arg2 Desc:(id)arg3 ThumbUrl:(id)arg4 AppId:(id)arg5 UserName:(id)arg6 ContentAttributeFlag:(unsigned long)arg7 publisherUsername:(id)arg8 PublishId:(id)arg9;
...
+ (id)ConvertUrlSNS2FavItem:(id)arg1 Desc:(id)arg2 Title:(id)arg3 EventId:(id)arg4 FromUser:(id)arg5 AppId:(id)arg6 ThumbUrl:(id)arg7 SrcCreateTime:(unsigned long)arg8 ContentAttributeFlag:(unsigned long)arg9 ThumbPath:(id)arg10;
+ (id)ConvertUrlSNS2FavItem:(id)arg1 Title:(id)arg2 EventId:(id)arg3 FromUser:(id)arg4 AppId:(id)arg5 ThumbUrl:(id)arg6 SrcCreateTime:(unsigned long)arg7 ContentAttributeFlag:(unsigned long)arg8 ThumbPath:(id)arg9;
+ (id)ConvertUrlReader2FavItem:(id)arg1 Url:(id)arg2 Index:(unsigned int)arg3;
