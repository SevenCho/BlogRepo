...
+ (void)markQBWKWebViewExist:(BOOL)arg1;
+ (BOOL)isQBUIWebViewExist;
+ (void)markQBUIWebViewExist:(BOOL)arg1;
...
+ (void)setInDic:(id)arg1 key:(id)arg2 boolValue:(BOOL)arg3;
+ (void)setInDic:(id)arg1 key:(id)arg2 urlValue:(id)arg3;
+ (void)setInDic:(id)arg1 key:(id)arg2 value:(id)arg3;
+ (id)host:(id)arg1;
+ (BOOL)isString:(id)arg1 absoluteEqualToString:(id)arg2;
+ (BOOL)originUrl:(id)arg1 isEqualIgorningFragment:(id)arg2;
