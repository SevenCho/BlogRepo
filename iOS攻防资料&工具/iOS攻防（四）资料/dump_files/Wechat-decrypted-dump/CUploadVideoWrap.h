...
@interface CUploadVideoWrap : NSObject
{
    ...
    unsigned long _m_videoSource;
}

@property(nonatomic) unsigned long m_videoSource; // @synthesize m_videoSource=_m_videoSource;
@property(nonatomic) unsigned long m_forwardType; // @synthesize m_forwardType=_m_forwardType;
@property(nonatomic) BOOL m_bUseSafeCdn; // @synthesize m_bUseSafeCdn=_m_bUseSafeCdn;
@property(nonatomic) BOOL m_bHitMd5; // @synthesize m_bHitMd5=_m_bHitMd5;
...
@property(nonatomic) unsigned long m_uiVideoThumbHeight; // @synthesize m_uiVideoThumbHeight;
@property(nonatomic) unsigned long m_uiVideoThumbWidth; // @synthesize m_uiVideoThumbWidth;
@property(nonatomic) unsigned long m_uiVideoThumbSize; // @synthesize m_uiVideoThumbSize;
...
@property(nonatomic) unsigned long m_uiEncrypVer; // @synthesize m_uiEncrypVer;
