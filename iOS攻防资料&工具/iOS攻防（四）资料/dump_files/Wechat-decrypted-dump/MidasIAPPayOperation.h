...
- (BOOL)shouldProcessTransactions:(id)arg1;
- (BOOL)shouldFinishNewTransactionsWhenFail:(int)arg1;
- (BOOL)shouldFinishTransactionsWhenFail:(int)arg1;
- (void)blockProcessFinalNewProvideError:(id)arg1;
- (void)blockProcessIapCancel:(id)arg1;
- (void)blockProcessIapErrorCode:(int)arg1 msg:(id)arg2 workingStep:(long)arg3 error:(id)arg4;
- (void)blockProcessCgiError:(int)arg1 inner:(id)arg2 msg:(id)arg3 workingStep:(long)arg4;
- (void)blockProcessNetError:(int)arg1 workingStep:(long)arg2;
