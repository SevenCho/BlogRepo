...
+ (struct CGSize)getFixedOrientationScreenMetrics:(int)arg1;
+ (id)h5ViewControllerWithOrientation:(int)arg1;
@property(retain, nonatomic) NSString *rawUserAgent; // @synthesize rawUserAgent;
@property(nonatomic) BOOL useScreenSizeRatio; // @synthesize useScreenSizeRatio=_useScreenSizeRatio;
...
- (void)load404:(id)arg1 errorCode:(int)arg2;
