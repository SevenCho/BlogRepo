...
@interface WCMallChargeMobileViewController : WCMallBaseViewController <ABPeoplePickerNavigationControllerDelegate, CNContactPickerDelegate, MMTipsViewControllerDelegate, UITextFieldDelegate, WCMallOldTelephoneViewDelegate, WCMallCandidateTelephoneViewDelegate, ILinkEventExt>
{
    ...
    BOOL _doNotUpdateAfterKeyboardDismiss;
    BOOL _bHasRefreshTextFieldDefaultNumber;
    NSDictionary *_specialItem;
}

@property(nonatomic) BOOL bHasRefreshTextFieldDefaultNumber; // @synthesize bHasRefreshTextFieldDefaultNumber=_bHasRefreshTextFieldDefaultNumber;
@property(retain, nonatomic) NSDictionary *specialItem; // @synthesize specialItem=_specialItem;
@property(nonatomic) BOOL doNotUpdateAfterKeyboardDismiss; // @synthesize doNotUpdateAfterKeyboardDismiss=_doNotUpdateAfterKeyboardDismiss;
- (void).cxx_destruct;
- (void)openTinyAppWithUserName:(id)arg1 path:(id)arg2;
- (id)getTextColorWithFunctionIndex:(unsigned int)arg1;
- (BOOL)isNumberMayInvalidTips:(id)arg1;
...
- (id)GetOldTelephoneOperatorName:(unsigned long)arg1;
