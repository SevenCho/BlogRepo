...
- (void)invalidate;
- (BOOL)abortDownloadTask:(id)arg1 getError:(id *)arg2;
- (void)startDownloadTaskWithUrl:(id)arg1 taskID:(id)arg2 httpHeaders:(id)arg3 isIgnoreCheckDomain:(BOOL)arg4 context:(id)arg5 completionHandler:(CDUnknownBlockType)arg6;
- (void)dealloc;
