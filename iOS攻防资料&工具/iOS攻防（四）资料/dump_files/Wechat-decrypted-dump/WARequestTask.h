...
@property(nonatomic) BOOL isRedirectInvalid; // @synthesize isRedirectInvalid=_isRedirectInvalid;
...
- (void)callCompletionHandlerWithError:(id)arg1 string:(id)arg2 buffer:(id)arg3 statusCode:(int)arg4 responseHeader:(id)arg5;
- (void)callCompletionHandlerWithString:(id)arg1 buffer:(id)arg2 statusCode:(int)arg3 responseHeader:(id)arg4;
