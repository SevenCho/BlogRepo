...
@property(nonatomic) BOOL bScrolling; // @synthesize bScrolling=_bScrolling;
...
- (BOOL)CTRectContainsPointError:(struct CGRect)arg1 point:(struct CGPoint)arg2 error:(float)arg3;
- (BOOL)pointIsVisableInScreen:(struct CGPoint)arg1;
...
- (BOOL)touchPointInSelectPath:(struct CGPoint)arg1;
- (BOOL)onClickPreViewWithPoint:(struct CGPoint)arg1 DoubleClick:(BOOL)arg2;
