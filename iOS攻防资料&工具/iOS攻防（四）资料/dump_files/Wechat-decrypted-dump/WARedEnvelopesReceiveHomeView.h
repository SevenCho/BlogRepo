...
- (BOOL)shouldShowDetailButtonWithIsSender:(BOOL)arg1 Type:(int)arg2 ReceiveStutus:(int)arg3 envelopeStutus:(int)arg4 data:(id)arg5;
- (BOOL)shouldShowBottomDescriptionWithType:(int)arg1 envelopeStutus:(int)arg2;
