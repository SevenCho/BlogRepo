...
@class CShakeChecker, MMUILabel, NSMutableArray, NSString, UIBezierPath, UIButton, UIImageView, UILabel, UIScrollView, UIView, WCPayControlData, WCPayImageMaskView, WCPayLotteryView, WCPayWebImageView;

@interface WCPayNewPaidOrderDetailView : MMUIView <WCPayPaidOrderShowInfoViewDelegate, WCPayImageMaskViewFilledDelegate, ShakeCheckerDelegate, WCPayLotteryViewDelegate>
{
    BOOL _isShaking;
    BOOL _bCanShake;
...
- (void)lotteryViewDidScratchOrShake:(id)arg1 drawType:(unsigned long)arg2;
...
- (id)getDiscountView;
- (void)setupBottomContentViewWithContentBottom:(float)arg1;
- (float)setupCenterContentViewWithContentBottom:(float)arg1;
- (id)getShowInfoView;
- (float)setupHeaderContentView;
