...
@interface WCPayAuthenticationPay : NSObject
{
    ...
    BOOL m_bIsAutoDeduct;
    BOOL _m_bTouchIDAuth;
    BOOL _mustCheckMessage;
    BOOL _bIsOfflinePayConfirm;
    BOOL _bIsLQTPay;
...
@property(nonatomic) BOOL bIsLQTPay; // @synthesize bIsLQTPay=_bIsLQTPay;
@property(retain, nonatomic) NSString *orderReqKey; // @synthesize orderReqKey=_orderReqKey;
@property(nonatomic) BOOL bIsOfflinePayConfirm; // @synthesize bIsOfflinePayConfirm=_bIsOfflinePayConfirm;
...
@property(nonatomic) BOOL mustCheckMessage; // @synthesize mustCheckMessage=_mustCheckMessage;
...
@property(nonatomic) BOOL m_bTouchIDAuth; // @synthesize m_bTouchIDAuth=_m_bTouchIDAuth;
...
@property(nonatomic) BOOL m_bIsAutoDeduct; // @synthesize m_bIsAutoDeduct;
...
@property(nonatomic) unsigned long m_payChannel; // @synthesize m_payChannel;
@property(nonatomic) unsigned long m_payScene; // @synthesize m_payScene;
...
@property(nonatomic) BOOL m_freeSMSFlag; // @synthesize m_freeSMSFlag;
...
@property(nonatomic) BOOL m_6resetFlag; // @synthesize m_6resetFlag;
...
@property(nonatomic) BOOL m_3simpleRegFlag; // @synthesize m_3simpleRegFlag;
...
@property(nonatomic) BOOL m_3resetFlag; // @synthesize m_3resetFlag;
...
@property(nonatomic) BOOL m_bRetry; // @synthesize m_bRetry;
- (void).cxx_destruct;
- (BOOL)isWrongFlag;
- (void)dealloc;
