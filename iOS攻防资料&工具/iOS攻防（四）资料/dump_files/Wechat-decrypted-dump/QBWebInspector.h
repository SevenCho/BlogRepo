...
+ (id)JSONInfoWithDetail:(BOOL)arg1 shouldUpload:(BOOL)arg2;
+ (void)uploadLogWithPaths:(id)arg1 completion:(CDUnknownBlockType)arg2;
+ (BOOL)uploadWithBusinessID:(id)arg1 log:(id)arg2 completion:(CDUnknownBlockType)arg3;
+ (BOOL)uploadAllLogsWithCompletion:(CDUnknownBlockType)arg1;
+ (BOOL)uploadWithDetail:(BOOL)arg1 triggerURL:(id)arg2 completion:(CDUnknownBlockType)arg3;
+ (BOOL)saveToFile;
...
+ (BOOL)isWebInspectorURL:(id)arg1;
+ (void)addStatusWithKey:(id)arg1 value:(id)arg2 allowDuplicateKey:(BOOL)arg3;
...
+ (id)networkDescriptionWithStatus:(int)arg1;
+ (BOOL)validationCheckForEvent:(id)arg1;
+ (void)initialize;
+ (id)sharedInstance;
