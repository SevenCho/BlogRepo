...
{
    BOOL _enableDeselection;
    id <MainTableDelegate> _m_mainTableDelegate;
}

@property(nonatomic) BOOL enableDeselection; // @synthesize enableDeselection=_enableDeselection;
...
- (void)forceDeselectRowAtIndexPath:(id)arg1 animated:(BOOL)arg2;
