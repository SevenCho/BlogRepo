...
{
    BOOL _isScannedStoreFile;
    NSString *_appID;
    unsigned long _storeFileCount;
...
@property(nonatomic) BOOL isScannedStoreFile; // @synthesize isScannedStoreFile=_isScannedStoreFile;
@property(nonatomic) unsigned long long storeFileSize; // @synthesize storeFileSize=_storeFileSize;
@property(nonatomic) unsigned long storeFileCount; // @synthesize storeFileCount=_storeFileCount;
...
- (void)setStoreFileCount:(unsigned long)arg1 fileSize:(unsigned long long)arg2;
